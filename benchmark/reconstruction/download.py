...
def download_eth3d(data_path: Path):
    ...
    subprocess.call(
        ["wget", "https://www.eth3d.net/data/" + undistorted_images], cwd=data_path
    )
    ...
    subprocess.call(["wget", "https://www.eth3d.net/data/" + scan], cwd=data_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=Path, default=Path(os.getcwd()) / "data")
