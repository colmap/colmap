...
complexity while preserving shape and appearance. More information on Multi-View
Stereo in general and the algorithms in COLMAP can be found in
[schoenberger16mvs]_.
...
command to reduce the number of faces while preserving the overall shape.
