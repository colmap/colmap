...
if(DEFINED glog_VERSION_MAJOR)
  ...
  add_compile_definitions("-DGLOG_VERSION_MAJOR=${glog_VERSION_MAJOR}")
  add_compile_definitions("-DGLOG_VERSION_MINOR=${glog_VERSION_MINOR}")
endif()
...
if(OPENMP_ENABLED AND OPENMP_FOUND)
    ...
    add_compile_definitions("-DCOLMAP_OPENMP_ENABLED")
else()
...
if(CGAL_FOUND)
    add_compile_definitions("-DCOLMAP_CGAL_ENABLED")
...
if(DOWNLOAD_ENABLED)
    ...
    if(CURL_FOUND AND CRYPTO_FOUND)
        ...
        add_compile_definitions("-DCOLMAP_DOWNLOAD_ENABLED")
    else()
...
if(CUDA_ENABLED AND CUDA_FOUND)
    ...
    add_compile_definitions("-DCOLMAP_CUDA_ENABLED")
...
if(GUI_ENABLED AND Qt5_FOUND)
    add_compile_definitions("-DCOLMAP_GUI_ENABLED")
...
if(OPENGL_ENABLED)
    if(NOT GUI_ENABLED)
        ...
        add_compile_definitions("-DCOLMAP_OPENGL_ENABLED")
...
if(OPENGL_ENABLED OR CUDA_ENABLED)
    add_compile_definitions("-DCOLMAP_GPU_ENABLED")
