...
if(AUTO_DOWNLOAD_ENABLED)
    ...
    if(CURL_FOUND)
        message(STATUS "Enabling auto-download support")
        add_definitions("-DCOLMAP_AUTO_DOWNLOAD_ENABLED")
    else()
        set(AUTO_DOWNLOAD_ENABLED OFF)
        message(STATUS "Disabling auto-download support (Curl/OpenSSL not found)")
    endif()
else()
    message(STATUS "Disabling auto-download support")
endif()
