...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_extra_calib_score_kernel(
        double* focal,
...
void simple_radial_fixed_pose_fixed_extra_calib_score(
    double* focal,
    unsigned int focal_num_alloc,
    SharedIndex* focal_indices,
    double* point,
  ...
  simple_radial_fixed_pose_fixed_extra_calib_score_kernel<<<n_blocks, 1024>>>(
      focal,
      focal_num_alloc,
      focal_indices,
      point,
