...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r32 = r32 * r4;
    r32 = r32 * r3;
    r32 = fma(r33, r32, r33 * r1);
    write_sum_2<double, double>((double*)inout_shared, r34, r32);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = r15 * r35;
    r1 = r17 * r9;
    r1 = fma(r33, r1, r16 * r25);
    r25 = r14 * r17;
    r32 = r0 * r0;
    r27 = r15 * r28;
    r32 = fma(r27, r32, r35 * r25);
    r25 = r14 * r21;
    r25 = r25 * r6;
    r32 = fma(r29, r25, r32);
    r32 = fma(r7, r27, r32);
    ...
    r1 = fma(r0, r32, r1);
    r25 = r21 * r9;
    r25 = fma(r33, r25, r6 * r32);
    r25 = fma(r15, r22, r25);
    write_idx_2<1024, double, double, double2>(
        out_point_jac, 2 * out_point_jac_num_alloc, global_thread_idx, r1, r25);
    r32 = r23 * r35;
    r27 = r19 * r9;
    r27 = fma(r33, r27, r16 * r32);
    r32 = r14 * r19;
    r16 = r0 * r0;
    r16 = r16 * r23;
    r16 = fma(r28, r16, r35 * r32);
    r32 = r14 * r5;
    r32 = r32 * r6;
    r16 = fma(r29, r32, r16);
    r29 = r23 * r7;
    ...
    r22 = r4 * r3;
    r29 = r4 * r2;
    r29 = fma(r34, r29, r31 * r22);
    r22 = r4 * r3;
    r33 = r4 * r2;
    r33 = fma(r1, r33, r25 * r22);
  ...
  flush_sum_shared<1, double>(out_point_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r29 = fma(r31, r31, r34 * r34);
    r33 = fma(r1, r1, r25 * r25);
    write_sum_2<double, double>((double*)inout_shared, r29, r33);
  };
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fma(r31, r25, r34 * r1);
    r34 = fma(r34, r27, r31 * r32);
    write_sum_2<double, double>((double*)inout_shared, r33, r34);
  };
  flush_sum_shared<2, double>(out_point_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r27 = fma(r1, r27, r25 * r32);
    write_sum_1<double, double>((double*)inout_shared, r27);
  };
