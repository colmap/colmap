...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r39 = r1 * r2;
    r39 = r39 * r32;
    r39 = fma(r38, r39, r38 * r37);
    write_sum_2<double, double>((double*)inout_shared, r39, r36);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r37 = r37 * r4;
    r37 = r37 * r2;
    r37 = fma(r33, r37, r33 * r39);
    write_sum_2<double, double>((double*)inout_shared, r36, r37);
  };
  flush_sum_shared<2, double>(out_calib_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r39 = r0 * r20;
    r37 = r37 * r39;
    r37 = fma(r27, r37, r18 * r37);
    write_sum_2<double, double>((double*)inout_shared, r22, r37);
  };
  flush_sum_shared<2, double>(out_calib_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    write_sum_2<double, double>((double*)inout_shared, r25, r16);
  };
  flush_sum_shared<2, double>(out_calib_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r16 = 0.00000000000000000e+00;
    r25 = r9 * r18;
    r36 = fma(r39, r36, r39 * r25);
    write_sum_2<double, double>((double*)inout_shared, r36, r16);
  };
  flush_sum_shared<2, double>(out_calib_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    write_sum_2<double, double>((double*)inout_shared, r34, r35);
  };
  flush_sum_shared<2, double>(out_calib_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r35 = r35 * r38;
    r0 = r11 * r9;
    r0 = fma(r33, r0, r30 * r35);
    r0 = fma(r6, r8, r0);
    write_idx_2<1024, double, double, double2>(
        out_point_jac, 0 * out_point_jac_num_alloc, global_thread_idx, r34, r0);
    r8 = r15 * r31;
    r16 = r17 * r9;
    r16 = fma(r33, r16, r38 * r8);
    r8 = r14 * r17;
    r36 = r1 * r1;
    r39 = r15 * r28;
    r36 = fma(r39, r36, r31 * r8);
    r8 = r14 * r21;
    r8 = r8 * r6;
    r36 = fma(r29, r8, r36);
    r36 = fma(r7, r39, r36);
    ...
    r16 = fma(r26, r8, r16);
    r8 = r21 * r9;
    r8 = fma(r33, r8, r15 * r35);
    r39 = r6 * r36;
    r8 = fma(r26, r39, r8);
    write_idx_2<1024, double, double, double2>(
        out_point_jac, 2 * out_point_jac_num_alloc, global_thread_idx, r16, r8);
    r39 = r14 * r19;
    r25 = r1 * r1;
    r25 = r25 * r23;
    r25 = fma(r28, r25, r31 * r39);
    r39 = r14 * r5;
    r39 = r39 * r6;
    r25 = fma(r29, r39, r25);
    r29 = r23 * r7;
    ...
    r29 = r1 * r25;
    r39 = r19 * r9;
    r39 = fma(r33, r39, r26 * r29);
    r29 = r23 * r31;
    r39 = fma(r38, r29, r39);
    r29 = r6 * r25;
    r38 = r5 * r9;
    r38 = fma(r33, r38, r26 * r29);
    r38 = fma(r23, r35, r38);
    ...
    r35 = r4 * r2;
    r29 = r4 * r3;
    r29 = fma(r0, r29, r34 * r35);
    r35 = r4 * r2;
    r33 = r4 * r3;
    r33 = fma(r8, r33, r16 * r35);
  ...
  flush_sum_shared<1, double>(out_point_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r29 = fma(r0, r0, r34 * r34);
    r33 = fma(r8, r8, r16 * r16);
    write_sum_2<double, double>((double*)inout_shared, r29, r33);
  };
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fma(r34, r16, r0 * r8);
    r0 = fma(r0, r38, r34 * r39);
    write_sum_2<double, double>((double*)inout_shared, r33, r0);
  };
