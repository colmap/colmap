...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_pose_fixed_focal_score_kernel(
        double* extra_calib,
...
void pinhole_fixed_pose_fixed_focal_score(double* extra_calib,
                                          unsigned int extra_calib_num_alloc,
                                          SharedIndex* extra_calib_indices,
                                          double* point,
                                          unsigned int point_num_alloc,
  ...
  pinhole_fixed_pose_fixed_focal_score_kernel<<<n_blocks, 1024>>>(
      extra_calib,
