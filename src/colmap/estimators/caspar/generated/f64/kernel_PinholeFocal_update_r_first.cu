...
__global__ void __launch_bounds__(1024, 1) PinholeFocal_update_r_first_kernel(
  ...
  if (global_thread_idx < problem_size) {
    read_idx_2<1024, double, double, double2>(PinholeFocal_r_k,
                                              ...
                                              r0,
                                              r1);
    read_idx_2<1024, double, double, double2>(PinholeFocal_w,
  ...
  sum_store<double>(out_PinholeFocal_r_0_norm2_tot_local,
                    (double*)inout_shared,
                    0,
  ...
  sum_store<double>(out_PinholeFocal_r_kp1_norm2_tot_local,
                    (double*)inout_shared,
                    0,
                    global_thread_idx < problem_size,
                    r2);
  ...
  sum_flush_final<double>(out_PinholeFocal_r_kp1_norm2_tot_local,
...
void PinholeFocal_update_r_first(double* PinholeFocal_r_k,
  ...
  PinholeFocal_update_r_first_kernel<<<n_blocks, 1024>>>(
      PinholeFocal_r_k,
