...
__global__ void __launch_bounds__(1024, 1)
    PinholeFocal_start_w_contribute_kernel(
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r2;
    read_idx_2<1024, double, double, double2>(PinholeFocal_p,
    ...
    r2 = r1 * r2;
    r2 = r2 * r4;
    add_idx_2<1024, double, double, double2>(out_PinholeFocal_w,
...
void PinholeFocal_start_w_contribute(
  ...
  PinholeFocal_start_w_contribute_kernel<<<n_blocks, 1024>>>(
      PinholeFocal_precond_diag,
