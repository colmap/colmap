...
__global__ void __launch_bounds__(1024, 1) pinhole_fixed_focal_res_jac_kernel(
    double* pose,
  ...
  if (global_thread_idx < problem_size) {
    r42 = r4 * r2;
    r44 = r4 * r3;
    write_sum_2<double, double>((double*)inout_shared, r42, r44);
  };
...
void pinhole_fixed_focal_res_jac(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* extra_calib,
  ...
  pinhole_fixed_focal_res_jac_kernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      extra_calib,
