...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedPrincipalPointFixedPointScoreKernel(
        double* pose,
...
void SimpleRadialFixedPrincipalPointFixedPointScore(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* focal_and_extra,
  ...
  SimpleRadialFixedPrincipalPointFixedPointScoreKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      focal_and_extra,
