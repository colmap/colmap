...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_extra_calib_fixed_point_res_jac_kernel(
        double* pose,
...
void simple_radial_fixed_extra_calib_fixed_point_res_jac(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* focal,
  ...
  simple_radial_fixed_extra_calib_fixed_point_res_jac_kernel<<<n_blocks,
                                                               1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
