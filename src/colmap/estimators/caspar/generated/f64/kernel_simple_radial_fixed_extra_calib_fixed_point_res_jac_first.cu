...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_extra_calib_fixed_point_res_jac_first_kernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r42 = fma(r45, r32, r42);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 0 * out_pose_jac_num_alloc, global_thread_idx, r39, r42);
    r22 = r15 * r6;
    r13 = r13 * r13;
    r13 = r13 * r4;
    r50 = r25 + r13;
    ...
    r11 = r11 * r24;
    r22 = r49 * r27;
    r22 = fma(r46, r22, r27 * r11);
    r22 = fma(r14, r1, r22);
    r37 = fma(r37, r1, r49 * r32);
    r14 = r0 * r20;
    r14 = r14 * r24;
    r37 = fma(r38, r14, r37);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 2 * out_pose_jac_num_alloc, global_thread_idx, r22, r37);
    r16 = r21 + r16;
    ...
    r17 = r17 * r24;
    r34 = fma(r27, r17, r34);
    r50 = fma(r16, r32, r50 * r1);
    r17 = r0 * r7;
    r17 = r17 * r24;
    r50 = fma(r38, r17, r50);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 4 * out_pose_jac_num_alloc, global_thread_idx, r34, r50);
    r17 = r0 * r28;
    r17 = r17 * r12;
    r17 = r17 * r5;
    r17 = r17 * r6;
    ...
    r40 = fma(r8, r40, r1);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 6 * out_pose_jac_num_alloc, global_thread_idx, r40, r17);
    r44 = r0 * r12;
    r44 = r44 * r6;
    r44 = r44 * r26;
    r44 = fma(r38, r44, r1);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 8 * out_pose_jac_num_alloc, global_thread_idx, r17, r44);
    r1 = r15 * r5;
    r1 = r1 * r5;
    r10 = r15 * r6;
    r10 = r10 * r6;
    ...
    r1 = r28 * r10;
    r1 = r1 * r24;
    r1 = fma(r27, r1, r27 * r46);
    r46 = r0 * r10;
    r46 = r46 * r24;
    r46 = fma(r38, r46, r32);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 10 * out_pose_jac_num_alloc, global_thread_idx, r1, r46);
    r32 = r4 * r2;
    r24 = r4 * r3;
    r24 = fma(r42, r24, r39 * r32);
    r32 = r4 * r2;
    r26 = r4 * r3;
    r26 = fma(r37, r26, r22 * r32);
    write_sum_2<double, double>((double*)inout_shared, r24, r26);
  };
  ...
  if (global_thread_idx < problem_size) {
    r26 = r4 * r3;
    r24 = r4 * r2;
    r24 = fma(r34, r24, r50 * r26);
    r26 = r4 * r2;
    r32 = r15 * r3;
    r48 = r38 * r18;
    r32 = fma(r48, r32, r40 * r26);
    write_sum_2<double, double>((double*)inout_shared, r24, r32);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    r32 = r4 * r3;
    r24 = r4 * r2;
    r24 = fma(r1, r24, r46 * r32);
    r32 = r4 * r3;
    r26 = r15 * r2;
    r26 = fma(r48, r26, r44 * r32);
    write_sum_2<double, double>((double*)inout_shared, r26, r24);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r24 = fma(r39, r39, r42 * r42);
    r26 = fma(r22, r22, r37 * r37);
    write_sum_2<double, double>((double*)inout_shared, r24, r26);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r24 = r24 * r8;
    r8 = fma(r40, r40, r24);
    write_sum_2<double, double>((double*)inout_shared, r26, r8);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    r24 = fma(r44, r44, r24);
    r8 = fma(r46, r46, r1 * r1);
    write_sum_2<double, double>((double*)inout_shared, r24, r8);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r8 = fma(r39, r22, r42 * r37);
    r24 = fma(r42, r50, r39 * r34);
    write_sum_2<double, double>((double*)inout_shared, r8, r24);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r24 = fma(r42, r17, r39 * r40);
    r8 = fma(r39, r17, r42 * r44);
    write_sum_2<double, double>((double*)inout_shared, r24, r8);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r39 = fma(r39, r1, r42 * r46);
    r42 = fma(r37, r50, r22 * r34);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r42 = fma(r37, r17, r22 * r40);
    r39 = fma(r22, r17, r37 * r44);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r37 = fma(r37, r46, r22 * r1);
    r22 = fma(r50, r17, r34 * r40);
    write_sum_2<double, double>((double*)inout_shared, r37, r22);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r22 = fma(r50, r46, r34 * r1);
    r34 = fma(r34, r17, r50 * r44);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r22 = fma(r44, r17, r40 * r17);
    r40 = fma(r46, r17, r40 * r1);
    write_sum_2<double, double>((double*)inout_shared, r22, r40);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
...
void simple_radial_fixed_extra_calib_fixed_point_res_jac_first(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* focal,
  ...
  simple_radial_fixed_extra_calib_fixed_point_res_jac_first_kernel<<<n_blocks,
                                                                     1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
