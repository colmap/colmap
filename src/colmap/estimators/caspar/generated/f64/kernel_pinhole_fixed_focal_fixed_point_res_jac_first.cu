...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_focal_fixed_point_res_jac_first_kernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r7, r43);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    r39 = r41 * r39;
    write_sum_1<double, double>((double*)inout_shared, r39);
  };
  ...
  if (global_thread_idx < problem_size) {
    r39 = r4 * r2;
    r41 = r4 * r3;
    write_sum_2<double, double>((double*)inout_shared, r39, r41);
  };
...
void pinhole_fixed_focal_fixed_point_res_jac_first(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* extra_calib,
  ...
  pinhole_fixed_focal_fixed_point_res_jac_first_kernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      extra_calib,
