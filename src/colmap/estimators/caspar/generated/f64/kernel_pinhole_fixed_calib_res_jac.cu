...
__global__ void __launch_bounds__(1024, 1) pinhole_fixed_calib_res_jac_kernel(
    double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r0 = 1.0 / r27;
    read_idx_2<1024, double, double, double2>(
        calib, 0 * calib_num_alloc, global_thread_idx, r5, r28);
  };
  load_shared<2, double, double>(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r48 = fma(r31, r13, r0 * r48);
    r32 = r23 + r32;
    r46 = r41 + r46;
    r46 = fma(r6, r46, r7 * r32);
    r6 = r28 * r46;
    r32 = r31 * r45;
    r32 = fma(r22, r32, r0 * r6);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 4 * out_pose_jac_num_alloc, global_thread_idx, r48, r32);
    r6 = r5 * r0;
    r7 = r28 * r0;
    write_idx_2<1024, double, double, double2>(
    ...
    r7 = r4 * r2;
    r6 = r4 * r3;
    r6 = fma(r50, r6, r18 * r7);
    r7 = r4 * r2;
    r41 = r4 * r3;
    r41 = fma(r15, r41, r17 * r7);
    write_sum_2<double, double>((double*)inout_shared, r6, r41);
  };
  ...
  flush_sum_shared<2, double>(out_pose_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r7 = fma(r18, r18, r50 * r50);
    r41 = fma(r15, r15, r17 * r17);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r23 = r5 * r29;
    r23 = r23 * r27;
    r23 = fma(r36, r23, r6 * r7);
    write_sum_2<double, double>((double*)inout_shared, r41, r23);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r23 = fma(r50, r15, r18 * r17);
    r41 = fma(r18, r48, r50 * r32);
    write_sum_2<double, double>((double*)inout_shared, r23, r41);
  };
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r23 = fma(r17, r48, r15 * r32);
    r41 = r50 * r45;
    r18 = fma(r18, r13, r22 * r41);
    write_sum_2<double, double>((double*)inout_shared, r18, r23);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r18 = r28 * r15;
    r18 = r18 * r0;
    write_sum_2<double, double>((double*)inout_shared, r23, r18);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    r6 = r5 * r25;
    r6 = fma(r20, r13, r0 * r6);
    r43 = r28 * r14;
    r36 = r20 * r45;
    r36 = fma(r22, r36, r0 * r43);
    write_idx_2<1024, double, double, double2>(
        out_point_jac, 0 * out_point_jac_num_alloc, global_thread_idx, r6, r36);
    r43 = r5 * r33;
    r43 = fma(r16, r13, r0 * r43);
    r48 = r28 * r35;
    r18 = r16 * r45;
    r18 = fma(r22, r18, r0 * r48);
    write_idx_2<1024, double, double, double2>(out_point_jac,
                                               ...
                                               r18);
    r48 = r5 * r19;
    r48 = fma(r0, r48, r26 * r13);
    r13 = r28 * r12;
    r23 = r26 * r45;
    r23 = fma(r22, r23, r0 * r13);
    write_idx_2<1024, double, double, double2>(out_point_jac,
    ...
    r13 = r4 * r3;
    r22 = r4 * r2;
    r22 = fma(r6, r22, r36 * r13);
    r13 = r4 * r2;
    r0 = r4 * r3;
    r0 = fma(r18, r0, r43 * r13);
  ...
  flush_sum_shared<1, double>(out_point_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r22 = fma(r36, r36, r6 * r6);
    r0 = fma(r43, r43, r18 * r18);
    write_sum_2<double, double>((double*)inout_shared, r22, r0);
  };
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r0 = fma(r6, r43, r36 * r18);
    r36 = fma(r36, r23, r6 * r48);
    write_sum_2<double, double>((double*)inout_shared, r0, r36);
  };
...
void pinhole_fixed_calib_res_jac(double* pose,
                                 unsigned int pose_num_alloc,
                                 SharedIndex* pose_indices,
                                 double* point,
                                 unsigned int point_num_alloc,
  ...
  pinhole_fixed_calib_res_jac_kernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      point,
