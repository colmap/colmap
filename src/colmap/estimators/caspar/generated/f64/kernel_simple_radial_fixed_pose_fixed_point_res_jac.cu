...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = r19 * r4;
    r25 = r25 * r2;
    r25 = fma(r13, r25, r13 * r6);
    r13 = r19 * r4;
    r13 = r13 * r2;
    r13 = r13 * r24;
    r26 = r24 * r1;
    r26 = fma(r6, r26, r1 * r13);
    write_sum_2<double, double>((double*)inout_shared, r25, r26);
  };
  ...
  if (global_thread_idx < problem_size) {
    r26 = r5 * r5;
    r26 = r26 * r20;
    r26 = fma(r17, r26, r22 * r26);
    r9 = r0 * r9;
    r20 = r20 * r1;
    r9 = r9 * r20;
    r9 = fma(r22, r9, r17 * r9);
    write_sum_2<double, double>((double*)inout_shared, r26, r9);
  };
  ...
  if (global_thread_idx < problem_size) {
    r9 = r5 * r22;
    r26 = r5 * r17;
    r26 = fma(r20, r26, r20 * r9);
    write_sum_1<double, double>((double*)inout_shared, r26);
  };
