...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_focal_fixed_extra_calib_res_jac_first_kernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r7, r40);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r43 = r4 * r43;
    r36 = r36 * r43;
    write_sum_2<double, double>((double*)inout_shared, r17, r36);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
...
void pinhole_fixed_focal_fixed_extra_calib_res_jac_first(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* point,
  ...
  pinhole_fixed_focal_fixed_extra_calib_res_jac_first_kernel<<<n_blocks,
                                                               1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
