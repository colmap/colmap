...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = r9 * r18;
    r37 = r9 * r27;
    r37 = fma(r36, r37, r36 * r25);
    write_sum_2<double, double>((double*)inout_shared, r37, r16);
  };
  flush_sum_shared<2, double>(out_calib_precond_tril,
