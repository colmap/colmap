...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r31 = r6 * r29;
    r31 = r31 * r16;
    r8 = fma(r30, r31, r6 * r8);
    r22 = r11 * r9;
    r8 = fma(r33, r22, r8);
    write_idx_2<1024, double, double, double2>(
        out_point_jac, 0 * out_point_jac_num_alloc, global_thread_idx, r34, r8);
    r22 = r15 * r35;
    r25 = r17 * r9;
    r25 = fma(r33, r25, r16 * r22);
    r22 = r14 * r17;
    r1 = r0 * r0;
    r32 = r15 * r28;
    r1 = fma(r32, r1, r35 * r22);
    r22 = r14 * r21;
    r22 = r22 * r6;
    r1 = fma(r29, r22, r1);
    r1 = fma(r7, r32, r1);
    ...
    r22 = r23 * r35;
    r27 = r19 * r9;
    r27 = fma(r33, r27, r16 * r22);
    r22 = r14 * r19;
    r16 = r0 * r0;
    r16 = r16 * r23;
    r16 = fma(r28, r16, r35 * r22);
    r22 = r14 * r5;
    r22 = r22 * r6;
    r16 = fma(r29, r22, r16);
    r29 = r23 * r7;
    ...
    r31 = r4 * r3;
    r29 = r4 * r2;
    r29 = fma(r34, r29, r8 * r31);
    r31 = r4 * r3;
    r33 = r4 * r2;
    r33 = fma(r25, r33, r32 * r31);
  ...
  flush_sum_shared<1, double>(out_point_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r29 = fma(r8, r8, r34 * r34);
    r33 = fma(r25, r25, r32 * r32);
    write_sum_2<double, double>((double*)inout_shared, r29, r33);
  };
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fma(r8, r32, r34 * r25);
    r34 = fma(r34, r27, r8 * r22);
