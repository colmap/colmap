...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedPoseFixedFocalAndExtraFixedPrincipalPointJtjnjtrDirectKernel(
        double* point_njtr,
...
void SimpleRadialFixedPoseFixedFocalAndExtraFixedPrincipalPointJtjnjtrDirect(
    double* point_njtr,
    unsigned int point_njtr_num_alloc,
    SharedIndex* point_njtr_indices,
    double* point_jac,
