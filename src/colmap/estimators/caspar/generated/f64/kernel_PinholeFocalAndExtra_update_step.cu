...
__global__ void __launch_bounds__(1024, 1) PinholeFocalAndExtraUpdateStepKernel(
    double* PinholeFocalAndExtra_step_k,
...
void PinholeFocalAndExtraUpdateStep(
    double* PinholeFocalAndExtra_step_k,
    unsigned int PinholeFocalAndExtra_step_k_num_alloc,
    double* PinholeFocalAndExtra_p_kp1,
    unsigned int PinholeFocalAndExtra_p_kp1_num_alloc,
  ...
  PinholeFocalAndExtraUpdateStepKernel<<<n_blocks, 1024>>>(
      PinholeFocalAndExtra_step_k,
