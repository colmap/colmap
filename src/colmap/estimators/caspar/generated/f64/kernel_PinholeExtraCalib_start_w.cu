...
__global__ void __launch_bounds__(1024, 1) PinholeExtraCalib_start_w_kernel(
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r2;
    read_idx_2<1024, double, double, double2>(PinholeExtraCalib_p,
...
void PinholeExtraCalib_start_w(
  ...
  PinholeExtraCalib_start_w_kernel<<<n_blocks, 1024>>>(
      PinholeExtraCalib_precond_diag,
