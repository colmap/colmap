...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_pose_fixed_calib_score_kernel(double* point,
...
void pinhole_fixed_pose_fixed_calib_score(double* point,
                                          unsigned int point_num_alloc,
                                          SharedIndex* point_indices,
                                          double* pixel,
                                          unsigned int pixel_num_alloc,
  ...
  pinhole_fixed_pose_fixed_calib_score_kernel<<<n_blocks, 1024>>>(
      point,
      point_num_alloc,
      point_indices,
      pixel,
