...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialPrincipalPoint_update_r_first_kernel(
  ...
  sum_store<double>(out_SimpleRadialPrincipalPoint_r_0_norm2_tot_local,
                    (double*)inout_shared,
                    0,
  ...
  sum_store<double>(out_SimpleRadialPrincipalPoint_r_kp1_norm2_tot_local,
                    (double*)inout_shared,
                    0,
                    global_thread_idx < problem_size,
                    r2);
  sum_flush_final<double>(out_SimpleRadialPrincipalPoint_r_0_norm2_tot_local,
                          out_SimpleRadialPrincipalPoint_r_0_norm2_tot,
                          1);
  sum_flush_final<double>(out_SimpleRadialPrincipalPoint_r_kp1_norm2_tot_local,
...
void SimpleRadialPrincipalPoint_update_r_first(
  ...
  SimpleRadialPrincipalPoint_update_r_first_kernel<<<n_blocks, 1024>>>(
      SimpleRadialPrincipalPoint_r_k,
