...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_extra_calib_fixed_point_res_jac_first_kernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    read_shared_2<double>(
        (double*)inout_shared, focal_indices_loc[threadIdx.x].target, r5, r27);
  };
  __syncthreads();
  load_shared<2, double, double>(
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 0 * out_pose_jac_num_alloc, global_thread_idx, r1, r45);
    r30 = r8 * r30;
    r17 = r17 + r30;
    r11 = r18 + r11;
    r10 = r10 * r10;
    ...
    r10 = r24 + r10;
    r43 = r43 + r10;
    r43 = fma(r6, r43, r21 * r20);
    r17 = fma(r43, r13, r0 * r17);
    r20 = r43 * r44;
    r22 = r15 + r22;
    r22 = fma(r6, r22, r21 * r14);
    r14 = r27 * r22;
    r14 = fma(r0, r14, r34 * r20);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 2 * out_pose_jac_num_alloc, global_thread_idx, r17, r14);
    r30 = r33 + r30;
    ...
    r6 = r27 * r10;
    r6 = fma(r0, r6, r34 * r42);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 4 * out_pose_jac_num_alloc, global_thread_idx, r32, r6);
    r42 = r5 * r0;
    r31 = r27 * r0;
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 6 * out_pose_jac_num_alloc, global_thread_idx, r42, r31);
    r31 = r44 * r34;
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 8 * out_pose_jac_num_alloc, global_thread_idx, r13, r31);
    r31 = r4 * r3;
    r42 = r4 * r2;
    r42 = fma(r1, r42, r45 * r31);
    r31 = r4 * r2;
    r7 = r4 * r3;
    r7 = fma(r14, r7, r17 * r31);
    write_sum_2<double, double>((double*)inout_shared, r42, r7);
  };
  ...
  if (global_thread_idx < problem_size) {
    r7 = r4 * r2;
    r42 = r4 * r3;
    r42 = fma(r6, r42, r32 * r7);
    r7 = r4 * r2;
    r7 = r7 * r0;
    r31 = r5 * r7;
    write_sum_2<double, double>((double*)inout_shared, r42, r31);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r42 = r3 * r41;
    r38 = r2 * r41;
    r38 = fma(r25, r38, r34 * r42);
    write_sum_2<double, double>((double*)inout_shared, r31, r38);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r38 = fma(r45, r45, r1 * r1);
    r31 = fma(r17, r17, r14 * r14);
    write_sum_2<double, double>((double*)inout_shared, r38, r31);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r42 = r29 * r26;
    r9 = r27 * r34;
    r42 = fma(r9, r42, r25 * r38);
    write_sum_2<double, double>((double*)inout_shared, r31, r42);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r42 = fma(r45, r14, r1 * r17);
    r31 = fma(r1, r32, r45 * r6);
    write_sum_2<double, double>((double*)inout_shared, r42, r31);
  };
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r42 = fma(r14, r6, r17 * r32);
    r31 = r45 * r44;
    r1 = fma(r1, r13, r34 * r31);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r1 = r27 * r14;
    r1 = r1 * r0;
    write_sum_2<double, double>((double*)inout_shared, r42, r1);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r1 = r1 * r0;
    r17 = r6 * r44;
    r17 = fma(r34, r17, r32 * r13);
    write_sum_2<double, double>((double*)inout_shared, r1, r17);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r9 = r29 * r0;
    write_idx_2<1024, double, double, double2>(
        out_focal_jac, 0 * out_focal_jac_num_alloc, global_thread_idx, r40, r9);
    r7 = r28 * r7;
    r9 = r4 * r29;
    r9 = r9 * r3;
    r9 = r9 * r0;
...
void pinhole_fixed_extra_calib_fixed_point_res_jac_first(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* focal,
  ...
  pinhole_fixed_extra_calib_fixed_point_res_jac_first_kernel<<<n_blocks,
                                                               1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
