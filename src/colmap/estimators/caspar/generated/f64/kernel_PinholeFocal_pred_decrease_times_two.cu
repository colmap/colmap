...
__global__ void __launch_bounds__(1024, 1)
    PinholeFocal_pred_decrease_times_two_kernel(
  ...
  if (global_thread_idx < problem_size) {
    read_idx_2<1024, double, double, double2>(PinholeFocal_step,
                                              0 * PinholeFocal_step_num_alloc,
                                              global_thread_idx,
                                              r0,
                                              r1);
    read_idx_2<1024, double, double, double2>(PinholeFocal_njtr,
  ...
  sum_store<double>(out_PinholeFocal_pred_dec_local,
                    (double*)inout_shared,
                    0,
                    global_thread_idx < problem_size,
                    r2);
  sum_flush_final<double>(
      out_PinholeFocal_pred_dec_local, out_PinholeFocal_pred_dec, 1);
}
...
void PinholeFocal_pred_decrease_times_two(
  ...
  PinholeFocal_pred_decrease_times_two_kernel<<<n_blocks, 1024>>>(
      PinholeFocal_step,
      PinholeFocal_step_num_alloc,
      PinholeFocal_precond_diag,
      PinholeFocal_precond_diag_num_alloc,
      diag,
      PinholeFocal_njtr,
      PinholeFocal_njtr_num_alloc,
      out_PinholeFocal_pred_dec,
      problem_size);
}
