...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedPrincipalPointFixedPointJtjnjtrDirectKernel(
        double* pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = fma(r19, r0, r15);
    r15 = fma(r20, r9, r15);
    r14 = fma(r8, r14, r16 * r18);
    r14 = fma(r17, r2, r14);
    r14 = fma(r19, r1, r14);
    r14 = fma(r20, r10, r14);
    r14 = fma(r3, r12, r14);
    r5 = fma(r5, r14, r4 * r15);
    r14 = fma(r7, r14, r6 * r15);
    WriteSum2<double, double>((double*)inout_shared, r5, r14);
  };
...
void SimpleRadialFixedPrincipalPointFixedPointJtjnjtrDirect(
    double* pose_njtr,
    unsigned int pose_njtr_num_alloc,
    SharedIndex* pose_njtr_indices,
    double* pose_jac,
  ...
  SimpleRadialFixedPrincipalPointFixedPointJtjnjtrDirectKernel<<<n_blocks,
                                                                 1024>>>(
      pose_njtr,
      pose_njtr_num_alloc,
      pose_njtr_indices,
