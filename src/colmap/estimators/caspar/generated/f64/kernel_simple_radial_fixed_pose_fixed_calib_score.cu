...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_calib_score_kernel(
        double* point,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = fma(r7, r23, r15);
    read_idx_2<1024, double, double, double2>(
        calib, 0 * calib_num_alloc, global_thread_idx, r23, r19);
...
void simple_radial_fixed_pose_fixed_calib_score(double* point,
                                                unsigned int point_num_alloc,
                                                SharedIndex* point_indices,
                                                double* pixel,
                                                unsigned int pixel_num_alloc,
  ...
  simple_radial_fixed_pose_fixed_calib_score_kernel<<<n_blocks, 1024>>>(
      point,
      point_num_alloc,
      point_indices,
      pixel,
