...
__global__ void __launch_bounds__(1024, 1)
    PinholeFocal_alpha_denumerator_or_beta_nummerator_kernel(
  ...
  sum_store<double>(PinholeFocal_out_local,
                    (double*)inout_shared,
                    0,
                    global_thread_idx < problem_size,
                    r3);
  sum_flush_final<double>(PinholeFocal_out_local, PinholeFocal_out, 1);
}
...
void PinholeFocal_alpha_denumerator_or_beta_nummerator(
  ...
  PinholeFocal_alpha_denumerator_or_beta_nummerator_kernel<<<n_blocks, 1024>>>(
      PinholeFocal_p_kp1,
