...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_pose_fixed_calib_res_jac_first_kernel(
        double* point,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r0 = 1.0 / r25;
    read_idx_2<1024, double, double, double2>(
        calib, 0 * calib_num_alloc, global_thread_idx, r5, r26);
    read_idx_2<1024, double, double, double2>(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r22 = r5 * r23;
    r27 = r25 * r27;
    r22 = fma(r19, r27, r0 * r22);
    r20 = fma(r22, r20, r21 * r7);
    r7 = r4 * r2;
    r8 = r5 * r29;
    r8 = fma(r15, r27, r0 * r8);
    r12 = r4 * r3;
    r28 = r26 * r16;
    r14 = r15 * r25;
    r14 = fma(r6, r14, r0 * r28);
    r12 = fma(r14, r12, r8 * r7);
    write_sum_2<double, double>((double*)inout_shared, r20, r12);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r20 = r4 * r2;
    r6 = r5 * r30;
    r6 = fma(r0, r6, r24 * r27);
    r20 = fma(r6, r20, r7 * r12);
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r12 = fma(r22, r8, r21 * r14);
    r21 = fma(r21, r7, r22 * r6);
    write_sum_2<double, double>((double*)inout_shared, r12, r21);
  };
...
void pinhole_fixed_pose_fixed_calib_res_jac_first(
  ...
  pinhole_fixed_pose_fixed_calib_res_jac_first_kernel<<<n_blocks, 1024>>>(
      point,
      point_num_alloc,
      point_indices,
      pixel,
