...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_focal_res_jac_kernel(
        double* extra_calib,
...
void simple_radial_fixed_pose_fixed_focal_res_jac(
    double* extra_calib,
    unsigned int extra_calib_num_alloc,
    SharedIndex* extra_calib_indices,
    double* point,
  ...
  simple_radial_fixed_pose_fixed_focal_res_jac_kernel<<<n_blocks, 1024>>>(
      extra_calib,
