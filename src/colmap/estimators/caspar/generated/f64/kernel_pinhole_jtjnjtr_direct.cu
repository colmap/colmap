...
__global__ void __launch_bounds__(1024, 1)
    pinhole_jtjnjtr_direct_kernel(double* pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r2 = fma(r24, r2, r28 * r19);
    write_sum_2<double, double>((double*)inout_shared, r27, r2);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
