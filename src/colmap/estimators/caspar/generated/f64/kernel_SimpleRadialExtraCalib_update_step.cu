...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialExtraCalib_update_step_kernel(
  ...
  if (global_thread_idx < problem_size) {
    read_idx_2<1024, double, double, double2>(
        SimpleRadialExtraCalib_step_k,
        0 * SimpleRadialExtraCalib_step_k_num_alloc,
        global_thread_idx,
        r0,
        r1);
    read_idx_2<1024, double, double, double2>(
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_idx_2<1024, double, double, double2>(
        out_SimpleRadialExtraCalib_step_kp1,
        0 * out_SimpleRadialExtraCalib_step_kp1_num_alloc,
        global_thread_idx,
        r2,
        r3);
    read_idx_1<1024, double, double, double>(
        SimpleRadialExtraCalib_step_k,
        2 * SimpleRadialExtraCalib_step_k_num_alloc,
        global_thread_idx,
        r3);
    read_idx_1<1024, double, double, double>(
        SimpleRadialExtraCalib_p_kp1,
    ...
    write_idx_1<1024, double, double, double>(
        out_SimpleRadialExtraCalib_step_kp1,
        2 * out_SimpleRadialExtraCalib_step_kp1_num_alloc,
        global_thread_idx,
        r4);
  };
}
...
void SimpleRadialExtraCalib_update_step(
  ...
  SimpleRadialExtraCalib_update_step_kernel<<<n_blocks, 1024>>>(
      SimpleRadialExtraCalib_step_k,
      SimpleRadialExtraCalib_step_k_num_alloc,
      SimpleRadialExtraCalib_p_kp1,
      SimpleRadialExtraCalib_p_kp1_num_alloc,
      alpha,
      out_SimpleRadialExtraCalib_step_kp1,
      out_SimpleRadialExtraCalib_step_kp1_num_alloc,
      problem_size);
}
