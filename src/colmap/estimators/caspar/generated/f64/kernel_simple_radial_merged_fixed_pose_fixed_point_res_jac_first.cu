...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_merged_fixed_pose_fixed_point_res_jac_first_kernel(
        double* calib,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = r19 * r4;
    r25 = r25 * r2;
    r25 = fma(r13, r25, r13 * r1);
    r6 = r19 * r4;
    r26 = r0 * r9;
    r6 = r6 * r2;
    r6 = r6 * r24;
    r14 = r24 * r26;
    r14 = fma(r1, r14, r26 * r6);
    write_sum_2<double, double>((double*)inout_shared, r25, r14);
  };
  ...
  if (global_thread_idx < problem_size) {
    r3 = r5 * r5;
    r3 = r3 * r20;
    r3 = fma(r17, r3, r22 * r3);
    r9 = r0 * r9;
    r20 = r20 * r26;
    r9 = r9 * r20;
    r9 = fma(r17, r9, r22 * r9);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r9 = r5 * r17;
    r3 = r5 * r22;
    r3 = fma(r20, r3, r20 * r9);
    write_sum_2<double, double>((double*)inout_shared, r3, r23);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r23 = r19 * r24;
    r23 = r23 * r26;
    write_sum_2<double, double>((double*)inout_shared, r13, r23);
  };
  flush_sum_shared<2, double>(out_calib_precond_tril,
...
void simple_radial_merged_fixed_pose_fixed_point_res_jac_first(
    double* calib,
    unsigned int calib_num_alloc,
    SharedIndex* calib_indices,
    double* pixel,
  ...
  simple_radial_merged_fixed_pose_fixed_point_res_jac_first_kernel<<<n_blocks,
                                                                     1024>>>(
      calib,
      calib_num_alloc,
      calib_indices,
