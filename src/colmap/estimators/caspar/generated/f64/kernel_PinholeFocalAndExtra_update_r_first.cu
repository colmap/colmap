...
__global__ void __launch_bounds__(1024, 1)
  ...
  __shared__ double out_PinholeFocalAndExtra_r_0_norm2_tot_local[1];
  ...
  SumStore<double>(out_PinholeFocalAndExtra_r_0_norm2_tot_local,
                   (double*)inout_shared,
                   0,
  ...
  SumStore<double>(out_PinholeFocalAndExtra_r_kp1_norm2_tot_local,
                   (double*)inout_shared,
                   0,
                   global_thread_idx < problem_size,
                   r4);
  SumFlushFinal<double>(out_PinholeFocalAndExtra_r_0_norm2_tot_local,
                        out_PinholeFocalAndExtra_r_0_norm2_tot,
                        1);
  SumFlushFinal<double>(out_PinholeFocalAndExtra_r_kp1_norm2_tot_local,
