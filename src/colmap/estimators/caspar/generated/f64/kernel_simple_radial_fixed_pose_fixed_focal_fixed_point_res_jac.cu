...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_focal_fixed_point_res_jac_kernel(
        double* extra_calib,
  ...
  if (global_thread_idx < problem_size) {
    ...
    read_idx_1<1024, double, double, double>(
        pose, 6 * pose_num_alloc, global_thread_idx, r24);
    r25 = r13 * r8;
    r25 = r25 * r14;
    r15 = fma(r9, r15, r25);
    r15 = fma(r7, r15, r24);
...
void simple_radial_fixed_pose_fixed_focal_fixed_point_res_jac(
    double* extra_calib,
    unsigned int extra_calib_num_alloc,
    SharedIndex* extra_calib_indices,
    double* pixel,
  ...
  simple_radial_fixed_pose_fixed_focal_fixed_point_res_jac_kernel<<<n_blocks,
                                                                    1024>>>(
      extra_calib,
