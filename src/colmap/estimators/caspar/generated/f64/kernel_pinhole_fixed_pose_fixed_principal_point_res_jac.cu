...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_pose_fixed_principal_point_res_jac_kernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_idx_2<1024, double, double, double2>(out_point_jac,
                                               ...
                                               r22);
    r21 = r5 * r30;
    r17 = fma(r24, r17, r0 * r21);
    r21 = r24 * r25;
    r8 = r26 * r18;
    r8 = fma(r0, r8, r7 * r21);
    write_idx_2<1024, double, double, double2>(
        out_point_jac, 4 * out_point_jac_num_alloc, global_thread_idx, r17, r8);
    r21 = r4 * r2;
    r0 = r4 * r3;
    r0 = fma(r20, r0, r6 * r21);
    r21 = r4 * r3;
    r7 = r4 * r2;
    r7 = fma(r27, r7, r22 * r21);
...
void pinhole_fixed_pose_fixed_principal_point_res_jac(
    double* focal_and_extra,
    unsigned int focal_and_extra_num_alloc,
    SharedIndex* focal_and_extra_indices,
    double* point,
  ...
  pinhole_fixed_pose_fixed_principal_point_res_jac_kernel<<<n_blocks, 1024>>>(
      focal_and_extra,
