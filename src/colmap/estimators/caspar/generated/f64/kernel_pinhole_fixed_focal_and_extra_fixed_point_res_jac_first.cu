...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double*)inout_shared, r39, r7);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r41 = r4 * r41;
    r25 = r25 * r41;
    WriteSum2<double, double>((double*)inout_shared, r13, r25);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    r45 = r4 * r2;
    r41 = r4 * r3;
    WriteSum2<double, double>((double*)inout_shared, r45, r41);
  };
