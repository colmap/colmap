...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    read_idx_2<1024, double, double, double2>(
        calib_jac, 2 * calib_jac_num_alloc, global_thread_idx, r6, r7);
    r3 = fma(r5, r6, r3);
    read_idx_2<1024, double, double, double2>(
    ...
    r2 = fma(r1, r5, r0 * r3);
    read_idx_2<1024, double, double, double2>(
        pose_jac, 2 * pose_jac_num_alloc, global_thread_idx, r4, r10);
    r11 = fma(r10, r5, r4 * r3);
    write_sum_2<double, double>((double*)inout_shared, r2, r11);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r16 = fma(r12, r5, r15 * r3);
    read_idx_2<1024, double, double, double2>(
        pose_jac, 10 * pose_jac_num_alloc, global_thread_idx, r17, r18);
    r3 = fma(r17, r3, r18 * r5);
    write_sum_2<double, double>((double*)inout_shared, r16, r3);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = fma(r19, r0, r15);
    r15 = fma(r20, r4, r15);
    r14 = fma(r5, r14, r16 * r18);
    r14 = fma(r17, r2, r14);
    r14 = fma(r19, r1, r14);
    r14 = fma(r20, r10, r14);
    r14 = fma(r3, r12, r14);
    r9 = fma(r9, r14, r8 * r15);
    write_sum_2<double, double>((double*)inout_shared, r9, r15);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r14, r7);
  };
  flush_sum_shared<2, double>(out_calib_njtr,
