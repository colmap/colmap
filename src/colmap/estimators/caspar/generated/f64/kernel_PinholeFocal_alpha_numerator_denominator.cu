...
__global__ void __launch_bounds__(1024, 1)
  ...
  sum_store<double>(PinholeFocal_total_ag_local,
                    (double*)inout_shared,
                    0,
  ...
  sum_store<double>(PinholeFocal_total_ac_local,
                    (double*)inout_shared,
                    0,
                    global_thread_idx < problem_size,
                    r3);
  sum_flush_final<double>(
      PinholeFocal_total_ag_local, PinholeFocal_total_ag, 1);
  sum_flush_final<double>(
      PinholeFocal_total_ac_local, PinholeFocal_total_ac, 1);
}
