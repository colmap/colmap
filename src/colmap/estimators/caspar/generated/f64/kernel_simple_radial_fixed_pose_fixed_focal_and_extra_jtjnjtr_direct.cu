...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedPoseFixedFocalAndExtraJtjnjtrDirectKernel(
...
void SimpleRadialFixedPoseFixedFocalAndExtraJtjnjtrDirect(
    double* principal_point_njtr,
    unsigned int principal_point_njtr_num_alloc,
    SharedIndex* principal_point_njtr_indices,
    double* principal_point_jac,
  ...
  SimpleRadialFixedPoseFixedFocalAndExtraJtjnjtrDirectKernel<<<n_blocks,
                                                               1024>>>(
