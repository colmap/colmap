...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_focal_and_extra_fixed_principal_point_score_kernel(
        double* point,
...
void simple_radial_fixed_pose_fixed_focal_and_extra_fixed_principal_point_score(
    double* point,
    unsigned int point_num_alloc,
    SharedIndex* point_indices,
    double* pixel,
