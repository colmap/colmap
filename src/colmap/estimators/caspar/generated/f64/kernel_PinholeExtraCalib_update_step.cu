...
__global__ void __launch_bounds__(1024, 1) PinholeExtraCalib_update_step_kernel(
    double* PinholeExtraCalib_step_k,
  ...
  if (global_thread_idx < problem_size) {
    read_idx_2<1024, double, double, double2>(
        PinholeExtraCalib_step_k,
        0 * PinholeExtraCalib_step_k_num_alloc,
        global_thread_idx,
        r0,
        r1);
    read_idx_2<1024, double, double, double2>(
...
void PinholeExtraCalib_update_step(
  ...
  PinholeExtraCalib_update_step_kernel<<<n_blocks, 1024>>>(
      PinholeExtraCalib_step_k,
      PinholeExtraCalib_step_k_num_alloc,
      PinholeExtraCalib_p_kp1,
