...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialPose_update_r_first_kernel(
  ...
  sum_store<double>(out_SimpleRadialPose_r_0_norm2_tot_local,
                    (double*)inout_shared,
                    0,
  ...
  sum_store<double>(out_SimpleRadialPose_r_kp1_norm2_tot_local,
                    ...
                    global_thread_idx < problem_size,
                    r11);
  sum_flush_final<double>(out_SimpleRadialPose_r_0_norm2_tot_local,
...
void SimpleRadialPose_update_r_first(
    double* SimpleRadialPose_r_k,
    unsigned int SimpleRadialPose_r_k_num_alloc,
    double* SimpleRadialPose_w,
    unsigned int SimpleRadialPose_w_num_alloc,
  ...
  SimpleRadialPose_update_r_first_kernel<<<n_blocks, 1024>>>(
      SimpleRadialPose_r_k,
