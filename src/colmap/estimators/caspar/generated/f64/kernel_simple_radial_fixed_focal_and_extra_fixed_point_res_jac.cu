...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_focal_and_extra_fixed_point_res_jac_kernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r12 = r48 * r28;
    r15 = fma(r37, r12, r15);
    r40 = fma(r48, r32, r40 * r1);
    r12 = r0 * r21;
    r12 = r12 * r29;
    r40 = fma(r38, r12, r40);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 2 * out_pose_jac_num_alloc, global_thread_idx, r15, r40);
    r12 = r13 * r7;
    r18 = r11 + r18;
    r49 = r45 + r49;
    r49 = fma(r8, r49, r9 * r18);
    r12 = r12 * r49;
    r18 = r16 * r6;
    r17 = r22 + r17;
    ...
    r34 = r34 * r29;
    r12 = r17 * r28;
    r12 = fma(r37, r12, r28 * r34);
    r12 = fma(r41, r1, r12);
    r41 = r0 * r18;
    r41 = r41 * r29;
    r41 = fma(r38, r41, r17 * r32);
    r41 = fma(r49, r1, r41);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 4 * out_pose_jac_num_alloc, global_thread_idx, r12, r41);
    r49 = r0 * r5;
    r49 = r49 * r13;
    r49 = r49 * r6;
    r49 = r49 * r7;
    ...
    r31 = fma(r9, r31, r1);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 6 * out_pose_jac_num_alloc, global_thread_idx, r31, r49);
    r19 = r0 * r13;
    r19 = r19 * r7;
    r19 = r19 * r27;
    r19 = fma(r38, r19, r1);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 8 * out_pose_jac_num_alloc, global_thread_idx, r49, r19);
    r1 = r16 * r6;
    r1 = r1 * r6;
    r8 = r16 * r7;
    r8 = r8 * r7;
    r8 = fma(r27, r8, r27 * r1);
    r1 = r5 * r8;
    r1 = r1 * r29;
    r37 = fma(r28, r37, r28 * r1);
    r1 = r0 * r8;
    r1 = r1 * r29;
    r1 = fma(r38, r1, r32);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 10 * out_pose_jac_num_alloc, global_thread_idx, r37, r1);
    r32 = r4 * r2;
    r29 = r4 * r3;
    r29 = fma(r43, r29, r23 * r32);
    r32 = r4 * r2;
    r27 = r4 * r3;
    r27 = fma(r40, r27, r15 * r32);
    write_sum_2<double, double>((double*)inout_shared, r29, r27);
  };
  ...
  if (global_thread_idx < problem_size) {
    r27 = r4 * r2;
    r29 = r4 * r3;
    r29 = fma(r41, r29, r12 * r27);
    r27 = r4 * r2;
    r32 = r16 * r3;
    r47 = r38 * r34;
    r32 = fma(r47, r32, r31 * r27);
  ...
  if (global_thread_idx < problem_size) {
    r32 = r4 * r3;
    r29 = r4 * r2;
    r29 = fma(r37, r29, r1 * r32);
    r32 = r4 * r3;
    r27 = r16 * r2;
    r27 = fma(r47, r27, r19 * r32);
    write_sum_2<double, double>((double*)inout_shared, r27, r29);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r29 = r29 * r9;
    r9 = fma(r31, r31, r29);
    write_sum_2<double, double>((double*)inout_shared, r27, r9);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    r29 = fma(r19, r19, r29);
    r9 = fma(r37, r37, r1 * r1);
    write_sum_2<double, double>((double*)inout_shared, r29, r9);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r29 = fma(r23, r12, r43 * r41);
    write_sum_2<double, double>((double*)inout_shared, r9, r29);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r29 = fma(r43, r49, r23 * r31);
    r9 = fma(r23, r49, r43 * r19);
    write_sum_2<double, double>((double*)inout_shared, r29, r9);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r23 = fma(r23, r37, r43 * r1);
    r43 = fma(r40, r41, r15 * r12);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r43 = fma(r40, r49, r15 * r31);
    r23 = fma(r15, r49, r40 * r19);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r40 = fma(r40, r1, r15 * r37);
    r15 = fma(r41, r49, r12 * r31);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fma(r12, r37, r41 * r1);
    r12 = fma(r12, r49, r41 * r19);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fma(r19, r49, r31 * r49);
    r31 = fma(r1, r49, r31 * r37);
  ...
  if (global_thread_idx < problem_size) {
    r49 = r4 * r2;
    r37 = r4 * r3;
    write_sum_2<double, double>((double*)inout_shared, r49, r37);
  };
...
void simple_radial_fixed_focal_and_extra_fixed_point_res_jac(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* principal_point,
  ...
  simple_radial_fixed_focal_and_extra_fixed_point_res_jac_kernel<<<n_blocks,
                                                                   1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
