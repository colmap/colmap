...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_focal_fixed_point_jtjnjtr_direct_kernel(
...
void simple_radial_fixed_pose_fixed_focal_fixed_point_jtjnjtr_direct(
    double* extra_calib_njtr,
    unsigned int extra_calib_njtr_num_alloc,
    SharedIndex* extra_calib_njtr_indices,
    double* extra_calib_jac,
