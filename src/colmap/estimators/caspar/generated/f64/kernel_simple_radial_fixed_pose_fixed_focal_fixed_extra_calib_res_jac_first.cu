...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_focal_fixed_extra_calib_res_jac_first_kernel(
        double* point,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = 1.0 / r28;
    read_idx_1<1024, double, double, double>(
        focal, 0 * focal_num_alloc, global_thread_idx, r26);
    read_idx_1<1024, double, double, double>(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r9 = r9 * r8;
    r9 = r9 * r25;
    r20 = fma(r6, r9, r18 * r20);
    r20 = fma(r11, r22, r20);
    r8 = r4 * r2;
    r33 = r4 * r18;
    r33 = r33 * r32;
    r28 = fma(r27, r33, r24 * r22);
    r28 = fma(r0, r9, r28);
    r8 = fma(r28, r8, r20 * r1);
    r1 = r4 * r3;
    r9 = r26 * r29;
    r34 = r14 * r17;
    r34 = fma(r15, r16, r32 * r34);
    r35 = r15 * r30;
    r34 = fma(r7, r35, r34);
    r36 = r14 * r21;
    r36 = r36 * r6;
    ...
    r35 = fma(r15, r33, r35);
    r36 = fma(r35, r36, r9 * r1);
    write_sum_2<double, double>((double*)inout_shared, r8, r36);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r8 = r8 * r4;
    r8 = r8 * r31;
    r8 = fma(r18, r8, r5 * r22);
    r18 = r26 * r29;
    r1 = r14 * r19;
    r16 = fma(r23, r16, r32 * r1);
    r1 = r14 * r5;
    r1 = r1 * r6;
    r16 = fma(r31, r1, r16);
    r31 = r23 * r30;
  ...
  flush_sum_shared<1, double>(out_point_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r18 = fma(r28, r28, r20 * r20);
    r36 = fma(r35, r35, r9 * r9);
    write_sum_2<double, double>((double*)inout_shared, r18, r36);
  };
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r36 = fma(r20, r9, r28 * r35);
    r20 = fma(r20, r8, r28 * r31);
...
void simple_radial_fixed_pose_fixed_focal_fixed_extra_calib_res_jac_first(
    double* point,
    unsigned int point_num_alloc,
    SharedIndex* point_indices,
    double* pixel,
