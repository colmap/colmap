...
__global__ void __launch_bounds__(1024, 1)
    PinholeFocalAndExtraAlphaDenominatorOrBetaNumeratorKernel(
  ...
  __shared__ double PinholeFocalAndExtra_out_local[1];
  ...
  SumStore<double>(PinholeFocalAndExtra_out_local,
                   (double*)inout_shared,
                   0,
...
void PinholeFocalAndExtraAlphaDenominatorOrBetaNumerator(
  ...
  PinholeFocalAndExtraAlphaDenominatorOrBetaNumeratorKernel<<<n_blocks, 1024>>>(
      PinholeFocalAndExtra_p_kp1,
