...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_focal_fixed_extra_calib_jtjnjtr_direct_kernel(
        double* point_njtr,
...
void simple_radial_fixed_pose_fixed_focal_fixed_extra_calib_jtjnjtr_direct(
    double* point_njtr,
    unsigned int point_njtr_num_alloc,
    SharedIndex* point_njtr_indices,
    double* point_jac,
