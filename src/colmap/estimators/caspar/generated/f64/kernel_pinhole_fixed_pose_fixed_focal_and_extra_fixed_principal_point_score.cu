...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedPoseFixedFocalAndExtraFixedPrincipalPointScoreKernel(
        double* point,
...
void PinholeFixedPoseFixedFocalAndExtraFixedPrincipalPointScore(
    double* point,
    unsigned int point_num_alloc,
    SharedIndex* point_indices,
    double* pixel,
  ...
  PinholeFixedPoseFixedFocalAndExtraFixedPrincipalPointScoreKernel<<<n_blocks,
                                                                     1024>>>(
      point,
      point_num_alloc,
      point_indices,
