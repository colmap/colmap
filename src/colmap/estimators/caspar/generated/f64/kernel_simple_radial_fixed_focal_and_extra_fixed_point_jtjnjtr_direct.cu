...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedFocalAndExtraFixedPointJtjnjtrDirectKernel(
        double* pose_njtr,
...
void SimpleRadialFixedFocalAndExtraFixedPointJtjnjtrDirect(
    double* pose_njtr,
    unsigned int pose_njtr_num_alloc,
    SharedIndex* pose_njtr_indices,
    double* pose_jac,
  ...
  SimpleRadialFixedFocalAndExtraFixedPointJtjnjtrDirectKernel<<<n_blocks,
                                                                1024>>>(
      pose_njtr,
      pose_njtr_num_alloc,
      pose_njtr_indices,
