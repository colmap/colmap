...
__global__ void __launch_bounds__(1024, 1)
    PinholeMergedJtjnjtrDirectKernel(double* pose_njtr,
...
void PinholeMergedJtjnjtrDirect(double* pose_njtr,
                                unsigned int pose_njtr_num_alloc,
                                SharedIndex* pose_njtr_indices,
                                double* pose_jac,
                                unsigned int pose_jac_num_alloc,
  ...
  PinholeMergedJtjnjtrDirectKernel<<<n_blocks, 1024>>>(pose_njtr,
                                                       pose_njtr_num_alloc,
                                                       pose_njtr_indices,
                                                       pose_jac,
                                                       pose_jac_num_alloc,
