...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_focal_fixed_point_score_kernel(
        double* pose,
...
void pinhole_fixed_focal_fixed_point_score(double* pose,
                                           unsigned int pose_num_alloc,
                                           SharedIndex* pose_indices,
                                           double* extra_calib,
                                           unsigned int extra_calib_num_alloc,
  ...
  pinhole_fixed_focal_fixed_point_score_kernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      extra_calib,
