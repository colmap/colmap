...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialMergedFixedPointScoreKernel(double* pose,
...
void SimpleRadialMergedFixedPointScore(double* pose,
                                       unsigned int pose_num_alloc,
                                       SharedIndex* pose_indices,
                                       double* calib,
                                       unsigned int calib_num_alloc,
  ...
  SimpleRadialMergedFixedPointScoreKernel<<<n_blocks, 1024>>>(pose,
                                                              pose_num_alloc,
                                                              pose_indices,
                                                              calib,
                                                              calib_num_alloc,
