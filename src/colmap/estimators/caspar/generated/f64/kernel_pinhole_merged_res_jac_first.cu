...
__global__ void __launch_bounds__(1024, 1) PinholeMergedResJacFirstKernel(
    double* pose,
...
void PinholeMergedResJacFirst(double* pose,
                              unsigned int pose_num_alloc,
                              SharedIndex* pose_indices,
                              double* calib,
                              unsigned int calib_num_alloc,
  ...
  PinholeMergedResJacFirstKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      calib,
