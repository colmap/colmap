...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    read_idx_2<1024, double, double, double2>(
        precond_tril, 0 * precond_tril_num_alloc, global_thread_idx, r7, r8);
    r7 = r8 * r2;
    r9 = r4 * r7;
    read_idx_1<1024, double, double, double>(
        njtr, 2 * njtr_num_alloc, global_thread_idx, r10);
    r10 = fma(r0, r9, r10);
    r11 = r1 * r4;
    read_idx_1<1024, double, double, double>(
        precond_tril, 2 * precond_tril_num_alloc, global_thread_idx, r12);
    r3 = fma(r3, r5, r6);
    r3 = 1.0 / r3;
    r13 = r12 * r3;
    r10 = fma(r13, r11, r10);
    r7 = fma(r8, r7, r12 * r13);
    r7 = fma(r4, r7, r6);
    read_idx_1<1024, double, double, double>(
    ...
    write_idx_1<1024, double, double, double>(
        out_normalized, 2 * out_normalized_num_alloc, global_thread_idx, r7);
  };
}

void SimpleRadialExtraCalib_normalize(double* precond_diag,
                                      unsigned int precond_diag_num_alloc,
                                      double* precond_tril,
                                      unsigned int precond_tril_num_alloc,
                                      double* njtr,
