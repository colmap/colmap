...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r8 = fma(r27, r8, r28);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 6 * out_pose_jac_num_alloc, global_thread_idx, r8, r21);
    r6 = r0 * r15;
    r6 = r6 * r5;
    r6 = r6 * r39;
    r6 = fma(r49, r6, r28);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 8 * out_pose_jac_num_alloc, global_thread_idx, r21, r6);
    r19 = r41 + r47;
    r13 = r29 * r19;
    r13 = r13 * r23;
    r13 = fma(r27, r13, r27 * r38);
    r45 = r0 * r19;
    r45 = r45 * r23;
    r10 = r0 * r5;
    r10 = fma(r38, r10, r49 * r45);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 10 * out_pose_jac_num_alloc, global_thread_idx, r13, r10);
    r45 = r4 * r3;
    r44 = r4 * r2;
    r44 = fma(r40, r44, r52 * r45);
    r45 = r4 * r2;
    r24 = r4 * r3;
    r24 = fma(r30, r24, r17 * r45);
    write_sum_2<double, double>((double*)inout_shared, r44, r24);
  };
  ...
  if (global_thread_idx < problem_size) {
    r24 = r4 * r3;
    r44 = r4 * r2;
    r44 = fma(r7, r44, r37 * r24);
    r24 = r4 * r2;
    r39 = r11 * r39;
    r11 = r3 * r39;
    r45 = r27 * r49;
    r11 = fma(r45, r11, r8 * r24);
    write_sum_2<double, double>((double*)inout_shared, r44, r11);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    r11 = r4 * r2;
    r44 = r4 * r3;
    r44 = fma(r10, r44, r13 * r11);
    r11 = r4 * r3;
    r24 = r2 * r39;
    r24 = fma(r45, r24, r6 * r11);
    write_sum_2<double, double>((double*)inout_shared, r24, r44);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r44 = fma(r52, r52, r40 * r40);
    r24 = fma(r17, r17, r30 * r30);
    write_sum_2<double, double>((double*)inout_shared, r44, r24);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r44 = r44 * r45;
    r45 = fma(r8, r8, r44);
    write_sum_2<double, double>((double*)inout_shared, r24, r45);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    r44 = fma(r6, r6, r44);
    r45 = fma(r13, r13, r10 * r10);
    write_sum_2<double, double>((double*)inout_shared, r44, r45);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r45 = fma(r40, r17, r52 * r30);
    r44 = fma(r40, r7, r52 * r37);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r44 = fma(r52, r21, r40 * r8);
    r45 = fma(r40, r21, r52 * r6);
    write_sum_2<double, double>((double*)inout_shared, r44, r45);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r52 = fma(r30, r21, r17 * r8);
    r40 = fma(r17, r21, r30 * r6);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r17 = fma(r17, r13, r30 * r10);
    r30 = fma(r37, r21, r7 * r8);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r30 = fma(r37, r10, r7 * r13);
    r7 = fma(r7, r21, r37 * r6);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r30 = fma(r8, r21, r6 * r21);
    r8 = fma(r10, r21, r8 * r13);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r13 = r29 * r21;
    r13 = r13 * r23;
    r13 = fma(r26, r28, r27 * r13);
    r10 = r18 * r27;
    r13 = fma(r38, r10, r13);
    r10 = r0 * r18;
    r10 = r10 * r5;
    r10 = fma(r14, r28, r38 * r10);
    r6 = r0 * r21;
    r6 = r6 * r23;
    r10 = fma(r49, r6, r10);
    ...
    r30 = r0 * r35;
    r30 = r30 * r5;
    r30 = fma(r22, r28, r38 * r30);
    r7 = r0 * r8;
    r7 = r7 * r23;
    r30 = fma(r49, r7, r30);
    write_idx_2<1024, double, double, double2>(
        out_point_jac, 2 * out_point_jac_num_alloc, global_thread_idx, r6, r30);
    r7 = r15 * r20;
    r7 = r7 * r1;
    r41 = fma(r25, r41, r32 * r7);
    r7 = r15 * r33;
    r7 = r7 * r5;
    r41 = fma(r32, r7, r41);
    r41 = fma(r25, r47, r41);
    ...
    r7 = r4 * r2;
    r38 = r4 * r3;
    r38 = fma(r10, r38, r13 * r7);
    r7 = r4 * r2;
    r49 = r4 * r3;
    r49 = fma(r30, r49, r6 * r7);
  ...
  flush_sum_shared<1, double>(out_point_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r38 = fma(r10, r10, r13 * r13);
    r49 = fma(r30, r30, r6 * r6);
    write_sum_2<double, double>((double*)inout_shared, r38, r49);
  };
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r49 = fma(r13, r6, r10 * r30);
    r10 = fma(r10, r28, r13 * r47);
    write_sum_2<double, double>((double*)inout_shared, r49, r10);
  };
