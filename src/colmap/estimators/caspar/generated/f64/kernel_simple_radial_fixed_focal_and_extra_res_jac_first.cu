...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedFocalAndExtraResJacFirstKernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double*)inout_shared, r46, r12);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double*)inout_shared, r46, r13);
  };
  FlushSumShared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double*)inout_shared, r12, r46);
  };
  FlushSumShared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double*)inout_shared, r46, r26);
  };
  FlushSumShared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double*)inout_shared, r26, r46);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double*)inout_shared, r50, r45);
  };
...
void SimpleRadialFixedFocalAndExtraResJacFirst(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* principal_point,
  ...
  SimpleRadialFixedFocalAndExtraResJacFirstKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      principal_point,
