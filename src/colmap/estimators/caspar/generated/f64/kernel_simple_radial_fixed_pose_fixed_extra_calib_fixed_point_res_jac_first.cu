...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_extra_calib_fixed_point_res_jac_first_kernel(
        double* focal,
  ...
  if (global_thread_idx < problem_size) {
    read_idx_1<1024, double, double, double>(
        extra_calib, 2 * extra_calib_num_alloc, global_thread_idx, r18);
...
void simple_radial_fixed_pose_fixed_extra_calib_fixed_point_res_jac_first(
    double* focal,
    unsigned int focal_num_alloc,
    SharedIndex* focal_indices,
    double* pixel,
