...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_pose_fixed_extra_calib_fixed_point_res_jac_kernel(
        double* focal,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r4 = r4 * r3;
    r4 = r4 * r25;
    write_sum_2<double, double>((double*)inout_shared, r2, r4);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r4 = r1 * r1;
    r4 = r24 * r4;
    write_sum_2<double, double>((double*)inout_shared, r19, r4);
  };
...
void pinhole_fixed_pose_fixed_extra_calib_fixed_point_res_jac(
    double* focal,
    unsigned int focal_num_alloc,
    SharedIndex* focal_indices,
    double* pixel,
  ...
  pinhole_fixed_pose_fixed_extra_calib_fixed_point_res_jac_kernel<<<n_blocks,
                                                                    1024>>>(
      focal,
      focal_num_alloc,
      focal_indices,
