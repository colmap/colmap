...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_focal_and_extra_fixed_principal_point_fixed_point_score_kernel(
        double* pose,
...
void pinhole_fixed_focal_and_extra_fixed_principal_point_fixed_point_score(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* pixel,
