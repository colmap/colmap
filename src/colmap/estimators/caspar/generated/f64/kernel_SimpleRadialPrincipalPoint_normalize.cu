...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialPrincipalPoint_normalize_kernel(
        double* precond_diag,
...
void SimpleRadialPrincipalPoint_normalize(double* precond_diag,
                                          unsigned int precond_diag_num_alloc,
                                          double* precond_tril,
                                          unsigned int precond_tril_num_alloc,
                                          double* njtr,
  ...
  SimpleRadialPrincipalPoint_normalize_kernel<<<n_blocks, 1024>>>(
      precond_diag,
