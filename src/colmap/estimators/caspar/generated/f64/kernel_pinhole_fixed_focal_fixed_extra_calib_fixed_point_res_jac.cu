...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_focal_fixed_extra_calib_fixed_point_res_jac_kernel(
        double* pose,
...
void pinhole_fixed_focal_fixed_extra_calib_fixed_point_res_jac(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* pixel,
  ...
  pinhole_fixed_focal_fixed_extra_calib_fixed_point_res_jac_kernel<<<n_blocks,
                                                                     1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
