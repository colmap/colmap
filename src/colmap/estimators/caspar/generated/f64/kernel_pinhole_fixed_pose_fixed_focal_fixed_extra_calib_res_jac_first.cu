...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_pose_fixed_focal_fixed_extra_calib_res_jac_first_kernel(
        double* point,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r8 = r15 * r25;
    r12 = r26 * r16;
    r12 = fma(r0, r12, r6 * r8);
    r8 = r4 * r2;
    r28 = r5 * r29;
    r28 = fma(r0, r28, r15 * r27);
    r8 = fma(r28, r8, r12 * r7);
    write_sum_2<double, double>((double*)inout_shared, r20, r8);
  };
  ...
  flush_sum_shared<1, double>(out_point_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r20 = fma(r22, r22, r21 * r21);
    r8 = fma(r28, r28, r12 * r12);
    write_sum_2<double, double>((double*)inout_shared, r20, r8);
  };
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r8 = fma(r21, r12, r22 * r28);
    r21 = fma(r21, r7, r22 * r6);
    write_sum_2<double, double>((double*)inout_shared, r8, r21);
  };
...
void pinhole_fixed_pose_fixed_focal_fixed_extra_calib_res_jac_first(
    double* point,
    unsigned int point_num_alloc,
    SharedIndex* point_indices,
    double* pixel,
