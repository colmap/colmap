...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_extra_calib_res_jac_kernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    read_shared_2<double>(
        (double*)inout_shared, focal_indices_loc[threadIdx.x].target, r5, r28);
  };
  __syncthreads();
  load_shared<2, double, double>(
  ...
  if (global_thread_idx < problem_size) {
    r7 = r4 * r2;
    r40 = r4 * r3;
    r40 = fma(r6, r40, r46 * r7);
    r7 = r4 * r2;
    r7 = r7 * r0;
    r32 = r5 * r7;
    write_sum_2<double, double>((double*)inout_shared, r40, r32);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r32, r41);
  };
  flush_sum_shared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r32, r40);
  };
  flush_sum_shared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r18, r40);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r18 = r28 * r21;
    r18 = r18 * r0;
    write_sum_2<double, double>((double*)inout_shared, r40, r18);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r18, r17);
  };
  flush_sum_shared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r7 = r30 * r30;
    r7 = r7 * r44;
    write_sum_2<double, double>((double*)inout_shared, r9, r7);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r22, r43);
  };
...
void pinhole_fixed_extra_calib_res_jac(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* focal,
  ...
  pinhole_fixed_extra_calib_res_jac_kernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      focal,
