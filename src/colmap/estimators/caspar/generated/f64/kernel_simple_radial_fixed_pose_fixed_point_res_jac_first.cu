...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r11 = r11 * r22;
    write_idx_2<1024, double, double, double2>(
        out_focal_jac, 0 * out_focal_jac_num_alloc, global_thread_idx, r1, r11);
    r11 = r23 * r22;
    r2 = r4 * r2;
    r1 = r17 * r2;
    r12 = r15 * r23;
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_idx_2<1024, double, double, double2>(
        ...
        r11);
    r26 = r4 * r3;
    write_sum_2<double, double>((double*)inout_shared, r2, r26);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r7, r12);
  };
