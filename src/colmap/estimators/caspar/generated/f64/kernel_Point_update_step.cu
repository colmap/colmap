...
__global__ void __launch_bounds__(1024, 1)
    Point_update_step_kernel(double* Point_step_k,
  ...
  if (global_thread_idx < problem_size) {
    read_idx_2<1024, double, double, double2>(
        Point_step_k, 0 * Point_step_k_num_alloc, global_thread_idx, r0, r1);
    read_idx_2<1024, double, double, double2>(
  ...
  if (global_thread_idx < problem_size) {
    r2 = fma(r2, r4, r0);
    r3 = fma(r3, r4, r1);
    write_idx_2<1024, double, double, double2>(out_Point_step_kp1,
    ...
    read_idx_1<1024, double, double, double>(
        Point_p_kp1, 2 * Point_p_kp1_num_alloc, global_thread_idx, r2);
    r4 = fma(r2, r4, r3);
    write_idx_1<1024, double, double, double>(out_Point_step_kp1,
