...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    r40 = r19 * r38;
    r45 = fma(r28, r40, r27 * r1);
    r44 = r16 * r27;
    r44 = r44 * r5;
    r44 = fma(r32, r44, r19 * r47);
    r14 = r16 * r15;
    r14 = r14 * r6;
    r44 = fma(r32, r14, r44);
    r44 = fma(r19, r48, r44);
    ...
    r40 = r29 * r19;
    r40 = r40 * r24;
    r40 = fma(r17, r1, r28 * r40);
    r22 = r35 * r28;
    r40 = fma(r38, r22, r40);
    r22 = r0 * r19;
    r22 = r22 * r24;
    r22 = fma(r23, r1, r50 * r22);
    r18 = r0 * r35;
    r18 = r18 * r6;
    r22 = fma(r38, r18, r22);
    write_idx_2<1024, double, double, double2>(out_point_jac,
    ...
    r1 = r4 * r3;
    r50 = r4 * r2;
    r50 = fma(r45, r50, r14 * r1);
    r1 = r4 * r3;
    r24 = r4 * r2;
    r24 = fma(r40, r24, r22 * r1);
  ...
  flush_sum_shared<1, double>(out_point_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r50 = fma(r45, r45, r14 * r14);
    r24 = fma(r40, r40, r22 * r22);
    write_sum_2<double, double>((double*)inout_shared, r50, r24);
  };
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r24 = fma(r14, r22, r45 * r40);
    r14 = fma(r14, r18, r45 * r48);
