...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_focal_fixed_extra_calib_fixed_point_score_kernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r17 = fma(r6, r23, r17);
    read_idx_1<1024, double, double, double>(
        focal, 0 * focal_num_alloc, global_thread_idx, r23);
    read_idx_1<1024, double, double, double>(
...
void simple_radial_fixed_focal_fixed_extra_calib_fixed_point_score(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* pixel,
