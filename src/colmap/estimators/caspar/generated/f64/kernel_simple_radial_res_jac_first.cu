...
__global__ void __launch_bounds__(1024, 1) simple_radial_res_jac_first_kernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r21 = r21 * r42;
    r9 = r10 * r29;
    r9 = fma(r52, r9, r29 * r21);
    r9 = fma(r23, r1, r9);
    r23 = r0 * r7;
    r23 = r23 * r10;
    r21 = r0 * r44;
    r21 = r21 * r42;
    r21 = fma(r56, r21, r52 * r23);
    r21 = fma(r57, r1, r21);
    write_idx_2<1024, double, double, double2>(
    ...
    r23 = fma(r29, r23, r1);
    write_idx_2<1024, double, double, double2>(
        out_pose_jac, 6 * out_pose_jac_num_alloc, global_thread_idx, r23, r57);
    r8 = r0 * r17;
    r8 = r8 * r7;
    r8 = r8 * r39;
    r8 = fma(r56, r8, r1);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r11 = fma(r9, r47, r21 * r15);
    r9 = fma(r9, r57, r21 * r8);
  ...
  flush_sum_shared<2, double>(out_pose_precond_tril,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r11 = fma(r8, r57, r23 * r57);
    r23 = fma(r15, r57, r23 * r47);
  ...
  if (global_thread_idx < problem_size) {
    r25 = r20 * r52;
    r15 = fma(r29, r25, r28 * r1);
    r47 = r17 * r28;
    r47 = r47 * r6;
    r47 = fma(r32, r47, r20 * r41);
    r30 = r17 * r16;
    r30 = r30 * r7;
    r47 = fma(r32, r30, r47);
    r47 = fma(r20, r50, r47);
    ...
    r20 = r0 * r47;
    r20 = r20 * r42;
    r8 = fma(r25, r8, r56 * r20);
    r8 = fma(r16, r1, r8);
    write_idx_2<1024, double, double, double2>(
        out_point_jac, 0 * out_point_jac_num_alloc, global_thread_idx, r15, r8);
    r25 = r35 * r29;
    r25 = fma(r18, r1, r52 * r25);
    r20 = r17 * r18;
    r20 = r20 * r6;
    r20 = fma(r35, r41, r32 * r20);
    r30 = r17 * r24;
    r30 = r30 * r7;
    r20 = fma(r32, r30, r20);
    r20 = fma(r35, r50, r20);
    ...
    write_idx_2<1024, double, double, double2>(out_point_jac,
                                               ...
                                               r30);
    r43 = r27 * r29;
    r43 = fma(r22, r1, r52 * r43);
    r23 = r17 * r22;
    r23 = r23 * r6;
    r41 = fma(r27, r41, r32 * r23);
    r23 = r17 * r33;
    r23 = r23 * r7;
    r41 = fma(r32, r23, r41);
    r41 = fma(r27, r50, r41);
    ...
    r1 = fma(r52, r50, r1);
    write_idx_2<1024, double, double, double2>(
        out_point_jac, 4 * out_point_jac_num_alloc, global_thread_idx, r43, r1);
    r50 = r4 * r3;
    r52 = r4 * r2;
    r52 = fma(r15, r52, r8 * r50);
    r50 = r4 * r3;
    r56 = r4 * r2;
    r56 = fma(r25, r56, r30 * r50);
  ...
  flush_sum_shared<1, double>(out_point_njtr,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r52 = fma(r8, r8, r15 * r15);
    r56 = fma(r25, r25, r30 * r30);
    write_sum_2<double, double>((double*)inout_shared, r52, r56);
  };
  ...
  flush_sum_shared<1, double>(out_point_precond_diag,
                              ...
                              (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r56 = fma(r8, r30, r15 * r25);
    r15 = fma(r15, r43, r8 * r1);
    write_sum_2<double, double>((double*)inout_shared, r56, r15);
  };
