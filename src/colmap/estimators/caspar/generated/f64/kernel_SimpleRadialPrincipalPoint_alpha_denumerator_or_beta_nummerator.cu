...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialPrincipalPoint_alpha_denumerator_or_beta_nummerator_kernel(
  ...
  sum_store<double>(SimpleRadialPrincipalPoint_out_local,
                    (double*)inout_shared,
                    0,
...
void SimpleRadialPrincipalPoint_alpha_denumerator_or_beta_nummerator(
  ...
  SimpleRadialPrincipalPoint_alpha_denumerator_or_beta_nummerator_kernel<<<
      n_blocks,
      1024>>>(SimpleRadialPrincipalPoint_p_kp1,
