...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r15, r46);
  };
  ...
  if (global_thread_idx < problem_size) {
    r54 = r4 * r2;
    r51 = r4 * r3;
    write_sum_2<double, double>((double*)inout_shared, r54, r51);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<double, double>((double*)inout_shared, r50, r25);
  };
