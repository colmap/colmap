...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedFocalAndExtraResJacKernel(
        double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r10 = fma(r50, r10, r1);
    WriteIdx2<1024, double, double, double2>(
        out_pose_jac, 8 * out_pose_jac_num_alloc, global_thread_idx, r54, r10);
    r8 = r41 + r48;
    r51 = r5 * r8;
    r51 = r51 * r30;
    r51 = fma(r29, r38, r29 * r51);
    r45 = r0 * r8;
    r45 = r45 * r30;
    r26 = r0 * r7;
    r26 = fma(r38, r26, r50 * r45);
    WriteIdx2<1024, double, double, double2>(
        out_pose_jac, 10 * out_pose_jac_num_alloc, global_thread_idx, r51, r26);
    r45 = r4 * r2;
    r15 = r4 * r3;
    r15 = fma(r44, r15, r40 * r45);
    r45 = r4 * r2;
    r46 = r4 * r3;
    r46 = fma(r34, r46, r11 * r45);
    WriteSum2<double, double>((double*)inout_shared, r15, r46);
  };
  ...
  if (global_thread_idx < problem_size) {
    r46 = r4 * r2;
    r15 = r4 * r3;
    r15 = fma(r9, r15, r21 * r46);
    r46 = r4 * r2;
    r39 = r13 * r39;
    r13 = r3 * r39;
    r45 = r29 * r50;
    r13 = fma(r45, r13, r23 * r46);
    WriteSum2<double, double>((double*)inout_shared, r15, r13);
  };
  FlushSumShared<2, double>(out_pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    r13 = r4 * r3;
    r15 = r4 * r2;
    r15 = fma(r51, r15, r26 * r13);
    r13 = r4 * r3;
    r46 = r2 * r39;
    r46 = fma(r45, r46, r10 * r13);
  ...
  FlushSumShared<2, double>(out_pose_njtr,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fma(r44, r44, r40 * r40);
    r46 = fma(r11, r11, r34 * r34);
    WriteSum2<double, double>((double*)inout_shared, r15, r46);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = r15 * r45;
    r45 = fma(r23, r23, r15);
    WriteSum2<double, double>((double*)inout_shared, r46, r45);
  };
  FlushSumShared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    r15 = fma(r10, r10, r15);
    r45 = fma(r51, r51, r26 * r26);
    WriteSum2<double, double>((double*)inout_shared, r15, r45);
  };
  FlushSumShared<2, double>(out_pose_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r45 = fma(r40, r11, r44 * r34);
    r15 = fma(r40, r21, r44 * r9);
    WriteSum2<double, double>((double*)inout_shared, r45, r15);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fma(r44, r54, r40 * r23);
    r45 = fma(r40, r54, r44 * r10);
    WriteSum2<double, double>((double*)inout_shared, r15, r45);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r40 = fma(r40, r51, r44 * r26);
    r44 = fma(r34, r9, r11 * r21);
    WriteSum2<double, double>((double*)inout_shared, r40, r44);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r40 = fma(r11, r54, r34 * r10);
    WriteSum2<double, double>((double*)inout_shared, r44, r40);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r34 = fma(r34, r26, r11 * r51);
    r11 = fma(r9, r54, r21 * r23);
  ...
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r11 = fma(r21, r51, r9 * r26);
    r21 = fma(r21, r54, r9 * r10);
  ...
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r11 = fma(r10, r54, r23 * r54);
    r23 = fma(r26, r54, r23 * r51);
  ...
  if (global_thread_idx < problem_size) {
    r54 = r4 * r2;
    r51 = r4 * r3;
    WriteSum2<double, double>((double*)inout_shared, r54, r51);
  };
  ...
  if (global_thread_idx < problem_size) {
    r25 = r20 * r29;
    r25 = fma(r38, r25, r28 * r1);
    r51 = r17 * r28;
    r51 = r51 * r6;
    r51 = fma(r32, r51, r20 * r41);
    r54 = r17 * r16;
    r54 = r54 * r7;
    r51 = fma(r32, r54, r51);
    r51 = fma(r20, r48, r51);
    ...
    WriteIdx2<1024, double, double, double2>(out_point_jac,
                                             ...
                                             r26);
    r54 = r35 * r29;
    r54 = fma(r18, r1, r38 * r54);
    r10 = r17 * r18;
    r10 = r10 * r6;
    r10 = fma(r35, r41, r32 * r10);
    r23 = r17 * r24;
    r23 = r23 * r7;
    r10 = fma(r32, r23, r10);
    r10 = fma(r35, r48, r10);
    ...
    r48 = r4 * r3;
    r38 = r4 * r2;
    r38 = fma(r25, r38, r26 * r48);
    r48 = r4 * r3;
    r50 = r4 * r2;
    r50 = fma(r54, r50, r23 * r48);
    WriteSum2<double, double>((double*)inout_shared, r38, r50);
  };
  ...
  if (global_thread_idx < problem_size) {
    r50 = r4 * r2;
    r38 = r4 * r3;
    r38 = fma(r1, r38, r11 * r50);
    WriteSum1<double, double>((double*)inout_shared, r38);
  };
  FlushSumShared<1, double>(out_point_njtr,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r38 = fma(r26, r26, r25 * r25);
    r50 = fma(r54, r54, r23 * r23);
    WriteSum2<double, double>((double*)inout_shared, r38, r50);
  };
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r50 = fma(r26, r23, r25 * r54);
    r25 = fma(r25, r11, r26 * r1);
    WriteSum2<double, double>((double*)inout_shared, r50, r25);
  };
  FlushSumShared<2, double>(out_point_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r11 = fma(r54, r11, r23 * r1);
    WriteSum1<double, double>((double*)inout_shared, r11);
  };
...
void SimpleRadialFixedFocalAndExtraResJac(
    double* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    double* principal_point,
  ...
  SimpleRadialFixedFocalAndExtraResJacKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      principal_point,
