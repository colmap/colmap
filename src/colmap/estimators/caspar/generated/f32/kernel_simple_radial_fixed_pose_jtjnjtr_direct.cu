...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    read_idx_4<1024, float, float, float4>(point_jac,
                                           ...
                                           r13,
                                           r14);
    r15 = fmaf(r7, r14, r8 * r10);
    r15 = fmaf(r6, r12, r15);
    r16 = r5 + r15;
    r7 = fmaf(r7, r13, r8 * r9);
    r7 = fmaf(r6, r11, r7);
    r6 = r4 + r7;
    r8 = fmaf(r0, r6, r1 * r16);
    r6 = fmaf(r2, r6, r3 * r16);
    write_sum_2<float, float>((float*)inout_shared, r8, r6);
  };
  ...
  if (global_thread_idx < problem_size) {
    r3 = r5 + r3;
    r2 = r4 + r2;
    r11 = fmaf(r11, r2, r12 * r3);
    r13 = fmaf(r13, r2, r14 * r3);
    r2 = fmaf(r9, r2, r10 * r3);
    write_sum_3<float, float>((float*)inout_shared, r11, r13, r2);
  };
