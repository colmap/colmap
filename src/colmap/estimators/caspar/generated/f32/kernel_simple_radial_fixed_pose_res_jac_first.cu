...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r27 = r27 * r33;
    r10 = r10 * r27;
    r9 = fmaf(r0, r10, r6 * r23);
    r26 = r25 * r13;
    r9 = fmaf(r33, r26, r9);
    r26 = r6 * r32;
    r10 = fmaf(r5, r10, r34 * r26);
    r26 = r15 * r13;
    r10 = fmaf(r33, r26, r10);
    r26 = r19 * r13;
    r26 = fmaf(r33, r26, r17 * r23);
    r35 = r16 * r19;
    r35 = r35 * r0;
    r1 = r17 * r30;
    r35 = fmaf(r7, r1, r8 * r35);
    r31 = r5 * r5;
    r35 = fmaf(r1, r31, r35);
    r1 = r16 * r22;
    r35 = fmaf(r32, r1, r35);
  ...
  flush_sum_shared<3, float>(out_point_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fmaf(r10, r31, r9 * r26);
    r10 = fmaf(r10, r1, r9 * r8);
    r1 = fmaf(r31, r1, r26 * r8);
    write_sum_3<float, float>((float*)inout_shared, r33, r10, r1);
  };
