...
__global__ void __launch_bounds__(1024, 1) pinhole_fixed_focal_res_jac_kernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r39 = r39 * r2;
    r39 = r39 * r0;
    write_sum_4<float, float>((float*)inout_shared, r10, r34, r32, r39);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r39, r34);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r39, r32, r10, r34);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r9 = r30 * r51;
    r9 = r9 * r0;
    write_sum_4<float, float>((float*)inout_shared, r32, r34, r10, r9);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r32, r9, r10, r34);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r9, r34, r10, r20);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r36 = r36 * r44;
    r39 = r44 * r39;
    write_sum_3<float, float>((float*)inout_shared, r20, r36, r39);
  };
  ...
  if (global_thread_idx < problem_size) {
    r39 = r4 * r2;
    r36 = r4 * r3;
    write_sum_2<float, float>((float*)inout_shared, r39, r36);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r0, r39, r20);
  };
