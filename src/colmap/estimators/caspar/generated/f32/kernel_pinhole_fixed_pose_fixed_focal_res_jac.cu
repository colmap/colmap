...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_pose_fixed_focal_res_jac_kernel(
        float* extra_calib,
  ...
  flush_sum_shared<3, float>(out_point_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r6 = fmaf(r24, r24, r9 * r9);
    r8 = fmaf(r11, r11, r10 * r10);
    r0 = fmaf(r23, r23, r15 * r15);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r9 = fmaf(r9, r15, r24 * r23);
    r23 = fmaf(r10, r23, r11 * r15);
    write_sum_3<float, float>((float*)inout_shared, r0, r9, r23);
  };
...
void pinhole_fixed_pose_fixed_focal_res_jac(
    float* extra_calib,
    unsigned int extra_calib_num_alloc,
    SharedIndex* extra_calib_indices,
    float* point,
  ...
  pinhole_fixed_pose_fixed_focal_res_jac_kernel<<<n_blocks, 1024>>>(
      extra_calib,
