...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialPose_start_w_contribute_kernel(
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r4;
    read_idx_4<1024, float, float, float4>(SimpleRadialPose_p,
    ...
    r3 = r3 * r4;
    r3 = r3 * r8;
    add_idx_4<1024, float, float, float4>(out_SimpleRadialPose_w,
    ...
    read_idx_2<1024, float, float, float2>(
        ...
        r2);
    r3 = r3 * r4;
    read_idx_2<1024, float, float, float2>(SimpleRadialPose_p,
    ...
    r4 = r2 * r4;
    r4 = r4 * r0;
    add_idx_2<1024, float, float, float2>(out_SimpleRadialPose_w,
...
void SimpleRadialPose_start_w_contribute(
  ...
  SimpleRadialPose_start_w_contribute_kernel<<<n_blocks, 1024>>>(
      SimpleRadialPose_precond_diag,
