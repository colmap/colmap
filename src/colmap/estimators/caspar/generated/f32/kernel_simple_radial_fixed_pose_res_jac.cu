...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r40, r36, r37, r32);
  };
  ...
  if (global_thread_idx < problem_size) {
    r32 = r15 * r29;
    r37 = r15 * r15;
    r37 = fmaf(r28, r37, r15 * r32);
    r36 = r0 * r23;
    r40 = r0 * r23;
    r36 = r36 * r40;
    r36 = fmaf(r28, r36, r29 * r36);
    write_sum_4<float, float>((float*)inout_shared, r37, r25, r25, r36);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = r15 * r28;
    r32 = fmaf(r40, r32, r40 * r25);
    write_sum_4<float, float>((float*)inout_shared, r2, r31, r32, r36);
  };
  flush_sum_shared<4, float>(out_calib_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    write_sum_2<float, float>((float*)inout_shared, r34, r35);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r12 = r18 * r27;
    r12 = r12 * r1;
    r12 = fmaf(r10, r12, r30 * r34);
    r34 = r7 * r7;
    r34 = r34 * r8;
    r12 = fmaf(r30, r34, r12);
    r11 = r18 * r17;
    r36 = r7 * r10;
    r12 = fmaf(r36, r11, r12);
    r11 = r1 * r12;
    r3 = r3 * r33;
    r0 = fmaf(r3, r11, r0);
    r11 = r7 * r12;
    r34 = r8 * r36;
    r34 = fmaf(r39, r34, r3 * r11);
    r11 = r17 * r15;
    r34 = fmaf(r33, r11, r34);
    r11 = r21 * r15;
    r11 = fmaf(r33, r11, r19 * r35);
    r32 = r18 * r21;
    r32 = r32 * r1;
    r31 = r19 * r30;
    r32 = fmaf(r9, r31, r10 * r32);
    r2 = r7 * r7;
    r32 = fmaf(r31, r2, r32);
    r31 = r18 * r24;
    r32 = fmaf(r36, r31, r32);
    r32 = r32 * r3;
    r11 = fmaf(r1, r32, r11);
    r31 = r19 * r36;
    r32 = fmaf(r7, r32, r39 * r31);
    r31 = r24 * r15;
    r32 = fmaf(r33, r31, r32);
    ...
    r2 = fmaf(r30, r10, r2);
    r10 = r1 * r2;
    r35 = fmaf(r26, r35, r3 * r10);
    r10 = r22 * r15;
    r35 = fmaf(r33, r10, r35);
    r10 = r26 * r36;
    r31 = r20 * r15;
    r31 = fmaf(r33, r31, r39 * r10);
    r10 = r7 * r2;
    r31 = fmaf(r3, r10, r31);
    ...
    r10 = r6 * r4;
    r3 = r6 * r5;
    r3 = fmaf(r34, r3, r0 * r10);
    r10 = r6 * r5;
    r33 = r6 * r4;
    r33 = fmaf(r11, r33, r32 * r10);
    r10 = r6 * r4;
    r39 = r6 * r5;
    r39 = fmaf(r31, r39, r35 * r10);
    write_sum_3<float, float>((float*)inout_shared, r3, r33, r39);
  };
  flush_sum_shared<3, float>(out_point_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r39 = fmaf(r0, r0, r34 * r34);
    r33 = fmaf(r11, r11, r32 * r32);
    r3 = fmaf(r31, r31, r35 * r35);
    write_sum_3<float, float>((float*)inout_shared, r39, r33, r3);
  };
  flush_sum_shared<3, float>(out_point_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r3 = fmaf(r0, r11, r34 * r32);
    r0 = fmaf(r0, r35, r34 * r31);
    r31 = fmaf(r32, r31, r11 * r35);
    write_sum_3<float, float>((float*)inout_shared, r3, r0, r31);
  };
