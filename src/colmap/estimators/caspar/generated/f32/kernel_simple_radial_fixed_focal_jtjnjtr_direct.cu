...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    read_idx_2<1024, float, float, float2>(extra_calib_jac,
                                           ...
                                           r17,
                                           r18);
    r14 = fmaf(r16, r17, r14);
    r19 = r13 + r14;
    r5 = fmaf(r5, r12, r6 * r8);
    r5 = fmaf(r4, r10, r5);
    r16 = fmaf(r16, r18, r15);
    r15 = r5 + r16;
    r4 = fmaf(r1, r15, r0 * r19);
    r6 = fmaf(r3, r15, r2 * r19);
    read_idx_4<1024, float, float, float4>(pose_jac,
                                           ...
                                           r22,
                                           r23);
    r24 = fmaf(r21, r15, r20 * r19);
    r25 = fmaf(r23, r15, r22 * r19);
  ...
  if (global_thread_idx < problem_size) {
    read_idx_4<1024, float, float, float4>(
        pose_jac, 8 * pose_jac_num_alloc, global_thread_idx, r25, r24, r6, r4);
    r26 = fmaf(r24, r15, r25 * r19);
    r19 = fmaf(r6, r19, r4 * r15);
    write_sum_2<float, float>((float*)inout_shared, r26, r19);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r23 = fmaf(r6, r1, r23);
    r23 = fmaf(r15, r3, r23);
    r23 = fmaf(r19, r24, r23);
    r5 = r23 + r5;
    r18 = fmaf(r18, r5, r17 * r13);
    write_sum_3<float, float>((float*)inout_shared, r13, r5, r18);
  };
  ...
  if (global_thread_idx < problem_size) {
    r16 = r23 + r16;
    r14 = r25 + r14;
    r9 = fmaf(r9, r14, r10 * r16);
    r11 = fmaf(r11, r14, r12 * r16);
    r14 = fmaf(r7, r14, r8 * r16);
    write_sum_3<float, float>((float*)inout_shared, r9, r11, r14);
  };
