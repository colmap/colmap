...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r26, r8);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r23 = fmaf(r8, r24, r23);
    r17 = r23 + r17;
    r17 = fmaf(r6, r17, r5 * r9);
    write_sum_1<float, float>((float*)inout_shared, r17);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r14, r16, r23);
  };
