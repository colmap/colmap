...
__global__ void __launch_bounds__(1024, 1)
  ...
  sum_store<float>(SimpleRadialFocalAndExtra_total_ag_local,
                   (float*)inout_shared,
                   0,
  ...
  sum_store<float>(SimpleRadialFocalAndExtra_total_ac_local,
                   (float*)inout_shared,
                   0,
                   global_thread_idx < problem_size,
                   r3);
  sum_flush_final<float>(SimpleRadialFocalAndExtra_total_ag_local,
                         SimpleRadialFocalAndExtra_total_ag,
                         1);
  sum_flush_final<float>(SimpleRadialFocalAndExtra_total_ac_local,
