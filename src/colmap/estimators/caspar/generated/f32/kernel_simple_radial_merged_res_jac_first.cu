...
__global__ void __launch_bounds__(1024, 1) SimpleRadialMergedResJacFirstKernel(
    float* pose,
...
void SimpleRadialMergedResJacFirst(
    float* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    float* calib,
  ...
  SimpleRadialMergedResJacFirstKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      calib,
