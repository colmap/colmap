...
__global__ void __launch_bounds__(1024, 1) PinholePrincipalPoint_start_w_kernel(
...
void PinholePrincipalPoint_start_w(
    float* PinholePrincipalPoint_precond_diag,
    unsigned int PinholePrincipalPoint_precond_diag_num_alloc,
    const float* const diag,
    float* PinholePrincipalPoint_p,
  ...
  PinholePrincipalPoint_start_w_kernel<<<n_blocks, 1024>>>(
      PinholePrincipalPoint_precond_diag,
