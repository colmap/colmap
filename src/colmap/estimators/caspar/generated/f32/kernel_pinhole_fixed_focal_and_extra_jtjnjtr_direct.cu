...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedFocalAndExtraJtjnjtrDirectKernel(
        float* pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    r23 = r21 * r6;
    ReadIdx2<1024, float, float, float2>(
        pose_jac, 8 * pose_jac_num_alloc, global_thread_idx, r22, r17);
    r6 = fmaf(r17, r6, r22 * r16);
    WriteSum2<float, float>((float*)inout_shared, r23, r6);
  };
  ...
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r18 = fmaf(r24, r18, r23 * r22);
    r18 = fmaf(r25, r20, r18);
    r18 = fmaf(r16, r0, r18);
    r18 = fmaf(r8, r2, r18);
    r15 = r18 + r15;
    r19 = fmaf(r24, r19, r23 * r17);
    r19 = fmaf(r16, r1, r19);
    r19 = fmaf(r8, r3, r19);
    r19 = fmaf(r6, r21, r19);
    r7 = r19 + r7;
  ...
  if (global_thread_idx < problem_size) {
    r19 = r5 + r19;
    r18 = r4 + r18;
    r11 = fmaf(r11, r18, r12 * r19);
    r13 = fmaf(r13, r18, r14 * r19);
    r18 = fmaf(r9, r18, r10 * r19);
    WriteSum3<float, float>((float*)inout_shared, r11, r13, r18);
  };
...
void PinholeFixedFocalAndExtraJtjnjtrDirect(
    float* pose_njtr,
    unsigned int pose_njtr_num_alloc,
    SharedIndex* pose_njtr_indices,
    float* pose_jac,
  ...
  PinholeFixedFocalAndExtraJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
      pose_njtr,
      pose_njtr_num_alloc,
      pose_njtr_indices,
      pose_jac,
