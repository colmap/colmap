...
__global__ void __launch_bounds__(1024, 1)
    PinholePose_update_p_kernel(float* PinholePose_z,
  ...
  if (global_thread_idx < problem_size) {
    read_idx_4<1024, float, float, float4>(PinholePose_p_k,
                                           ...
                                           r2,
                                           r3);
    read_idx_4<1024, float, float, float4>(PinholePose_z,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r2 = fmaf(r2, r8, r6);
    r3 = fmaf(r3, r8, r7);
    write_idx_4<1024, float, float, float4>(out_PinholePose_p_kp1,
                                            ...
                                            r2,
                                            r3);
    read_idx_2<1024, float, float, float2>(PinholePose_p_k,
    ...
    r3 = fmaf(r3, r8, r1);
    r8 = fmaf(r2, r8, r0);
    write_idx_2<1024, float, float, float2>(out_PinholePose_p_kp1,
