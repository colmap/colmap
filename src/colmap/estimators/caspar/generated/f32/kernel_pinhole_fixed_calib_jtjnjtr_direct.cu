...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_calib_jtjnjtr_direct_kernel(
        float* pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r19, r13);
  };
...
void pinhole_fixed_calib_jtjnjtr_direct(float* pose_njtr,
                                        unsigned int pose_njtr_num_alloc,
                                        SharedIndex* pose_njtr_indices,
                                        float* pose_jac,
                                        unsigned int pose_jac_num_alloc,
  ...
  pinhole_fixed_calib_jtjnjtr_direct_kernel<<<n_blocks, 1024>>>(
      pose_njtr,
      pose_njtr_num_alloc,
      pose_njtr_indices,
      pose_jac,
