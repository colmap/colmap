...
__global__ void __launch_bounds__(1024, 1) PinholeFocalAndExtraUpdateMpKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, float, float, float2>(PinholeFocalAndExtra_Mp,
...
void PinholeFocalAndExtraUpdateMp(
    float* PinholeFocalAndExtra_r_k,
    unsigned int PinholeFocalAndExtra_r_k_num_alloc,
    float* PinholeFocalAndExtra_Mp,
    unsigned int PinholeFocalAndExtra_Mp_num_alloc,
  ...
  PinholeFocalAndExtraUpdateMpKernel<<<n_blocks, 1024>>>(
