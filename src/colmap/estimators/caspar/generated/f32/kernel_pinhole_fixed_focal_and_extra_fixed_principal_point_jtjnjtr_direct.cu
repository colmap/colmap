...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedFocalAndExtraFixedPrincipalPointJtjnjtrDirectKernel(
        float* pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    r19 = r17 * r5;
    ReadIdx2<1024, float, float, float2>(
        pose_jac, 8 * pose_jac_num_alloc, global_thread_idx, r18, r6);
    r13 = fmaf(r18, r13, r6 * r5);
    WriteSum2<float, float>((float*)inout_shared, r19, r13);
  };
  ...
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r15 = fmaf(r20, r15, r19 * r6);
    r15 = fmaf(r5, r1, r15);
    r15 = fmaf(r4, r3, r15);
    r15 = fmaf(r13, r17, r15);
    r14 = fmaf(r20, r14, r19 * r18);
    r14 = fmaf(r21, r16, r14);
    r14 = fmaf(r5, r0, r14);
    r14 = fmaf(r4, r2, r14);
    r9 = fmaf(r9, r14, r10 * r15);
    r11 = fmaf(r11, r14, r12 * r15);
    r14 = fmaf(r7, r14, r8 * r15);
    WriteSum3<float, float>((float*)inout_shared, r9, r11, r14);
  };
...
void PinholeFixedFocalAndExtraFixedPrincipalPointJtjnjtrDirect(
    float* pose_njtr,
    unsigned int pose_njtr_num_alloc,
    SharedIndex* pose_njtr_indices,
    float* pose_jac,
  ...
  PinholeFixedFocalAndExtraFixedPrincipalPointJtjnjtrDirectKernel<<<n_blocks,
                                                                    1024>>>(
      pose_njtr,
      pose_njtr_num_alloc,
      pose_njtr_indices,
