...
__global__ void __launch_bounds__(1024, 1)
    pinhole_merged_fixed_point_jtjnjtr_direct_kernel(
        float* pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = r12 * r4;
    write_sum_4<float, float>((float*)inout_shared, r7, r6, r14, r15);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r15, r4);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r11 = fmaf(r4, r13, r11);
    r9 = r9 * r11;
    write_sum_4<float, float>((float*)inout_shared, r8, r9, r10, r11);
  };
...
void pinhole_merged_fixed_point_jtjnjtr_direct(
  ...
  pinhole_merged_fixed_point_jtjnjtr_direct_kernel<<<n_blocks, 1024>>>(
      pose_njtr,
      pose_njtr_num_alloc,
      pose_njtr_indices,
      pose_jac,
