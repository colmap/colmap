...
__global__ void __launch_bounds__(1024, 1) simple_radial_res_jac_first_kernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r31 = r5 * r7;
    r56 = r56 * r42;
    r46 = fmaf(r46, r1, r31 * r56);
    r56 = r0 * r7;
    r56 = r56 * r49;
    r46 = fmaf(r50, r56, r46);
    r56 = r19 * r7;
    r13 = r39 + r13;
    ...
    r22 = r14 * r30;
    r22 = fmaf(r50, r22, r24 * r1);
    r52 = r19 * r6;
    r52 = r52 * r24;
    r52 = fmaf(r14, r54, r8 * r52);
    r24 = r19 * r7;
    r44 = r16 + r44;
    r35 = r48 + r35;
    r35 = fmaf(r9, r35, r10 * r44);
    r24 = r24 * r35;
    r52 = fmaf(r8, r24, r52);
    r52 = fmaf(r14, r55, r52);
    r24 = r5 * r52;
    r24 = r24 * r42;
    ...
    r10 = r5 * r44;
    r10 = r10 * r42;
    r10 = fmaf(r30, r10, r30 * r50);
    r48 = r0 * r7;
    r16 = r0 * r44;
    r16 = r16 * r42;
    r16 = fmaf(r31, r16, r50 * r48);
    write_idx_4<1024, float, float, float4>(out_pose_jac,
    ...
    r48 = r4 * r2;
    r47 = r4 * r3;
    r47 = fmaf(r46, r47, r33 * r48);
    r48 = r4 * r2;
    r27 = r4 * r3;
    r27 = fmaf(r15, r27, r56 * r48);
    r48 = r4 * r3;
    r11 = r4 * r2;
    r11 = fmaf(r22, r11, r24 * r48);
    r48 = r4 * r2;
    r36 = r17 * r36;
    r17 = r3 * r36;
    r40 = r30 * r31;
    r17 = fmaf(r40, r17, r35 * r48);
    write_sum_4<float, float>((float*)inout_shared, r47, r27, r11, r17);
  };
  ...
  flush_sum_shared<2, float>(out_pose_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r11 = fmaf(r46, r46, r33 * r33);
    r27 = fmaf(r15, r15, r56 * r56);
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r47, r40);
  };
  flush_sum_shared<2, float>(out_pose_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r40 = fmaf(r33, r56, r46 * r15);
    r47 = fmaf(r33, r22, r46 * r24);
    r17 = fmaf(r46, r13, r33 * r35);
    r27 = fmaf(r33, r13, r46 * r9);
    write_sum_4<float, float>((float*)inout_shared, r40, r47, r17, r27);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fmaf(r33, r10, r46 * r16);
    r46 = fmaf(r15, r24, r56 * r22);
    r27 = fmaf(r15, r13, r56 * r35);
    r17 = fmaf(r56, r13, r15 * r9);
    write_sum_4<float, float>((float*)inout_shared, r33, r46, r27, r17);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fmaf(r15, r16, r56 * r10);
    r56 = fmaf(r24, r16, r22 * r10);
    r17 = fmaf(r24, r13, r22 * r35);
    r22 = fmaf(r22, r13, r24 * r9);
    write_sum_4<float, float>((float*)inout_shared, r15, r17, r22, r56);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r56 = fmaf(r35, r13, r9 * r13);
    r35 = fmaf(r16, r13, r35 * r10);
    r13 = fmaf(r10, r13, r9 * r16);
    write_sum_3<float, float>((float*)inout_shared, r56, r35, r13);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r43 = r43 * r4;
    r43 = r43 * r3;
    r43 = fmaf(r42, r43, r30 * r10);
    write_sum_2<float, float>((float*)inout_shared, r56, r43);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r35 = r7 * r10;
    r13 = r0 * r7;
    r35 = fmaf(r13, r35, r10 * r43);
    write_sum_2<float, float>((float*)inout_shared, r56, r35);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r56 = r56 * r37;
    r56 = r56 * r8;
    r56 = fmaf(r30, r56, r8 * r35);
    write_sum_1<float, float>((float*)inout_shared, r56);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r35 = r19 * r29;
    r35 = r35 * r6;
    r35 = fmaf(r8, r35, r21 * r55);
    r56 = r19 * r18;
    r56 = r56 * r7;
    r35 = fmaf(r8, r56, r35);
    r35 = fmaf(r21, r54, r35);
    r56 = r5 * r35;
    r56 = r56 * r42;
    r56 = fmaf(r30, r56, r50 * r26);
    r56 = fmaf(r29, r1, r56);
    r26 = r0 * r7;
    r26 = r26 * r21;
    r37 = r0 * r35;
    r37 = r37 * r42;
    r37 = fmaf(r31, r37, r50 * r26);
    r37 = fmaf(r18, r1, r37);
    r26 = r32 * r50;
    r43 = fmaf(r20, r1, r30 * r26);
    r16 = r19 * r20;
    r16 = r16 * r6;
    r16 = fmaf(r32, r55, r8 * r16);
    r9 = r19 * r25;
    r9 = r9 * r7;
    r16 = fmaf(r8, r9, r16);
    r16 = fmaf(r32, r54, r16);
    r9 = r5 * r16;
    r9 = r9 * r42;
    r43 = fmaf(r30, r9, r43);
    r9 = r0 * r16;
    r9 = r9 * r42;
    r13 = fmaf(r26, r13, r31 * r9);
    r13 = fmaf(r25, r1, r13);
    ...
    r54 = r5 * r55;
    r54 = r54 * r42;
    r54 = fmaf(r30, r54, r50 * r26);
    r54 = fmaf(r23, r1, r54);
    r26 = r0 * r7;
    r26 = r26 * r28;
    r9 = r0 * r55;
    r9 = r9 * r42;
    r9 = fmaf(r31, r9, r50 * r26);
    r9 = fmaf(r34, r1, r9);
    write_idx_2<1024, float, float, float2>(
        out_point_jac, 4 * out_point_jac_num_alloc, global_thread_idx, r54, r9);
    r1 = r4 * r3;
    r26 = r4 * r2;
    r26 = fmaf(r56, r26, r37 * r1);
    r1 = r4 * r3;
    r31 = r4 * r2;
    r31 = fmaf(r43, r31, r13 * r1);
    r1 = r4 * r3;
    r50 = r4 * r2;
    r50 = fmaf(r54, r50, r9 * r1);
    write_sum_3<float, float>((float*)inout_shared, r26, r31, r50);
  };
  flush_sum_shared<3, float>(out_point_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r50 = fmaf(r56, r56, r37 * r37);
    r31 = fmaf(r13, r13, r43 * r43);
    r26 = fmaf(r54, r54, r9 * r9);
    write_sum_3<float, float>((float*)inout_shared, r50, r31, r26);
  };
  flush_sum_shared<3, float>(out_point_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r26 = fmaf(r37, r13, r56 * r43);
    r37 = fmaf(r37, r9, r56 * r54);
    r9 = fmaf(r13, r9, r43 * r54);
    write_sum_3<float, float>((float*)inout_shared, r26, r37, r9);
  };
