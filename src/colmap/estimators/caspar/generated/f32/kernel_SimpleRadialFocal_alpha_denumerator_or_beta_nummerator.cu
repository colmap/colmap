...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFocal_alpha_denumerator_or_beta_nummerator_kernel(
  ...
  __shared__ float SimpleRadialFocal_out_local[1];
  ...
  sum_store<float>(SimpleRadialFocal_out_local,
                   (float*)inout_shared,
                   0,
                   global_thread_idx < problem_size,
                   r1);
  sum_flush_final<float>(SimpleRadialFocal_out_local, SimpleRadialFocal_out, 1);
}
...
void SimpleRadialFocal_alpha_denumerator_or_beta_nummerator(
  ...
  SimpleRadialFocal_alpha_denumerator_or_beta_nummerator_kernel<<<n_blocks,
                                                                  1024>>>(
      SimpleRadialFocal_p_kp1,
      SimpleRadialFocal_p_kp1_num_alloc,
      SimpleRadialFocal_w,
      SimpleRadialFocal_w_num_alloc,
      SimpleRadialFocal_out,
      problem_size);
}
