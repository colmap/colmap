...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r36, r32, r25, r25);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r37, r3, r31, r34);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r1, r0, r35);
  };
