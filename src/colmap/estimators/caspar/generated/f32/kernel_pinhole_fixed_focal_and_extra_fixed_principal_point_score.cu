...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedFocalAndExtraFixedPrincipalPointScoreKernel(
        float* pose,
...
void PinholeFixedFocalAndExtraFixedPrincipalPointScore(
    float* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    float* point,
  ...
  PinholeFixedFocalAndExtraFixedPrincipalPointScoreKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      point,
