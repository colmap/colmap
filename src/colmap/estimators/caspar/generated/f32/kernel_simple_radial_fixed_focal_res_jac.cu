...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r16 = fmaf(r45, r14, r54 * r50);
    r17 = fmaf(r45, r43, r54 * r35);
    r46 = fmaf(r54, r43, r45 * r22);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r45 = fmaf(r15, r50, r31 * r14);
    r46 = fmaf(r31, r43, r15 * r35);
    r17 = fmaf(r15, r43, r31 * r22);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = fmaf(r14, r47, r50 * r13);
    r17 = fmaf(r14, r43, r50 * r35);
    r50 = fmaf(r50, r43, r14 * r22);
  ...
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fmaf(r35, r43, r22 * r43);
    r35 = fmaf(r47, r43, r35 * r13);
    r43 = fmaf(r13, r43, r22 * r47);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r22 = r22 * r3;
    r22 = r22 * r42;
    r22 = fmaf(r30, r22, r42 * r47);
    write_sum_3<float, float>((float*)inout_shared, r15, r13, r22);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r15, r43, r35);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = r21 * r30;
    r43 = fmaf(r37, r15, r43);
    r15 = r0 * r7;
    r15 = r15 * r21;
    r26 = r0 * r35;
    r26 = r26 * r42;
    r26 = fmaf(r33, r26, r37 * r15);
    r26 = fmaf(r18, r1, r26);
    r15 = r19 * r20;
    r15 = r15 * r6;
    r15 = fmaf(r32, r53, r8 * r15);
    r13 = r19 * r25;
    r13 = r13 * r7;
    r15 = fmaf(r8, r13, r15);
    r15 = fmaf(r32, r52, r15);
    r13 = r2 * r15;
    r13 = r13 * r42;
    r13 = fmaf(r20, r1, r30 * r13);
    r24 = r32 * r30;
    r13 = fmaf(r37, r24, r13);
    r24 = r0 * r7;
    r24 = r24 * r32;
    r24 = fmaf(r37, r24, r25 * r1);
    r47 = r0 * r15;
    r47 = r47 * r42;
    r24 = fmaf(r33, r47, r24);
    write_idx_4<1024, float, float, float4>(out_point_jac,
                                            ...
                                            r24);
    r47 = r28 * r30;
    r47 = fmaf(r37, r47, r23 * r1);
    r50 = r19 * r23;
    r50 = r50 * r6;
    r53 = fmaf(r28, r53, r8 * r50);
    r50 = r19 * r34;
    r50 = r50 * r7;
    r53 = fmaf(r8, r50, r53);
    ...
    r52 = r2 * r53;
    r52 = r52 * r42;
    r47 = fmaf(r30, r52, r47);
    r52 = r0 * r7;
    r52 = r52 * r28;
    r1 = fmaf(r34, r1, r37 * r52);
    r52 = r0 * r53;
    r52 = r52 * r42;
    r1 = fmaf(r33, r52, r1);
    write_idx_2<1024, float, float, float2>(
    ...
    r52 = r5 * r3;
    r33 = r5 * r4;
    r33 = fmaf(r26, r33, r43 * r52);
    r52 = r5 * r3;
    r42 = r5 * r4;
    r42 = fmaf(r24, r42, r13 * r52);
    r52 = r5 * r3;
    r37 = r5 * r4;
    r37 = fmaf(r1, r37, r47 * r52);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r42 = fmaf(r24, r24, r13 * r13);
    r33 = fmaf(r1, r1, r47 * r47);
  ...
  flush_sum_shared<3, float>(out_point_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fmaf(r26, r24, r43 * r13);
    r26 = fmaf(r26, r1, r43 * r47);
    r1 = fmaf(r24, r1, r13 * r47);
