...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_focal_fixed_extra_calib_score_kernel(
        float* pose,
...
void pinhole_fixed_focal_fixed_extra_calib_score(
    float* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    float* point,
  ...
  pinhole_fixed_focal_fixed_extra_calib_score_kernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      point,
