...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_focal_fixed_point_res_jac_first_kernel(
        float* pose,
...
void simple_radial_fixed_focal_fixed_point_res_jac_first(
    float* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    float* extra_calib,
  ...
  simple_radial_fixed_focal_fixed_point_res_jac_first_kernel<<<n_blocks,
                                                               1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
