...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_focal_and_extra_fixed_point_jtjnjtr_direct_kernel(
        float* pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r5 = fmaf(r6, r5, r7 * r4);
    write_sum_2<float, float>((float*)inout_shared, r14, r5);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r11 = fmaf(r4, r3, r11);
    r11 = fmaf(r5, r12, r11);
    write_sum_2<float, float>((float*)inout_shared, r13, r11);
  };
...
void simple_radial_fixed_focal_and_extra_fixed_point_jtjnjtr_direct(
    float* pose_njtr,
    unsigned int pose_njtr_num_alloc,
    SharedIndex* pose_njtr_indices,
    float* pose_jac,
