...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r46, r27, r11, r17);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<float, float>((float*)inout_shared, r27, r11);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r11, r27, r17, r40);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<float, float>((float*)inout_shared, r46, r40);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r40, r46, r17, r27);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r33, r45, r27, r17);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r15, r17, r22, r55);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r55, r35, r13);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<float, float>((float*)inout_shared, r55, r42);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<float, float>((float*)inout_shared, r55, r35);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum1<float, float>((float*)inout_shared, r55);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r42 = fmaf(r18, r1, r42);
    r55 = r32 * r49;
    r16 = fmaf(r20, r1, r30 * r55);
    r9 = r19 * r20;
    r9 = r9 * r6;
    r9 = fmaf(r32, r54, r8 * r9);
    r22 = r19 * r25;
    r22 = r22 * r7;
    r9 = fmaf(r8, r22, r9);
    r9 = fmaf(r32, r53, r9);
    r22 = r5 * r9;
    r22 = r22 * r37;
    r16 = fmaf(r30, r22, r16);
    r22 = r0 * r9;
    r22 = r22 * r37;
    r13 = fmaf(r55, r13, r31 * r22);
    r13 = fmaf(r25, r1, r13);
    ...
    r53 = r5 * r54;
    r53 = r53 * r37;
    r53 = fmaf(r30, r53, r49 * r55);
    r53 = fmaf(r23, r1, r53);
    r55 = r0 * r7;
    r55 = r55 * r28;
    r22 = r0 * r54;
    r22 = r22 * r37;
    r22 = fmaf(r31, r22, r49 * r55);
    r22 = fmaf(r34, r1, r22);
    ...
    r1 = r4 * r3;
    r55 = r4 * r2;
    r55 = fmaf(r26, r55, r42 * r1);
    r1 = r4 * r3;
    r31 = r4 * r2;
    r31 = fmaf(r16, r31, r13 * r1);
    r1 = r4 * r3;
    r49 = r4 * r2;
    r49 = fmaf(r53, r49, r22 * r1);
    WriteSum3<float, float>((float*)inout_shared, r55, r31, r49);
  };
  FlushSumShared<3, float>(out_point_njtr,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r49 = fmaf(r26, r26, r42 * r42);
    r31 = fmaf(r13, r13, r16 * r16);
    r55 = fmaf(r53, r53, r22 * r22);
    WriteSum3<float, float>((float*)inout_shared, r49, r31, r55);
  };
  FlushSumShared<3, float>(out_point_precond_diag,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r55 = fmaf(r42, r13, r26 * r16);
    r42 = fmaf(r42, r22, r26 * r53);
    r22 = fmaf(r13, r22, r16 * r53);
    WriteSum3<float, float>((float*)inout_shared, r55, r42, r22);
  };
