...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_pose_fixed_focal_fixed_point_res_jac_kernel(
        float* extra_calib,
...
void pinhole_fixed_pose_fixed_focal_fixed_point_res_jac(
    float* extra_calib,
    unsigned int extra_calib_num_alloc,
    SharedIndex* extra_calib_indices,
    float* pixel,
  ...
  pinhole_fixed_pose_fixed_focal_fixed_point_res_jac_kernel<<<n_blocks, 1024>>>(
      extra_calib,
