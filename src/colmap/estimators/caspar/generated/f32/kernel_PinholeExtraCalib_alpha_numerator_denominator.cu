...
__global__ void __launch_bounds__(1024, 1)
  ...
  __shared__ float PinholeExtraCalib_total_ag_local[1];

  __shared__ float PinholeExtraCalib_total_ac_local[1];
  ...
  sum_store<float>(PinholeExtraCalib_total_ag_local,
                   (float*)inout_shared,
                   0,
  ...
  sum_store<float>(PinholeExtraCalib_total_ac_local,
                   (float*)inout_shared,
                   0,
                   global_thread_idx < problem_size,
                   r2);
