...
void SortIndicesPybinding(pybind11::object keys_in, pybind11::object sorted_out,
  ...
  SortIndices(AsCharPtr(tmp_storage), tmp_storage_bytes, AsUintPtr(keys_in), AsUintPtr(sorted_out),
