...
__global__ void __launch_bounds__(1024, 1)
    PinholeCalib_start_w_contribute_kernel(
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r4;
    read_idx_4<1024, float, float, float4>(PinholeCalib_p,
    ...
    r4 = r3 * r4;
    r4 = r4 * r8;
    add_idx_4<1024, float, float, float4>(out_PinholeCalib_w,
...
void PinholeCalib_start_w_contribute(
  ...
  PinholeCalib_start_w_contribute_kernel<<<n_blocks, 1024>>>(
      PinholeCalib_precond_diag,
