...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_point_fixed_calib_score_kernel(
        float* pose,
...
void simple_radial_fixed_point_fixed_calib_score(float* pose,
                                                 unsigned int pose_num_alloc,
                                                 SharedIndex* pose_indices,
                                                 float* pixel,
                                                 unsigned int pixel_num_alloc,
  ...
  simple_radial_fixed_point_fixed_calib_score_kernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      pixel,
