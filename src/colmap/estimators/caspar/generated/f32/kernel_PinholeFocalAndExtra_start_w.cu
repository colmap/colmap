...
__global__ void __launch_bounds__(1024, 1) PinholeFocalAndExtra_start_w_kernel(
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r2;
    read_idx_2<1024, float, float, float2>(PinholeFocalAndExtra_p,
...
void PinholeFocalAndExtra_start_w(
  ...
  PinholeFocalAndExtra_start_w_kernel<<<n_blocks, 1024>>>(
      PinholeFocalAndExtra_precond_diag,
