...
__global__ void __launch_bounds__(1024, 1) PinholeFocalAndExtraUpdateRKernel(
...
void PinholeFocalAndExtraUpdateR(
    float* PinholeFocalAndExtra_r_k,
    unsigned int PinholeFocalAndExtra_r_k_num_alloc,
    float* PinholeFocalAndExtra_w,
    unsigned int PinholeFocalAndExtra_w_num_alloc,
  ...
  PinholeFocalAndExtraUpdateRKernel<<<n_blocks, 1024>>>(
