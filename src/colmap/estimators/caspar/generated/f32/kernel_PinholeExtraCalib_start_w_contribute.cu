...
__global__ void __launch_bounds__(1024, 1)
    PinholeExtraCalib_start_w_contribute_kernel(
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r2;
    read_idx_2<1024, float, float, float2>(PinholeExtraCalib_p,
                                           0 * PinholeExtraCalib_p_num_alloc,
                                           global_thread_idx,
                                           r3,
                                           r4);
    r0 = r0 * r3;
    r2 = r1 * r2;
    r2 = r2 * r4;
    add_idx_2<1024, float, float, float2>(out_PinholeExtraCalib_w,
...
void PinholeExtraCalib_start_w_contribute(
  ...
  PinholeExtraCalib_start_w_contribute_kernel<<<n_blocks, 1024>>>(
      PinholeExtraCalib_precond_diag,
      PinholeExtraCalib_precond_diag_num_alloc,
      diag,
      PinholeExtraCalib_p,
      PinholeExtraCalib_p_num_alloc,
