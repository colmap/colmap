...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    read_idx_4<1024, float, float, float4>(pose_jac,
                                           ...
                                           r13);
    r14 = r11 * r4;
    r14 = fmaf(r10, r8, r7 * r14);
    r15 = r13 * r4;
    r15 = fmaf(r12, r8, r7 * r15);
    write_sum_4<float, float>((float*)inout_shared, r5, r9, r14, r15);
  };
  ...
  if (global_thread_idx < problem_size) {
    read_idx_4<1024, float, float, float4>(
        pose_jac, 8 * pose_jac_num_alloc, global_thread_idx, r15, r14, r9, r5);
    r16 = r14 * r4;
    r16 = fmaf(r15, r8, r7 * r16);
    r17 = r5 * r4;
    r8 = fmaf(r9, r8, r7 * r17);
    write_sum_2<float, float>((float*)inout_shared, r16, r8);
  };
  ...
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r21 = fmaf(r20, r13, r16 * r5);
    r21 = fmaf(r19, r11, r21);
    r21 = fmaf(r17, r1, r21);
    r21 = fmaf(r18, r3, r21);
    r21 = fmaf(r8, r14, r21);
    r15 = fmaf(r8, r15, r16 * r9);
    r15 = fmaf(r19, r10, r15);
    r15 = fmaf(r20, r12, r15);
    r15 = fmaf(r17, r0, r15);
    r15 = fmaf(r18, r2, r15);
    r15 = fmaf(r6, r15, r7 * r21);
    write_sum_1<float, float>((float*)inout_shared, r15);
  };
