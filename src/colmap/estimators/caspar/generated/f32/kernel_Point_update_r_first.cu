...
__global__ void __launch_bounds__(1024, 1)
    PointUpdateRFirstKernel(float* Point_r_k,
  ...
  SumStore<float>(out_Point_r_0_norm2_tot_local,
                  (float*)inout_shared,
                  0,
  ...
  SumStore<float>(out_Point_r_kp1_norm2_tot_local,
                  (float*)inout_shared,
                  0,
                  global_thread_idx < problem_size,
                  r3);
...
void PointUpdateRFirst(float* Point_r_k,
                       unsigned int Point_r_k_num_alloc,
                       float* Point_w,
                       unsigned int Point_w_num_alloc,
                       const float* const negalpha,
