...
GraphSolver::GraphSolver(const SolverParams<double>& params,
  ...
  facs__pinhole_fixed_calib__args__point__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * pinhole_fixed_calib_num_, 4);
  facs__pinhole_fixed_calib__args__pixel__data_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_calib_num_, 4);
  facs__pinhole_fixed_calib__args__calib__data_ = assign_and_increment<float>(
  ...
  facs__simple_radial_fixed_point__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * simple_radial_fixed_point_num_, 4);
  facs__simple_radial_fixed_calib__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * simple_radial_fixed_calib_num_, 4);
  ...
  facs__pinhole_fixed_point__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_point_num_, 4);
  facs__pinhole_fixed_calib__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_calib_num_, 4);
  facs__pinhole_fixed_pose_fixed_point__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  facs__pinhole_fixed_pose_fixed_calib__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_calib_num_, 4);
  facs__pinhole_fixed_point_fixed_calib__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_point_fixed_calib_num_, 4);
  ...
  facs__pinhole_fixed_point__args__calib__jac_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_point_num_, 4);
  facs__pinhole_fixed_calib__args__pose__jac_ = assign_and_increment<float>(
      origin_ptr_, offset, 10 * pinhole_fixed_calib_num_, 4);
  facs__pinhole_fixed_calib__args__point__jac_ = assign_and_increment<float>(
  ...
  facs__simple_radial_fixed_point__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * simple_radial_fixed_point_num_, 4);
  facs__simple_radial_fixed_calib__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * simple_radial_fixed_calib_num_, 4);
  ...
  facs__simple_radial_fixed_pose_fixed_calib__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * simple_radial_fixed_pose_fixed_calib_num_, 4);
  ...
  facs__pinhole_fixed_point__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_point_num_, 4);
  facs__pinhole_fixed_calib__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_calib_num_, 4);
  facs__pinhole_fixed_pose_fixed_point__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  facs__pinhole_fixed_pose_fixed_calib__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_calib_num_, 4);
  facs__pinhole_fixed_point_fixed_calib__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_point_fixed_calib_num_, 4);
...
size_t GraphSolver::get_nbytes() {
  ...
  increment_offset<SharedIndex>(offset, 1 * simple_radial_fixed_calib_num_, 4);
  increment_offset<float>(offset, 2 * simple_radial_fixed_calib_num_, 4);
  increment_offset<float>(offset, 4 * simple_radial_fixed_calib_num_, 4);
  ...
  increment_offset<SharedIndex>(offset, 1 * pinhole_fixed_calib_num_, 4);
  increment_offset<float>(offset, 2 * pinhole_fixed_calib_num_, 4);
  increment_offset<float>(offset, 4 * pinhole_fixed_calib_num_, 4);
  increment_offset<SharedIndex>(
  ...
  increment_offset<float>(offset, 2 * pinhole_fixed_pose_fixed_calib_num_, 4);
  increment_offset<float>(offset, 8 * pinhole_fixed_pose_fixed_calib_num_, 4);
  increment_offset<float>(offset, 4 * pinhole_fixed_pose_fixed_calib_num_, 4);
  increment_offset<SharedIndex>(
      offset, 1 * pinhole_fixed_point_fixed_calib_num_, 4);
  increment_offset<float>(offset, 2 * pinhole_fixed_point_fixed_calib_num_, 4);
  increment_offset<float>(offset, 4 * pinhole_fixed_point_fixed_calib_num_, 4);
  increment_offset<float>(offset, 4 * pinhole_fixed_point_fixed_calib_num_, 4);
  ...
  increment_offset<float>(offset, 4 * simple_radial_fixed_point_num_, 4);
  increment_offset<float>(offset, 12 * simple_radial_fixed_calib_num_, 4);
  increment_offset<float>(offset, 6 * simple_radial_fixed_calib_num_, 4);
  increment_offset<float>(
      offset, 4 * simple_radial_fixed_pose_fixed_point_num_, 4);
  increment_offset<float>(
  ...
  increment_offset<float>(offset, 2 * pinhole_fixed_point_num_, 4);
  increment_offset<float>(offset, 10 * pinhole_fixed_calib_num_, 4);
  increment_offset<float>(offset, 6 * pinhole_fixed_calib_num_, 4);
  increment_offset<float>(offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  increment_offset<float>(offset, 6 * pinhole_fixed_pose_fixed_calib_num_, 4);
  increment_offset<float>(offset, 10 * pinhole_fixed_point_fixed_calib_num_, 4);
  increment_offset<float>(offset, 4 * PinholeCalib_num_, 4);
  increment_offset<float>(offset, 0 * 0, 4);
  increment_offset<float>(offset, 4 * Point_num_, 4);
  increment_offset<float>(offset, 0 * 0, 4);
