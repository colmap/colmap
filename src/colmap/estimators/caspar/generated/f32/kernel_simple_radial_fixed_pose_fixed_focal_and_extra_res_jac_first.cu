...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedPoseFixedFocalAndExtraResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r30, r28, r2);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r2, r28, r30);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r30, r1, r34);
  };
...
void SimpleRadialFixedPoseFixedFocalAndExtraResJacFirst(
    float* principal_point,
    unsigned int principal_point_num_alloc,
    SharedIndex* principal_point_indices,
    float* point,
  ...
  SimpleRadialFixedPoseFixedFocalAndExtraResJacFirstKernel<<<n_blocks, 1024>>>(
      principal_point,
