...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r37 = r29 * r45;
    r37 = r37 * r0;
    write_sum_4<float, float>((float*)inout_shared, r31, r19, r17, r37);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r31, r37, r17, r19);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r37, r19, r17, r20);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r39 = r4 * r39;
    r39 = r39 * r9;
    write_sum_3<float, float>((float*)inout_shared, r20, r17, r39);
  };
