...
__global__ void __launch_bounds__(1024, 1) simple_radial_res_jac_kernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r16 = fmaf(r46, r14, r56 * r52);
    r17 = fmaf(r46, r44, r56 * r35);
    r47 = fmaf(r56, r44, r46 * r22);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r46 = fmaf(r15, r52, r31 * r14);
    r47 = fmaf(r31, r44, r15 * r35);
    r17 = fmaf(r15, r44, r31 * r22);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = fmaf(r14, r48, r52 * r13);
    r17 = fmaf(r14, r44, r52 * r35);
    r52 = fmaf(r52, r44, r14 * r22);
  ...
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fmaf(r35, r44, r22 * r44);
    r35 = fmaf(r48, r44, r35 * r13);
    r44 = fmaf(r13, r44, r22 * r48);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r43 = r7 * r13;
    r37 = r6 * r30;
    r37 = fmaf(r13, r37, r24 * r43);
    write_sum_3<float, float>((float*)inout_shared, r26, r26, r37);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r37, r35, r44);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r37 = r21 * r30;
    r35 = fmaf(r50, r37, r35);
    r37 = r0 * r7;
    r37 = r37 * r21;
    r26 = r0 * r44;
    r26 = r26 * r42;
    r26 = fmaf(r33, r26, r50 * r37);
    r26 = fmaf(r18, r1, r26);
    r37 = r19 * r20;
    r37 = r37 * r6;
    r37 = fmaf(r32, r55, r8 * r37);
    r43 = r19 * r25;
    r43 = r43 * r7;
    r37 = fmaf(r8, r43, r37);
    r37 = fmaf(r32, r54, r37);
    r43 = r2 * r37;
    r43 = r43 * r42;
    r43 = fmaf(r20, r1, r30 * r43);
    r24 = r32 * r30;
    r43 = fmaf(r50, r24, r43);
    r24 = r0 * r7;
    r24 = r24 * r32;
    r24 = fmaf(r50, r24, r25 * r1);
    r15 = r0 * r37;
    r15 = r15 * r42;
    r24 = fmaf(r33, r15, r24);
    ...
    r1 = fmaf(r33, r54, r1);
    write_idx_2<1024, float, float, float2>(
        out_point_jac, 4 * out_point_jac_num_alloc, global_thread_idx, r15, r1);
    r54 = r5 * r3;
    r33 = r5 * r4;
    r33 = fmaf(r26, r33, r35 * r54);
    r54 = r5 * r3;
    r42 = r5 * r4;
    r42 = fmaf(r24, r42, r43 * r54);
    r54 = r5 * r3;
    r50 = r5 * r4;
    r50 = fmaf(r1, r50, r15 * r54);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r42 = fmaf(r24, r24, r43 * r43);
    r33 = fmaf(r1, r1, r15 * r15);
  ...
  flush_sum_shared<3, float>(out_point_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fmaf(r26, r24, r35 * r43);
    r26 = fmaf(r26, r1, r35 * r15);
    r1 = fmaf(r24, r1, r43 * r15);
...
void simple_radial_res_jac(float* pose,
                           unsigned int pose_num_alloc,
                           SharedIndex* pose_indices,
                           float* focal,
                           unsigned int focal_num_alloc,
