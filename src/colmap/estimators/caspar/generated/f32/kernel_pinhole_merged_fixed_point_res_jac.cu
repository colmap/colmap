...
__global__ void __launch_bounds__(1024, 1) PinholeMergedFixedPointResJacKernel(
    float* pose,
...
void PinholeMergedFixedPointResJac(
    float* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    float* calib,
  ...
  PinholeMergedFixedPointResJacKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      calib,
