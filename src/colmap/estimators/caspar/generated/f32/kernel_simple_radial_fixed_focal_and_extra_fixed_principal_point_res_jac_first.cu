...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r44, r27, r11, r17);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r40, r44, r17, r27);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r33, r43, r27, r17);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r15, r17, r22, r52);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r52, r35, r13);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r16, r31, r41);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r41, r31, r16);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r16, r10, r22);
  };
