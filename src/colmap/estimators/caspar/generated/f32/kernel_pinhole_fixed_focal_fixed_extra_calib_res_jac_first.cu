...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r38 = r38 * r2;
    r38 = r38 * r0;
    write_sum_4<float, float>((float*)inout_shared, r10, r34, r32, r38);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r38, r32, r10, r34);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r36 = r36 * r43;
    r38 = r43 * r38;
    write_sum_3<float, float>((float*)inout_shared, r20, r36, r38);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r16 = r4 * r2;
    r24 = r4 * r3;
    r24 = fmaf(r10, r24, r36 * r16);
    r16 = r4 * r3;
    r9 = r4 * r2;
    r9 = fmaf(r43, r9, r34 * r16);
    write_sum_3<float, float>((float*)inout_shared, r0, r24, r9);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r9, r24, r0);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r0, r20, r43);
  };
