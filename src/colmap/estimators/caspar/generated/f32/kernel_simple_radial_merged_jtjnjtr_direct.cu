...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r14, r5, r26, r27);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r28, r22);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r9, r11, r21, r13);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r18, r20, r4);
  };
...
void simple_radial_merged_jtjnjtr_direct(float* pose_njtr,
                                         unsigned int pose_njtr_num_alloc,
                                         SharedIndex* pose_njtr_indices,
                                         float* pose_jac,
                                         unsigned int pose_jac_num_alloc,
