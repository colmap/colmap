...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    read_idx_2<1024, float, float, float2>(PinholeFocal_step,
                                           0 * PinholeFocal_step_num_alloc,
                                           global_thread_idx,
                                           r0,
                                           r1);
    read_idx_2<1024, float, float, float2>(PinholeFocal_njtr,
  ...
  sum_store<float>(out_PinholeFocal_pred_dec_local,
                   (float*)inout_shared,
                   0,
