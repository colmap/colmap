...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r9 = r2 * r22;
    r9 = r9 * r26;
    r9 = fmaf(r30, r9, r30 * r41);
    r13 = r0 * r22;
    r13 = r13 * r26;
    r10 = r0 * r7;
    r10 = fmaf(r41, r10, r33 * r13);
    write_idx_4<1024, float, float, float4>(out_pose_jac,
    ...
    r13 = r5 * r4;
    r45 = r5 * r3;
    r45 = fmaf(r52, r45, r43 * r13);
    r13 = r5 * r3;
    r16 = r5 * r4;
    r16 = fmaf(r31, r16, r15 * r13);
    r13 = r5 * r3;
    r44 = r5 * r4;
    r44 = fmaf(r14, r44, r48 * r13);
    r13 = r5 * r3;
    r36 = r17 * r36;
    r17 = r4 * r36;
    r27 = r30 * r33;
    r17 = fmaf(r27, r17, r35 * r13);
    write_sum_4<float, float>((float*)inout_shared, r45, r16, r44, r17);
  };
  ...
  if (global_thread_idx < problem_size) {
    r17 = r5 * r4;
    r44 = r5 * r3;
    r44 = fmaf(r9, r44, r10 * r17);
    r17 = r5 * r4;
    r16 = r3 * r36;
    r16 = fmaf(r27, r16, r24 * r17);
    write_sum_2<float, float>((float*)inout_shared, r16, r44);
  };
  flush_sum_shared<2, float>(out_pose_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r44 = fmaf(r43, r43, r52 * r52);
    r16 = fmaf(r15, r15, r31 * r31);
    r17 = fmaf(r48, r48, r14 * r14);
    r45 = r0 * r2;
    ...
    r45 = r45 * r38;
    r45 = r45 * r27;
    r27 = fmaf(r35, r35, r45);
    write_sum_4<float, float>((float*)inout_shared, r44, r16, r17, r27);
  };
  ...
  flush_sum_shared<2, float>(out_pose_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r27 = fmaf(r52, r15, r43 * r31);
    r45 = fmaf(r43, r14, r52 * r48);
    r17 = fmaf(r43, r37, r52 * r35);
    r16 = fmaf(r52, r37, r43 * r24);
    write_sum_4<float, float>((float*)inout_shared, r27, r45, r17, r16);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r52 = fmaf(r52, r9, r43 * r10);
    r43 = fmaf(r15, r48, r31 * r14);
    r16 = fmaf(r31, r37, r15 * r35);
    r17 = fmaf(r15, r37, r31 * r24);
    write_sum_4<float, float>((float*)inout_shared, r52, r43, r16, r17);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = fmaf(r14, r10, r48 * r9);
    r17 = fmaf(r14, r37, r48 * r35);
    r48 = fmaf(r48, r37, r14 * r24);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r35 = fmaf(r10, r37, r35 * r9);
    r37 = fmaf(r9, r37, r24 * r10);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = r21 * r30;
    r35 = fmaf(r41, r15, r35);
    r15 = r0 * r7;
    r15 = r15 * r21;
    r9 = r0 * r37;
    r9 = r9 * r26;
    r9 = fmaf(r33, r9, r41 * r15);
    r9 = fmaf(r18, r1, r9);
    r15 = r19 * r20;
    r15 = r15 * r6;
    ...
    r10 = r2 * r15;
    r10 = r10 * r26;
    r10 = fmaf(r20, r1, r30 * r10);
    r24 = r32 * r30;
    r10 = fmaf(r41, r24, r10);
    r24 = r0 * r7;
    r24 = r24 * r32;
    r24 = fmaf(r41, r24, r25 * r1);
    r48 = r0 * r15;
    r48 = r48 * r26;
    r24 = fmaf(r33, r48, r24);
    write_idx_4<1024, float, float, float4>(out_point_jac,
                                            ...
                                            r24);
    r48 = r28 * r30;
    r48 = fmaf(r41, r48, r23 * r1);
    r17 = r19 * r23;
    r17 = r17 * r6;
    r51 = fmaf(r28, r51, r8 * r17);
    r17 = r19 * r34;
    r17 = r17 * r7;
    r51 = fmaf(r8, r17, r51);
    ...
    r50 = r5 * r3;
    r33 = r5 * r4;
    r33 = fmaf(r9, r33, r35 * r50);
    r50 = r5 * r3;
    r26 = r5 * r4;
    r26 = fmaf(r24, r26, r10 * r50);
    r50 = r5 * r3;
    r41 = r5 * r4;
    r41 = fmaf(r1, r41, r48 * r50);
  ...
  flush_sum_shared<3, float>(out_point_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r41 = fmaf(r9, r9, r35 * r35);
    r26 = fmaf(r24, r24, r10 * r10);
    r33 = fmaf(r1, r1, r48 * r48);
  ...
  flush_sum_shared<3, float>(out_point_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fmaf(r9, r24, r35 * r10);
    r9 = fmaf(r9, r1, r35 * r48);
    r1 = fmaf(r24, r1, r10 * r48);
    write_sum_3<float, float>((float*)inout_shared, r33, r9, r1);
  };
