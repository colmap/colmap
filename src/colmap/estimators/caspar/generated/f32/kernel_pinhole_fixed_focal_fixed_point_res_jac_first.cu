...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r18 = r18 * r2;
    r18 = r18 * r0;
    write_sum_4<float, float>((float*)inout_shared, r17, r19, r31, r18);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r18, r19);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r18, r31, r17, r19);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r9 = r29 * r46;
    r9 = r9 * r0;
    write_sum_4<float, float>((float*)inout_shared, r31, r19, r17, r9);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r31, r9, r17, r19);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r0, r19, r17, r20);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r27 = r27 * r40;
    r18 = r40 * r18;
    write_sum_3<float, float>((float*)inout_shared, r20, r27, r18);
  };
  ...
  if (global_thread_idx < problem_size) {
    r18 = r4 * r2;
    r27 = r4 * r3;
    write_sum_2<float, float>((float*)inout_shared, r18, r27);
  };
