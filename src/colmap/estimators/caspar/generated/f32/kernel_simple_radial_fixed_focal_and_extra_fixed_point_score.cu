...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_focal_and_extra_fixed_point_score_kernel(
        float* pose,
...
void simple_radial_fixed_focal_and_extra_fixed_point_score(
    float* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    float* principal_point,
  ...
  simple_radial_fixed_focal_and_extra_fixed_point_score_kernel<<<n_blocks,
                                                                 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
