...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedFocalAndExtraFixedPointScoreKernel(
        float* pose,
...
void SimpleRadialFixedFocalAndExtraFixedPointScore(
    float* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    float* principal_point,
  ...
  SimpleRadialFixedFocalAndExtraFixedPointScoreKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      principal_point,
