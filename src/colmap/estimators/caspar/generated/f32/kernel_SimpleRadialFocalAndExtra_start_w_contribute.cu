...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFocalAndExtra_start_w_contribute_kernel(
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r2;
    read_idx_2<1024, float, float, float2>(
        SimpleRadialFocalAndExtra_p,
        0 * SimpleRadialFocalAndExtra_p_num_alloc,
        global_thread_idx,
        r3,
        r4);
    r0 = r0 * r3;
...
void SimpleRadialFocalAndExtra_start_w_contribute(
  ...
  SimpleRadialFocalAndExtra_start_w_contribute_kernel<<<n_blocks, 1024>>>(
      SimpleRadialFocalAndExtra_precond_diag,
      SimpleRadialFocalAndExtra_precond_diag_num_alloc,
      diag,
      SimpleRadialFocalAndExtra_p,
      SimpleRadialFocalAndExtra_p_num_alloc,
      out_SimpleRadialFocalAndExtra_w,
