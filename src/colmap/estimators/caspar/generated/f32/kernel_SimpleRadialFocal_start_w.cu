...
__global__ void __launch_bounds__(1024, 1) SimpleRadialFocal_start_w_kernel(
  ...
  if (global_thread_idx < problem_size) {
    r1 = r0 * r1;
    read_idx_1<1024, float, float, float>(SimpleRadialFocal_p,
...
void SimpleRadialFocal_start_w(
  ...
  SimpleRadialFocal_start_w_kernel<<<n_blocks, 1024>>>(
      SimpleRadialFocal_precond_diag,
