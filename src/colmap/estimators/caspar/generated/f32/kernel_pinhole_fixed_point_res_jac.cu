...
__global__ void __launch_bounds__(1024, 1) pinhole_fixed_point_res_jac_kernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r10 = r10 * r0;
    r9 = r7 * r10;
    write_sum_4<float, float>((float*)inout_shared, r13, r43, r31, r9);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r9, r43);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r9, r31, r13, r43);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r43, r9);
  };
  flush_sum_shared<2, float>(out_pose_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r9 = fmaf(r46, r17, r1 * r20);
    r43 = fmaf(r1, r32, r46 * r8);
    r13 = r7 * r1;
    r13 = r13 * r0;
    r39 = r29 * r46;
    r39 = r39 * r0;
    write_sum_4<float, float>((float*)inout_shared, r9, r43, r13, r39);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r1, r39, r13, r43);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r13 = r13 * r0;
    r39 = r17 * r45;
    r20 = fmaf(r20, r16, r34 * r39);
    r39 = r8 * r45;
    r39 = fmaf(r34, r39, r32 * r16);
    write_sum_4<float, float>((float*)inout_shared, r20, r43, r13, r39);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r41 = r4 * r41;
    r41 = r41 * r31;
    write_sum_3<float, float>((float*)inout_shared, r39, r13, r41);
  };
