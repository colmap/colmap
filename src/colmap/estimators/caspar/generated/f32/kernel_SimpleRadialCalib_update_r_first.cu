...
__global__ void __launch_bounds__(1024, 1)
  ...
  __shared__ float out_SimpleRadialCalib_r_0_norm2_tot_local[1];

  __shared__ float out_SimpleRadialCalib_r_kp1_norm2_tot_local[1];
  ...
  sum_store<float>(out_SimpleRadialCalib_r_0_norm2_tot_local,
                   (float*)inout_shared,
                   0,
  ...
  sum_store<float>(out_SimpleRadialCalib_r_kp1_norm2_tot_local,
                   (float*)inout_shared,
                   0,
                   global_thread_idx < problem_size,
                   r4);
  sum_flush_final<float>(out_SimpleRadialCalib_r_0_norm2_tot_local,
                         out_SimpleRadialCalib_r_0_norm2_tot,
                         1);
  sum_flush_final<float>(out_SimpleRadialCalib_r_kp1_norm2_tot_local,
