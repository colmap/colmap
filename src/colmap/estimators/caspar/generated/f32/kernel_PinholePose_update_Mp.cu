...
__global__ void __launch_bounds__(1024, 1)
    PinholePose_update_Mp_kernel(float* PinholePose_r_k,
  ...
  if (global_thread_idx < problem_size) {
    read_idx_4<1024, float, float, float4>(PinholePose_Mp,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_idx_4<1024, float, float, float4>(
        ...
        r2,
        r3);
    read_idx_2<1024, float, float, float2>(PinholePose_Mp,
    ...
    write_idx_2<1024, float, float, float2>(
        ...
        r7,
        r8);
    write_idx_4<1024, float, float, float4>(out_PinholePose_w,
                                            ...
                                            r2,
                                            r3);
    write_idx_2<1024, float, float, float2>(out_PinholePose_w,
