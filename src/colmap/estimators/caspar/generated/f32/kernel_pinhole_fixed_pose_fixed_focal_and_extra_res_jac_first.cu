...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedPoseFixedFocalAndExtraResJacFirstKernel(
  ...
  FlushSumShared<2, float>(out_principal_point_njtr,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    WriteSum2<float, float>((float*)inout_shared, r24, r24);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r0, r8, r6);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r6, r8, r0);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float*)inout_shared, r0, r24, r23);
  };
...
void PinholeFixedPoseFixedFocalAndExtraResJacFirst(
    float* principal_point,
    unsigned int principal_point_num_alloc,
    SharedIndex* principal_point_indices,
    float* point,
  ...
  PinholeFixedPoseFixedFocalAndExtraResJacFirstKernel<<<n_blocks, 1024>>>(
      principal_point,
