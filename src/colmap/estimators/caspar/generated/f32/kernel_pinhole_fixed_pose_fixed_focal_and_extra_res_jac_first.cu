...
__global__ void __launch_bounds__(1024, 1)
    pinhole_fixed_pose_fixed_focal_and_extra_res_jac_first_kernel(
  ...
  if (global_thread_idx < problem_size) {
    r9 = r4 * r2;
    r10 = r4 * r3;
    write_sum_2<float, float>((float*)inout_shared, r9, r10);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r5 = r27 * r5;
    r24 = r7 * r25;
    r24 = fmaf(r0, r24, r22 * r5);
    r10 = r22 * r27;
    r9 = r28 * r1;
    r9 = fmaf(r0, r9, r8 * r10);
    r10 = r7 * r29;
    r10 = fmaf(r0, r10, r18 * r5);
    r23 = r18 * r27;
    r11 = r28 * r19;
    r11 = fmaf(r0, r11, r8 * r23);
    write_idx_4<1024, float, float, float4>(out_point_jac,
                                            ...
                                            r11);
    r23 = r7 * r30;
    r23 = fmaf(r0, r23, r26 * r5);
    r5 = r26 * r27;
    r15 = r28 * r21;
    r15 = fmaf(r0, r15, r8 * r5);
    ...
    r5 = r4 * r3;
    r0 = r4 * r2;
    r0 = fmaf(r24, r0, r9 * r5);
    r5 = r4 * r2;
    r8 = r4 * r3;
    r8 = fmaf(r11, r8, r10 * r5);
    r5 = r4 * r3;
    r6 = r4 * r2;
    r6 = fmaf(r23, r6, r15 * r5);
    write_sum_3<float, float>((float*)inout_shared, r0, r8, r6);
  };
  flush_sum_shared<3, float>(out_point_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r6 = fmaf(r9, r9, r24 * r24);
    r8 = fmaf(r11, r11, r10 * r10);
    r0 = fmaf(r15, r15, r23 * r23);
    write_sum_3<float, float>((float*)inout_shared, r6, r8, r0);
  };
  flush_sum_shared<3, float>(out_point_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r0 = fmaf(r9, r11, r24 * r10);
    r24 = fmaf(r24, r23, r9 * r15);
    r23 = fmaf(r10, r23, r11 * r15);
    write_sum_3<float, float>((float*)inout_shared, r0, r24, r23);
  };
...
void pinhole_fixed_pose_fixed_focal_and_extra_res_jac_first(
    float* principal_point,
    unsigned int principal_point_num_alloc,
    SharedIndex* principal_point_indices,
    float* point,
  ...
  pinhole_fixed_pose_fixed_focal_and_extra_res_jac_first_kernel<<<n_blocks,
                                                                  1024>>>(
      principal_point,
