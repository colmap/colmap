...
__global__ void __launch_bounds__(1024, 1) PinholeMergedFixedPoseResJacKernel(
    float* calib,
...
void PinholeMergedFixedPoseResJac(float* calib,
                                  unsigned int calib_num_alloc,
                                  SharedIndex* calib_indices,
                                  float* point,
                                  unsigned int point_num_alloc,
  ...
  PinholeMergedFixedPoseResJacKernel<<<n_blocks, 1024>>>(
      calib,
      calib_num_alloc,
      calib_indices,
      point,
