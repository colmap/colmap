...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r13 = r4 + r12;
    r7 = fmaf(r7, r11, r6 * r9);
    r6 = r5 + r7;
    r14 = fmaf(r1, r6, r0 * r13);
    r15 = fmaf(r3, r6, r2 * r13);
    read_idx_4<1024, float, float, float4>(pose_jac,
                                           ...
                                           r18,
                                           r19);
    r20 = fmaf(r17, r6, r16 * r13);
    r21 = fmaf(r19, r6, r18 * r13);
  ...
  if (global_thread_idx < problem_size) {
    read_idx_4<1024, float, float, float4>(pose_jac,
                                           ...
                                           r15,
                                           r14);
    r22 = fmaf(r20, r6, r21 * r13);
    r13 = fmaf(r15, r13, r14 * r6);
    write_sum_2<float, float>((float*)inout_shared, r22, r13);
  };
  ...
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r21 = fmaf(r23, r16, r21);
    r21 = fmaf(r24, r18, r21);
    r21 = fmaf(r15, r0, r21);
    r21 = fmaf(r6, r2, r21);
    r4 = r4 + r21;
    r19 = fmaf(r24, r19, r22 * r14);
    r19 = fmaf(r23, r17, r19);
    r19 = fmaf(r15, r1, r19);
    r19 = fmaf(r6, r3, r19);
    r19 = fmaf(r13, r20, r19);
    r5 = r5 + r19;
    r9 = fmaf(r9, r5, r8 * r4);
    r5 = fmaf(r11, r5, r10 * r4);
    write_sum_2<float, float>((float*)inout_shared, r9, r5);
  };
  ...
  if (global_thread_idx < problem_size) {
    r12 = r21 + r12;
    r7 = r19 + r7;
    write_sum_2<float, float>((float*)inout_shared, r12, r7);
  };
