...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_merged_fixed_point_res_jac_kernel(
        float* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r28, r49, r13, r44);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r36 = r36 * r27;
    r9 = fmaf(r23, r23, r36);
    write_sum_4<float, float>((float*)inout_shared, r13, r49, r44, r9);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r9, r36, r44, r49);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r24, r41, r49, r44);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r15, r44, r31, r50);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r50, r23, r48);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r44, r40, r30, r20);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r30, r44, r26, r26);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_4<float, float>((float*)inout_shared, r44, r48, r23, r50);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_2<float, float>((float*)inout_shared, r3, r50);
  };
...
void simple_radial_merged_fixed_point_res_jac(
  ...
  simple_radial_merged_fixed_point_res_jac_kernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      calib,
