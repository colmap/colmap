...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_focal_and_extra_fixed_principal_point_jtjnjtr_direct_kernel(
        float* pose_njtr,
...
void simple_radial_fixed_focal_and_extra_fixed_principal_point_jtjnjtr_direct(
    float* pose_njtr,
    unsigned int pose_njtr_num_alloc,
    SharedIndex* pose_njtr_indices,
    float* pose_jac,
