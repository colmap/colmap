...
__global__ void __launch_bounds__(1024, 1)
    PinholeFocalAndExtraStartWContributeKernel(
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r2;
    ReadIdx2<1024, float, float, float2>(PinholeFocalAndExtra_p,
                                         0 * PinholeFocalAndExtra_p_num_alloc,
                                         global_thread_idx,
                                         r3,
                                         r4);
    r0 = r0 * r3;
...
void PinholeFocalAndExtraStartWContribute(
    float* PinholeFocalAndExtra_precond_diag,
    unsigned int PinholeFocalAndExtra_precond_diag_num_alloc,
    const float* const diag,
    float* PinholeFocalAndExtra_p,
  ...
  PinholeFocalAndExtraStartWContributeKernel<<<n_blocks, 1024>>>(
      PinholeFocalAndExtra_precond_diag,
      PinholeFocalAndExtra_precond_diag_num_alloc,
      diag,
      PinholeFocalAndExtra_p,
      PinholeFocalAndExtra_p_num_alloc,
      out_PinholeFocalAndExtra_w,
