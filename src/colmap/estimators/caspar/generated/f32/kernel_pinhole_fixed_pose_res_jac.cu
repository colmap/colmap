...
__global__ void __launch_bounds__(1024, 1) pinhole_fixed_pose_res_jac_kernel(
  ...
  flush_sum_shared<3, float>(out_point_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fmaf(r24, r24, r8 * r8);
    r9 = fmaf(r23, r23, r5 * r5);
    r0 = fmaf(r10, r10, r11 * r11);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r8 = fmaf(r8, r11, r24 * r10);
    r10 = fmaf(r5, r10, r23 * r11);
    write_sum_3<float, float>((float*)inout_shared, r0, r8, r10);
  };
