...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r50 = r2 * r33;
    r50 = r50 * r26;
    r50 = fmaf(r29, r50, r46 * r32);
    r50 = fmaf(r24, r1, r50);
    r24 = r0 * r33;
    r32 = r2 * r7;
    r24 = r24 * r26;
    r42 = fmaf(r42, r1, r32 * r24);
    r24 = r0 * r7;
    r24 = r24 * r8;
    r24 = r24 * r35;
    r24 = r24 * r5;
    r42 = fmaf(r45, r24, r42);
    r47 = r17 * r7;
    r39 = r37 + r39;
    r39 = fmaf(r9, r39, r11 * r16);
    r47 = r47 * r39;
    r16 = r17 * r6;
    r19 = r12 * r19;
    r38 = r38 + r19;
    ...
    r22 = r49 * r29;
    r15 = fmaf(r46, r22, r15);
    r22 = r0 * r16;
    r22 = r22 * r26;
    r22 = fmaf(r49, r24, r32 * r22);
    r22 = fmaf(r39, r1, r22);
    ...
    r48 = r2 * r21;
    r48 = r48 * r26;
    r48 = fmaf(r29, r48, r46 * r31);
    r48 = fmaf(r40, r1, r48);
    r40 = r0 * r21;
    r40 = r40 * r26;
    r40 = fmaf(r32, r40, r19 * r24);
    r40 = fmaf(r14, r1, r40);
    r14 = r28 * r29;
    r31 = r17 * r14;
    r23 = r2 * r6;
    ...
    r24 = r5 * r4;
    r26 = r5 * r3;
    r26 = fmaf(r50, r26, r42 * r24);
    r24 = r5 * r3;
    r28 = r5 * r4;
    r28 = fmaf(r22, r28, r15 * r24);
    r24 = r5 * r3;
    r10 = r5 * r4;
    r10 = fmaf(r40, r10, r48 * r24);
    r24 = r5 * r3;
    r44 = r18 * r4;
    r13 = r32 * r14;
    r44 = fmaf(r13, r44, r31 * r24);
    write_sum_4<float, float>((float*)inout_shared, r26, r28, r10, r44);
  };
  ...
  if (global_thread_idx < problem_size) {
    r44 = r5 * r4;
    r10 = r5 * r3;
    r10 = fmaf(r1, r10, r46 * r44);
    r44 = r5 * r4;
    r28 = r18 * r3;
    r28 = fmaf(r13, r28, r9 * r44);
  ...
  flush_sum_shared<2, float>(out_pose_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r10 = fmaf(r42, r42, r50 * r50);
    r28 = fmaf(r15, r15, r22 * r22);
    r44 = fmaf(r48, r48, r40 * r40);
    r13 = r0 * r7;
    ...
    r13 = r13 * r32;
    r13 = r13 * r23;
    r23 = fmaf(r31, r31, r13);
    write_sum_4<float, float>((float*)inout_shared, r10, r28, r44, r23);
  };
  ...
  flush_sum_shared<2, float>(out_pose_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r23 = fmaf(r50, r15, r42 * r22);
    r13 = fmaf(r42, r40, r50 * r48);
    r44 = fmaf(r42, r39, r50 * r31);
    r28 = fmaf(r50, r39, r42 * r9);
    write_sum_4<float, float>((float*)inout_shared, r23, r13, r44, r28);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r50 = fmaf(r50, r1, r42 * r46);
    r42 = fmaf(r15, r48, r22 * r40);
    r28 = fmaf(r22, r39, r15 * r31);
    r44 = fmaf(r15, r39, r22 * r9);
    write_sum_4<float, float>((float*)inout_shared, r50, r42, r28, r44);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r22 = fmaf(r22, r46, r15 * r1);
    r15 = fmaf(r40, r46, r48 * r1);
    r44 = fmaf(r40, r39, r48 * r31);
    r48 = fmaf(r48, r39, r40 * r9);
    write_sum_4<float, float>((float*)inout_shared, r22, r44, r48, r15);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fmaf(r31, r39, r9 * r39);
    r31 = fmaf(r46, r39, r31 * r1);
    r39 = fmaf(r1, r39, r9 * r46);
    write_sum_3<float, float>((float*)inout_shared, r15, r31, r39);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r39 = r6 * r5;
    r39 = r39 * r3;
    r39 = fmaf(r25, r39, r25 * r31);
    write_sum_1<float, float>((float*)inout_shared, r39);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r31 = r31 * r35;
    r31 = r31 * r35;
    r31 = fmaf(r8, r31, r8 * r39);
    write_sum_1<float, float>((float*)inout_shared, r31);
  };
