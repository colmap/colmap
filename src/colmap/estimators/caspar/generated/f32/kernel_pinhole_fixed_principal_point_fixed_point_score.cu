...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedPrincipalPointFixedPointScoreKernel(
        float* pose,
...
void PinholeFixedPrincipalPointFixedPointScore(
    float* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    float* focal_and_extra,
  ...
  PinholeFixedPrincipalPointFixedPointScoreKernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      focal_and_extra,
