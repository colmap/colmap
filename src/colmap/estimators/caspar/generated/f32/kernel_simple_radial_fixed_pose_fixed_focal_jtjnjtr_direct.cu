...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_pose_fixed_focal_jtjnjtr_direct_kernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    read_idx_2<1024, float, float, float2>(extra_calib_jac,
                                           ...
                                           r0,
                                           r2);
    r10 = fmaf(r0, r9, r2 * r1);
    write_sum_3<float, float>((float*)inout_shared, r9, r1, r10);
  };
...
void simple_radial_fixed_pose_fixed_focal_jtjnjtr_direct(
    float* extra_calib_njtr,
    unsigned int extra_calib_njtr_num_alloc,
    SharedIndex* extra_calib_njtr_indices,
    float* extra_calib_jac,
  ...
  simple_radial_fixed_pose_fixed_focal_jtjnjtr_direct_kernel<<<n_blocks,
                                                               1024>>>(
      extra_calib_njtr,
