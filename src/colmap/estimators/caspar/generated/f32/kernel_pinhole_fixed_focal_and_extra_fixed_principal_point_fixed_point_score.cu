...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedFocalAndExtraFixedPrincipalPointFixedPointScoreKernel(
        float* pose,
...
void PinholeFixedFocalAndExtraFixedPrincipalPointFixedPointScore(
    float* pose,
    unsigned int pose_num_alloc,
    SharedIndex* pose_indices,
    float* pixel,
  ...
  PinholeFixedFocalAndExtraFixedPrincipalPointFixedPointScoreKernel<<<n_blocks,
                                                                      1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
