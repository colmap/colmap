...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r21 = r20 * r5;
    r21 = r21 * r3;
    r21 = fmaf(r11, r21, r4 * r16);
    write_sum_3<float, float>((float*)inout_shared, r1, r4, r21);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r10, r24, r16);
  };
