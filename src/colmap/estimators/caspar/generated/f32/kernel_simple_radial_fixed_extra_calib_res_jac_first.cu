...
__global__ void __launch_bounds__(1024, 1)
    simple_radial_fixed_extra_calib_res_jac_first_kernel(
        float* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r50 = r2 * r11;
    r50 = r50 * r26;
    r50 = fmaf(r30, r50, r48 * r22);
    r50 = fmaf(r24, r1, r50);
    r24 = r0 * r7;
    r24 = r24 * r14;
    r22 = r0 * r11;
    r22 = r22 * r26;
    r22 = fmaf(r33, r22, r48 * r24);
    r22 = fmaf(r35, r1, r22);
    r35 = r2 * r19;
    r35 = r35 * r6;
    r35 = r35 * r36;
    ...
    r13 = r2 * r9;
    r13 = r13 * r26;
    r13 = fmaf(r30, r13, r30 * r48);
    r10 = r0 * r9;
    r10 = r10 * r26;
    r46 = r0 * r7;
    r46 = fmaf(r48, r46, r33 * r10);
    write_idx_4<1024, float, float, float4>(out_pose_jac,
    ...
    r10 = r5 * r4;
    r16 = r5 * r3;
    r16 = fmaf(r54, r16, r44 * r10);
    r10 = r5 * r3;
    r45 = r5 * r4;
    r45 = fmaf(r31, r45, r15 * r10);
    r10 = r5 * r3;
    r27 = r5 * r4;
    ...
    write_sum_4<float, float>((float*)inout_shared, r16, r45, r27, r17);
  };
  ...
  if (global_thread_idx < problem_size) {
    r17 = r5 * r4;
    r27 = r5 * r3;
    r27 = fmaf(r13, r27, r46 * r17);
    r17 = r5 * r4;
    r45 = r3 * r36;
    r45 = fmaf(r40, r45, r24 * r17);
    write_sum_2<float, float>((float*)inout_shared, r45, r27);
  };
  flush_sum_shared<2, float>(out_pose_njtr,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r27 = fmaf(r44, r44, r54 * r54);
    r45 = fmaf(r15, r15, r31 * r31);
    ...
    write_sum_4<float, float>((float*)inout_shared, r27, r45, r17, r40);
  };
  ...
  flush_sum_shared<2, float>(out_pose_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r40 = fmaf(r54, r15, r44 * r31);
    r16 = fmaf(r44, r22, r54 * r50);
    r17 = fmaf(r44, r42, r54 * r35);
    r45 = fmaf(r54, r42, r44 * r24);
    write_sum_4<float, float>((float*)inout_shared, r40, r16, r17, r45);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r54 = fmaf(r54, r13, r44 * r46);
    r44 = fmaf(r15, r50, r31 * r22);
    r45 = fmaf(r31, r42, r15 * r35);
    r17 = fmaf(r15, r42, r31 * r24);
    write_sum_4<float, float>((float*)inout_shared, r54, r44, r45, r17);
  };
  flush_sum_shared<4, float>(out_pose_precond_tril,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r31 = fmaf(r31, r46, r15 * r13);
    r15 = fmaf(r22, r46, r50 * r13);
    r17 = fmaf(r22, r42, r50 * r35);
    r50 = fmaf(r50, r42, r22 * r24);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r35 = fmaf(r46, r42, r35 * r13);
    r42 = fmaf(r13, r42, r24 * r46);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r13 = r32 * r30;
    r15 = fmaf(r48, r13, r15);
    r13 = r0 * r7;
    r13 = r13 * r32;
    r13 = fmaf(r48, r13, r25 * r1);
    r46 = r0 * r41;
    r46 = r46 * r26;
    r13 = fmaf(r33, r46, r13);
    ...
    r1 = fmaf(r33, r52, r1);
    write_idx_2<1024, float, float, float2>(
        out_point_jac, 4 * out_point_jac_num_alloc, global_thread_idx, r46, r1);
    r52 = r5 * r3;
    r33 = r5 * r4;
    r33 = fmaf(r37, r33, r42 * r52);
    r52 = r5 * r3;
    r26 = r5 * r4;
    r26 = fmaf(r13, r26, r15 * r52);
    r52 = r5 * r3;
    r48 = r5 * r4;
    r48 = fmaf(r1, r48, r46 * r52);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r26 = fmaf(r13, r13, r15 * r15);
    r33 = fmaf(r1, r1, r46 * r46);
  ...
  flush_sum_shared<3, float>(out_point_precond_diag,
                             ...
                             (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fmaf(r37, r13, r42 * r15);
    r37 = fmaf(r37, r1, r42 * r46);
    r1 = fmaf(r13, r1, r15 * r46);
...
void simple_radial_fixed_extra_calib_res_jac_first(
  ...
  simple_radial_fixed_extra_calib_res_jac_first_kernel<<<n_blocks, 1024>>>(
      pose,
      pose_num_alloc,
      pose_indices,
      focal,
