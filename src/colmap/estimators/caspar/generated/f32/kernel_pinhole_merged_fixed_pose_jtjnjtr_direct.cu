...
__global__ void __launch_bounds__(1024, 1)
    pinhole_merged_fixed_pose_jtjnjtr_direct_kernel(
        float* calib_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r1 = fmaf(r0, r6, r1);
    r0 = r11 * r1;
    write_sum_4<float, float>((float*)inout_shared, r12, r0, r9, r1);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    write_sum_3<float, float>((float*)inout_shared, r6, r8, r11);
  };
...
void pinhole_merged_fixed_pose_jtjnjtr_direct(
    float* calib_njtr,
    unsigned int calib_njtr_num_alloc,
    SharedIndex* calib_njtr_indices,
    float* calib_jac,
  ...
  pinhole_merged_fixed_pose_jtjnjtr_direct_kernel<<<n_blocks, 1024>>>(
      calib_njtr,
