...
__global__ void __launch_bounds__(1024, 1)
    PinholeMergedFixedPoseJtjnjtrDirectKernel(
        float* calib_njtr,
...
void PinholeMergedFixedPoseJtjnjtrDirect(float* calib_njtr,
                                         unsigned int calib_njtr_num_alloc,
                                         SharedIndex* calib_njtr_indices,
                                         float* calib_jac,
                                         unsigned int calib_jac_num_alloc,
  ...
  PinholeMergedFixedPoseJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
      calib_njtr,
