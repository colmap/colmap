...
class CasparModelAdapter {
 public:
  static constexpr CameraModelId kModelId = CameraModelId::kSimpleRadial;
  static constexpr size_t kCalibSize = 4;  // f, cx, cy, k
  ...
  static void SetFactorIndices(caspar::GraphSolver& s,
                               ...
                               const size_t n) {
    s.set_simple_radial_pose_indices_from_host(pose_idx, n);
    s.set_simple_radial_calib_indices_from_host(calib_idx, n);
    s.set_simple_radial_point_indices_from_host(point_idx, n);
    s.set_simple_radial_pixel_data_from_stacked_host(pixels, 0, n);
  ...
  static void SetFixedPoseFactorIndices(caspar::GraphSolver& s,
                                        ...
                                        const StorageType* pixels,
                                        const size_t n) {
    s.set_simple_radial_fixed_pose_calib_indices_from_host(calib_idx, n);
    s.set_simple_radial_fixed_pose_point_indices_from_host(point_idx, n);
    s.set_simple_radial_fixed_pose_cam_T_world_data_from_stacked_host(
        poses, 0, n);
    s.set_simple_radial_fixed_pose_pixel_data_from_stacked_host(pixels, 0, n);
  ...
  static void SetFixedPointFactorIndices(caspar::GraphSolver& s,
                                         ...
                                         const StorageType* pixels,
                                         const size_t n) {
    s.set_simple_radial_fixed_point_pose_indices_from_host(pose_idx, n);
    s.set_simple_radial_fixed_point_calib_indices_from_host(calib_idx, n);
    s.set_simple_radial_fixed_point_point_data_from_stacked_host(points, 0, n);
    s.set_simple_radial_fixed_point_pixel_data_from_stacked_host(pixels, 0, n);
