...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r36 = r52 * r29;
    r36 = fma(r38, r36, r11 * r1);
    r43 = r17 * r7;
    r42 = r34 + r42;
    r42 = fma(r8, r42, r19 * r16);
    r43 = r43 * r42;
    r43 = fma(r32, r43, r52 * r48);
    r19 = r17 * r6;
    r19 = r19 * r11;
    r43 = fma(r32, r19, r43);
    r43 = fma(r52, r41, r43);
    ...
    r19 = fma(r38, r42, r19);
    WriteIdx2<1024, double, double, double2>(
        out_pose_jac, 2 * out_pose_jac_num_alloc, global_thread_idx, r36, r19);
    r23 = r26 + r23;
    r23 = r23 + r45;
    r23 = r23 + r51;
  ...
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            pose_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r53 = fma(r19, r37, r36 * r8);
    r40 = fma(r36, r37, r19 * r15);
  ...
  if (global_thread_idx < problem_size) {
    r25 = r20 * r38;
    r46 = fma(r28, r1, r29 * r25);
    r37 = r17 * r28;
    r37 = r37 * r6;
    r37 = fma(r32, r37, r20 * r41);
    r45 = r17 * r16;
    r45 = r45 * r7;
    r37 = fma(r32, r45, r37);
    r37 = fma(r20, r48, r37);
    ...
    r45 = r5 * r25;
    r45 = r45 * r30;
    r45 = fma(r18, r1, r29 * r45);
    r15 = r35 * r29;
    r45 = fma(r38, r15, r45);
    r15 = r0 * r25;
    r15 = r15 * r30;
    r15 = fma(r24, r1, r50 * r15);
    r8 = r0 * r35;
    r8 = r8 * r7;
    r15 = fma(r38, r8, r15);
    WriteIdx2<1024, double, double, double2>(out_point_jac,
                                             2 * out_point_jac_num_alloc,
                                             global_thread_idx, r45, r15);
    r8 = r17 * r22;
    r8 = r8 * r6;
    ...
    r8 = r4 * r2;
    r50 = r4 * r3;
    r50 = fma(r20, r50, r46 * r8);
    r8 = r4 * r3;
    r30 = r4 * r2;
    r30 = fma(r45, r30, r15 * r8);
  ...
  FlushSumShared<1, double>(out_point_njtr, 2 * out_point_njtr_num_alloc,
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r50 = fma(r20, r20, r46 * r46);
    r30 = fma(r15, r15, r45 * r45);
    WriteSum2<double, double>((double *)inout_shared, r50, r30);
  };
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r30 = fma(r46, r45, r20 * r15);
    r46 = fma(r46, r48, r20 * r1);
    WriteSum2<double, double>((double *)inout_shared, r30, r46);
  };
  FlushSumShared<2, double>(out_point_precond_tril,
                            0 * out_point_precond_tril_num_alloc,
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r1 = fma(r15, r1, r45 * r48);
