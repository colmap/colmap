...
__global__ void __launch_bounds__(1024, 1)
    PointAlphaNumeratorDenominatorKernel(double* Point_p_kp1,
  ...
  SumStore<double>(Point_total_ag_local,
                   (double*)inout_shared,
                   0,
  ...
  SumStore<double>(Point_total_ac_local,
                   (double*)inout_shared,
                   0,
                   global_thread_idx < problem_size,
                   r5);
...
void PointAlphaNumeratorDenominator(double* Point_p_kp1,
                                    unsigned int Point_p_kp1_num_alloc,
                                    double* Point_r_k,
                                    unsigned int Point_r_k_num_alloc,
                                    double* Point_w,
