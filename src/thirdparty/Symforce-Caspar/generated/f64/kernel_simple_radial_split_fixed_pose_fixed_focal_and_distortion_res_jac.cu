...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialSplitFixedPoseFixedFocalAndDistortionResJacKernel(
        ...
        unsigned int focal_and_distortion_num_alloc, double *out_res,
        unsigned int out_res_num_alloc, double *out_principal_point_jac,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r9 = r9 * r0;
    r9 = r9 * r33;
    r9 = fma(r17, r20, r25 * r9);
    r9 = fma(r15, r22, r9);
    r34 = r26 * r29;
    r34 = r34 * r6;
    r34 = r34 * r33;
    r34 = fma(r21, r20, r25 * r34);
    r33 = r15 * r6;
    r33 = r33 * r4;
    r33 = r33 * r31;
    r34 = fma(r18, r33, r34);
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 2 * out_point_jac_num_alloc, global_thread_idx, r9, r34);
    r33 = r26 * r29;
    r28 = r14 * r19;
    r16 = fma(r23, r16, r32 * r28);
    r28 = r14 * r5;
    r28 = r28 * r6;
    r16 = fma(r31, r28, r16);
    r32 = r23 * r30;
    ...
    r33 = r33 * r0;
    r33 = r33 * r16;
    r33 = fma(r25, r33, r19 * r20);
    r33 = fma(r23, r22, r33);
    r22 = r23 * r6;
    r22 = r22 * r4;
    r22 = r22 * r31;
    r20 = fma(r5, r20, r18 * r22);
    r22 = r26 * r29;
    r22 = r22 * r6;
    r22 = r22 * r16;
    r20 = fma(r25, r22, r20);
    WriteIdx2<1024, double, double, double2>(out_point_jac,
                                             ...
                                             global_thread_idx, r33, r20);
    r22 = r4 * r3;
    r22 = fma(r1, r2, r8 * r22);
    r25 = r4 * r3;
    r25 = fma(r9, r2, r34 * r25);
  ...
  if (global_thread_idx < problem_size) {
    r2 = fma(r8, r8, r1 * r1);
    r25 = fma(r34, r34, r9 * r9);
    WriteSum2<double, double>((double *)inout_shared, r2, r25);
  };
  FlushSumShared<2, double>(out_point_precond_diag,
                            0 * out_point_precond_diag_num_alloc,
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r25 = fma(r33, r33, r20 * r20);
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r25 = fma(r1, r9, r8 * r34);
    r1 = fma(r1, r33, r8 * r20);
...
void SimpleRadialSplitFixedPoseFixedFocalAndDistortionResJac(
    double *principal_point, unsigned int principal_point_num_alloc,
    SharedIndex *principal_point_indices, double *point,
    unsigned int point_num_alloc, SharedIndex *point_indices, double *pixel,
    unsigned int pixel_num_alloc, double *pose, unsigned int pose_num_alloc,
  ...
  SimpleRadialSplitFixedPoseFixedFocalAndDistortionResJacKernel<<<n_blocks,
                                                                  1024>>>(
      principal_point, principal_point_num_alloc, principal_point_indices,
      ...
      out_res, out_res_num_alloc, out_principal_point_jac,
