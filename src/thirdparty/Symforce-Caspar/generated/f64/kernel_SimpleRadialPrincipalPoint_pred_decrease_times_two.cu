...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialPrincipalPointPredDecreaseTimesTwoKernel(
        ...
        const double *const diag, double *SimpleRadialPrincipalPoint_njtr,
  ...
  __shared__ double out_SimpleRadialPrincipalPoint_pred_dec_local[1];
  ...
  SumStore<double>(out_SimpleRadialPrincipalPoint_pred_dec_local,
                   (double *)inout_shared, 0, global_thread_idx < problem_size,
                   r2);
  SumFlushFinal<double>(out_SimpleRadialPrincipalPoint_pred_dec_local,
