...
__global__ void __launch_bounds__(1024, 1) PinholePoseUpdatePKernel(
    double *PinholePose_z, unsigned int PinholePose_z_num_alloc,
    double *PinholePose_p_k, unsigned int PinholePose_p_k_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(PinholePose_p_k,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, double, double, double2>(
        out_PinholePose_p_kp1, 0 * out_PinholePose_p_kp1_num_alloc,
        global_thread_idx, r0, r1);
    ReadIdx2<1024, double, double, double2>(PinholePose_p_k,
    ...
    r0 = fma(r0, r4, r2);
    WriteIdx2<1024, double, double, double2>(
        out_PinholePose_p_kp1, 2 * out_PinholePose_p_kp1_num_alloc,
        global_thread_idx, r1, r0);
    ReadIdx2<1024, double, double, double2>(PinholePose_p_k,
    ...
    r4 = fma(r1, r4, r3);
    WriteIdx2<1024, double, double, double2>(
        out_PinholePose_p_kp1, 4 * out_PinholePose_p_kp1_num_alloc,
