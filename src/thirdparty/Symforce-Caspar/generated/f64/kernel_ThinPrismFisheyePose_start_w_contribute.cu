...
__global__ void __launch_bounds__(1024, 1)
    ThinPrismFisheyePoseStartWContributeKernel(
        ...
        const double *const diag, double *ThinPrismFisheyePose_p,
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r2;
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_p, 0 * ThinPrismFisheyePose_p_num_alloc,
    ...
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_precond_diag,
        2 * ThinPrismFisheyePose_precond_diag_num_alloc, global_thread_idx, r1,
        r0);
    r1 = r1 * r2;
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_p, 2 * ThinPrismFisheyePose_p_num_alloc,
    ...
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_precond_diag,
        4 * ThinPrismFisheyePose_precond_diag_num_alloc, global_thread_idx, r0,
        r1);
    r0 = r0 * r2;
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_p, 4 * ThinPrismFisheyePose_p_num_alloc,
        global_thread_idx, r3, r4);
    r0 = r0 * r3;
    r2 = r1 * r2;
    r2 = r2 * r4;
