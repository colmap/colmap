...
__global__ void __launch_bounds__(1024, 1)
    PinholePoseAlphaNumeratorDenominatorKernel(
        ...
        double *const PinholePose_total_ag, double *const PinholePose_total_ac,
        size_t problem_size) {
  ...
  SumStore<double>(PinholePose_total_ag_local, (double *)inout_shared, 0,
  ...
  SumStore<double>(PinholePose_total_ac_local, (double *)inout_shared, 0,
