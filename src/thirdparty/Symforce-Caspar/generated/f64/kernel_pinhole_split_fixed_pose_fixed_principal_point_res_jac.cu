...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>(
        (double*)inout_shared, focal_indices_loc[threadIdx.x].target, r5, r34);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(sensor_from_rig,
    ...
    r39 = r39 * r3;
    r39 = r39 * r0;
    WriteSum2<double, double>((double*)inout_shared, r31, r39);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, double, double, double2>(out_point_jac,
                                             ...
                                             r30);
    r31 = r5 * r46;
    r31 = fma(r0, r31, r41 * r33);
    r33 = r41 * r36;
    r47 = r34 * r11;
    r47 = fma(r0, r47, r7 * r33);
    WriteIdx2<1024, double, double, double2>(out_point_jac,
    ...
    r33 = r4 * r3;
    r0 = r4 * r2;
    r0 = fma(r6, r0, r39 * r33);
    r33 = r4 * r3;
    r7 = r4 * r2;
    r7 = fma(r29, r7, r30 * r33);
