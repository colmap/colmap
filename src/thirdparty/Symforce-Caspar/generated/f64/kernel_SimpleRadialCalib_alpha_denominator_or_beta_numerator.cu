...
__global__ void __launch_bounds__(1024, 1)
  ...
  SumStore<double>(SimpleRadialCalib_out_local, (double *)inout_shared, 0,
                   global_thread_idx < problem_size, r6);
  SumFlushFinal<double>(SimpleRadialCalib_out_local, SimpleRadialCalib_out, 1);
}
...
void SimpleRadialCalibAlphaDenominatorOrBetaNumerator(
  ...
  SimpleRadialCalibAlphaDenominatorOrBetaNumeratorKernel<<<n_blocks, 1024>>>(
      ...
      SimpleRadialCalib_w, SimpleRadialCalib_w_num_alloc, SimpleRadialCalib_out,
      problem_size);
}
