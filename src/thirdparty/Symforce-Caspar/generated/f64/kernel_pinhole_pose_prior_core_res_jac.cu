...
__global__ void __launch_bounds__(1024, 1) PinholePosePriorCoreResJacKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r31 = fma(r0, r33, r31);
    r25 = fma(r31, r25, r15 * r34);
    r34 = r4 * r16;
    r33 = r21 * r2;
    r25 = fma(r33, r34, r25);
    WriteSum2<double, double>((double *)inout_shared, r6, r25);
  };
  FlushSumShared<2, double>(out_pose_njtr, 4 * out_pose_njtr_num_alloc,
                            pose_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r25 = fma(r45, r45, r22 * r22);
    r6 = r37 * r37;
    r25 = fma(r2, r6, r25);
    r6 = r40 * r40;
    ...
    r34 = r11 * r40;
    r6 = fma(r26, r34, r6);
    WriteSum2<double, double>((double *)inout_shared, r25, r6);
  };
  ...
  FlushSumShared<2, double>(out_pose_precond_diag,
                            ...
                            pose_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r25 = fma(r10, r10, r20 * r20);
    r6 = r36 * r36;
    r25 = fma(r2, r6, r25);
    r6 = fma(r15, r15, r31 * r31);
    r6 = fma(r21, r33, r6);
    WriteSum2<double, double>((double *)inout_shared, r25, r6);
  };
  FlushSumShared<2, double>(out_pose_precond_diag,
                            ...
                            pose_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r6 = fma(r22, r26, r45 * r32);
    r25 = r37 * r40;
    r6 = fma(r2, r25, r6);
    r25 = fma(r22, r38, r45 * r23);
    WriteSum2<double, double>((double *)inout_shared, r6, r25);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            pose_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r25 = fma(r45, r30, r22 * r27);
    r6 = r37 * r24;
    r25 = fma(r2, r6, r25);
    r6 = fma(r45, r10, r22 * r20);
    r21 = r37 * r36;
    r6 = fma(r2, r21, r6);
    WriteSum2<double, double>((double *)inout_shared, r25, r6);
  };
...
void PinholePosePriorCoreResJac(
  ...
  PinholePosePriorCoreResJacKernel<<<n_blocks, 1024>>>(
