...
__global__ void __launch_bounds__(1024, 1) ThinPrismFisheyePoseUpdateMpKernel(
    ...
    unsigned int ThinPrismFisheyePose_Mp_num_alloc, const double *const beta,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_Mp, 0 * ThinPrismFisheyePose_Mp_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, double, double, double2>(
        ...
        0 * out_ThinPrismFisheyePose_Mp_kp1_num_alloc, global_thread_idx, r0,
        r1);
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_Mp, 2 * ThinPrismFisheyePose_Mp_num_alloc,
    ...
    WriteIdx2<1024, double, double, double2>(
        out_ThinPrismFisheyePose_Mp_kp1,
        2 * out_ThinPrismFisheyePose_Mp_kp1_num_alloc, global_thread_idx, r3,
        r2);
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_Mp, 4 * ThinPrismFisheyePose_Mp_num_alloc,
    ...
    WriteIdx2<1024, double, double, double2>(
        out_ThinPrismFisheyePose_Mp_kp1,
        4 * out_ThinPrismFisheyePose_Mp_kp1_num_alloc, global_thread_idx, r6,
        r4);
    WriteIdx2<1024, double, double, double2>(
        out_ThinPrismFisheyePose_w, 0 * out_ThinPrismFisheyePose_w_num_alloc,
        global_thread_idx, r0, r1);
    WriteIdx2<1024, double, double, double2>(
        out_ThinPrismFisheyePose_w, 2 * out_ThinPrismFisheyePose_w_num_alloc,
        global_thread_idx, r3, r2);
    WriteIdx2<1024, double, double, double2>(
...
void ThinPrismFisheyePoseUpdateMp(
  ...
  ThinPrismFisheyePoseUpdateMpKernel<<<n_blocks, 1024>>>(
      ...
      ThinPrismFisheyePose_Mp, ThinPrismFisheyePose_Mp_num_alloc, beta,
      out_ThinPrismFisheyePose_Mp_kp1,
      out_ThinPrismFisheyePose_Mp_kp1_num_alloc, out_ThinPrismFisheyePose_w,
