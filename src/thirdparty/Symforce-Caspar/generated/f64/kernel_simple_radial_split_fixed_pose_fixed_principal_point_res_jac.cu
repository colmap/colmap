...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r33 = r33 * r26;
    r1 = r17 * r22;
    r1 = fma(r32, r1, r0 * r33);
    r27 = r15 * r16;
    r1 = fma(r9, r27, r1);
    r27 = r21 * r22;
    r27 = fma(r32, r27, r6 * r33);
    r27 = fma(r15, r34, r27);
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 2 * out_point_jac_num_alloc, global_thread_idx, r1, r27);
    r33 = r19 * r22;
    r35 = r14 * r19;
    r36 = r0 * r0;
    r36 = r36 * r23;
    ...
    r36 = fma(r28, r29, r36);
    r29 = r0 * r36;
    r29 = fma(r26, r29, r32 * r33);
    r33 = r23 * r16;
    r29 = fma(r9, r33, r29);
    r33 = r5 * r22;
    r33 = fma(r32, r33, r23 * r34);
    r34 = r6 * r36;
    r33 = fma(r26, r34, r33);
    WriteIdx2<1024, double, double, double2>(out_point_jac,
                                             4 * out_point_jac_num_alloc,
                                             global_thread_idx, r29, r33);
    r34 = r4 * r2;
    r26 = r4 * r3;
    r26 = fma(r31, r26, r25 * r34);
    r34 = r4 * r3;
    r32 = r4 * r2;
    r32 = fma(r1, r32, r27 * r34);
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r32 = fma(r25, r1, r31 * r27);
    r25 = fma(r25, r29, r31 * r33);
...
void SimpleRadialSplitFixedPoseFixedPrincipalPointResJac(
  ...
  SimpleRadialSplitFixedPoseFixedPrincipalPointResJacKernel<<<n_blocks, 1024>>>(
      ...
      principal_point_num_alloc, out_res, out_res_num_alloc,
