...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedPoseFixedPrincipalPointResJacFirstKernel(
        ...
        double *out_focal_jac, unsigned int out_focal_jac_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ReadShared1<double>((double *)inout_shared,
                        point_indices_loc[threadIdx.x].target, r20);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r21 = r8 * r8;
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>((double *)inout_shared,
                        focal_indices_loc[threadIdx.x].target, r5, r26);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
  ...
  if (global_thread_idx < problem_size) {
    ...
    r20 = r20 * r3;
    r20 = r20 * r0;
    WriteSum2<double, double>((double *)inout_shared, r21, r20);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r17 = r25 * r17;
    r6 = r5 * r23;
    r6 = fma(r0, r6, r19 * r17);
    r27 = r26 * r1;
    r20 = r19 * r25;
    r20 = fma(r7, r20, r0 * r27);
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 0 * out_point_jac_num_alloc, global_thread_idx, r6, r20);
    r27 = r5 * r29;
    r27 = fma(r0, r27, r15 * r17);
    r21 = r15 * r25;
    r22 = r26 * r16;
    r22 = fma(r0, r22, r7 * r21);
    WriteIdx2<1024, double, double, double2>(out_point_jac,
                                             2 * out_point_jac_num_alloc,
                                             global_thread_idx, r27, r22);
    r21 = r5 * r30;
    r21 = fma(r0, r21, r24 * r17);
    r17 = r24 * r25;
    r8 = r26 * r18;
    r8 = fma(r0, r8, r7 * r17);
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 4 * out_point_jac_num_alloc, global_thread_idx, r21, r8);
    r17 = r4 * r3;
    r0 = r4 * r2;
    r0 = fma(r6, r0, r20 * r17);
    r17 = r4 * r2;
    r7 = r4 * r3;
    r7 = fma(r22, r7, r27 * r17);
  ...
  FlushSumShared<1, double>(out_point_njtr, 2 * out_point_njtr_num_alloc,
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r0 = fma(r6, r6, r20 * r20);
    r7 = fma(r27, r27, r22 * r22);
    WriteSum2<double, double>((double *)inout_shared, r0, r7);
  };
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r7 = fma(r20, r22, r6 * r27);
    r20 = fma(r20, r8, r6 * r21);
  ...
  FlushSumShared<2, double>(out_point_precond_tril,
                            ...
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r21 = fma(r27, r21, r22 * r8);
    WriteSum1<double, double>((double *)inout_shared, r21);
  };
...
void PinholeSplitFixedPoseFixedPrincipalPointResJacFirst(
  ...
  PinholeSplitFixedPoseFixedPrincipalPointResJacFirstKernel<<<n_blocks, 1024>>>(
      focal, focal_num_alloc, focal_indices, point, point_num_alloc,
      ...
      out_rTr, out_focal_jac, out_focal_jac_num_alloc, out_focal_njtr,
