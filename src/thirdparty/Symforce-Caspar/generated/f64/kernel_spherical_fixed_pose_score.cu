...
__global__ void __launch_bounds__(1024, 1)
    SphericalFixedPoseScoreKernel(double* sensor_from_rig,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = r24 * r17;
    r26 = r4 * r25;
    r27 = fma(r14, r12, r13 * r11);
    r27 = fma(r9, r15, r27);
    r27 = fma(r18, r27, r10 * r16);
    r16 = r8 * r27;
    r28 = fma(r21, r16, r26);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r35 = fma(r24, r34, r33);
    ReadIdx2<1024, double, double, double2>(
        pose, 4 * pose_num_alloc, global_thread_idx, r36, r37);
    r38 = r9 * r10;
    r39 = r13 * r14;
    r39 = r39 * r24;
    r38 = fma(r8, r38, r39);
