...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(SimpleRadialPose_step,
                                            2 * SimpleRadialPose_step_num_alloc,
                                            global_thread_idx, r0, r1);
    ReadIdx2<1024, double, double, double2>(SimpleRadialPose_njtr,
                                            2 * SimpleRadialPose_njtr_num_alloc,
                                            global_thread_idx, r2, r3);
    ReadIdx2<1024, double, double, double2>(
        SimpleRadialPose_precond_diag,
        2 * SimpleRadialPose_precond_diag_num_alloc, global_thread_idx, r4, r5);
    r6 = r0 * r4;
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx2<1024, double, double, double2>(SimpleRadialPose_step,
                                            ...
                                            global_thread_idx, r6, r3);
    ReadIdx2<1024, double, double, double2>(SimpleRadialPose_njtr,
                                            4 * SimpleRadialPose_njtr_num_alloc,
                                            global_thread_idx, r8, r9);
    ReadIdx2<1024, double, double, double2>(
        SimpleRadialPose_precond_diag,
        4 * SimpleRadialPose_precond_diag_num_alloc, global_thread_idx, r10,
        r11);
    r12 = r6 * r10;
    r12 = fma(r7, r12, r8);
    ReadIdx2<1024, double, double, double2>(SimpleRadialPose_step,
    ...
    ReadIdx2<1024, double, double, double2>(
        SimpleRadialPose_precond_diag,
        0 * SimpleRadialPose_precond_diag_num_alloc, global_thread_idx, r16,
        r17);
    r18 = r8 * r16;
    r18 = fma(r7, r18, r14);
    r14 = r13 * r17;
  ...
  SumStore<double>(out_SimpleRadialPose_pred_dec_local, (double *)inout_shared,
                   0, global_thread_idx < problem_size, r2);
  SumFlushFinal<double>(out_SimpleRadialPose_pred_dec_local,
