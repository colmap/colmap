...
__global__ void __launch_bounds__(1024, 1) SphericalFixedPointResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    r63 = r58 * r58;
    r3 = r33 * r62;
    r33 = fma(r33, r3, r28 * r63);
    r63 = r19 * r28;
    r51 = r6 * r6;
    r51 = fma(r62, r51, r19 * r63);
  ...
  if (global_thread_idx < problem_size) {
    r51 = r46 * r65;
    r33 = r36 * r73;
    r33 = fma(r62, r33, r28 * r51);
    r51 = r46 * r2;
    r19 = r36 * r69;
    r19 = fma(r62, r19, r28 * r51);
    WriteSum2<double, double>((double*)inout_shared, r33, r19);
  };
  ...
  if (global_thread_idx < problem_size) {
    r19 = r46 * r57;
    r33 = r36 * r7;
    r33 = fma(r62, r33, r28 * r19);
    r19 = r46 * r58;
    r19 = fma(r28, r19, r36 * r3);
    WriteSum2<double, double>((double*)inout_shared, r33, r19);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    r19 = r36 * r6;
    r19 = fma(r62, r19, r46 * r63);
    r33 = r65 * r2;
    r51 = r73 * r69;
    r51 = fma(r62, r51, r28 * r33);
    WriteSum2<double, double>((double*)inout_shared, r19, r51);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    r51 = r73 * r7;
    r19 = r65 * r57;
    r19 = fma(r28, r19, r62 * r51);
    r51 = r65 * r58;
    r51 = fma(r28, r51, r73 * r3);
    WriteSum2<double, double>((double*)inout_shared, r19, r51);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    r51 = r73 * r6;
    r51 = fma(r62, r51, r65 * r63);
    r19 = r69 * r7;
    r33 = r2 * r57;
    r33 = fma(r28, r33, r62 * r19);
  ...
  if (global_thread_idx < problem_size) {
    r33 = r2 * r58;
    r33 = fma(r69, r3, r28 * r33);
    r51 = r69 * r6;
    r51 = fma(r62, r51, r2 * r63);
    WriteSum2<double, double>((double*)inout_shared, r33, r51);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    r51 = r57 * r58;
    r51 = fma(r7, r3, r28 * r51);
    r28 = r7 * r6;
    r28 = fma(r57, r63, r62 * r28);
    WriteSum2<double, double>((double*)inout_shared, r51, r28);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
