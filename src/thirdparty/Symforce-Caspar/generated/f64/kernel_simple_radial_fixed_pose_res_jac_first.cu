...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>((double *)inout_shared,
                        calib_indices_loc[threadIdx.x].target, r25, r26);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r27 = r0 * r0;
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r38, r32);
  };
  ...
  if (global_thread_idx < problem_size) {
    r38 = r9 * r9;
    r38 = fma(r27, r38, r18 * r38);
    r32 = r25 * r20;
    r36 = r25 * r20;
    r32 = r32 * r36;
    r32 = fma(r27, r32, r18 * r32);
    WriteSum2<double, double>((double *)inout_shared, r38, r32);
  };
  ...
  if (global_thread_idx < problem_size) {
    r22 = r9 * r27;
    r32 = r9 * r18;
    r32 = fma(r36, r32, r36 * r22);
    WriteSum2<double, double>((double *)inout_shared, r32, r1);
  };
  FlushSumShared<2, double>(out_calib_precond_tril,
                            0 * out_calib_precond_tril_num_alloc,
                            calib_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    WriteSum2<double, double>((double *)inout_shared, r16, r34);
  };
  FlushSumShared<2, double>(out_calib_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r35, r34);
  };
  FlushSumShared<2, double>(out_calib_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r8 = r8 * r26;
    r35 = r24 * r9;
    r35 = fma(r33, r35, r0 * r8);
    r34 = r30 * r31;
    r37 = r25 * r37;
    r35 = fma(r37, r34, r35);
    r34 = r11 * r9;
    r8 = fma(r6, r8, r33 * r34);
    r34 = r6 * r29;
    r34 = r34 * r37;
    r8 = fma(r30, r34, r8);
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 0 * out_point_jac_num_alloc, global_thread_idx, r35, r8);
    r25 = r17 * r9;
    r16 = r14 * r17;
    r1 = r0 * r0;
    r32 = r15 * r28;
    r1 = fma(r32, r1, r31 * r16);
    r16 = r14 * r21;
    r16 = r16 * r6;
    r1 = fma(r29, r16, r1);
    r1 = fma(r7, r32, r1);
    r16 = r0 * r1;
    r16 = fma(r26, r16, r33 * r25);
    r25 = r15 * r31;
    r16 = fma(r37, r25, r16);
    r25 = r21 * r9;
    r25 = fma(r33, r25, r15 * r34);
    r32 = r6 * r1;
    r25 = fma(r26, r32, r25);
    WriteIdx2<1024, double, double, double2>(out_point_jac,
                                             2 * out_point_jac_num_alloc,
                                             global_thread_idx, r16, r25);
    r32 = r14 * r19;
    r22 = r0 * r0;
    r22 = r22 * r23;
    r22 = fma(r28, r22, r31 * r32);
    r32 = r14 * r5;
    r32 = r32 * r6;
    r22 = fma(r29, r32, r22);
    r29 = r23 * r7;
    ...
    WriteIdx2<1024, double, double, double2>(out_point_jac,
                                             ...
                                             global_thread_idx, r32, r37);
    r34 = r4 * r3;
    r29 = r4 * r2;
    r29 = fma(r35, r29, r8 * r34);
    r34 = r4 * r3;
    r33 = r4 * r2;
    r33 = fma(r16, r33, r25 * r34);
    WriteSum2<double, double>((double *)inout_shared, r29, r33);
  };
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fma(r8, r25, r35 * r16);
    r8 = fma(r8, r37, r35 * r32);
    WriteSum2<double, double>((double *)inout_shared, r33, r8);
  };
  FlushSumShared<2, double>(out_point_precond_tril,
                            0 * out_point_precond_tril_num_alloc,
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r32 = fma(r16, r32, r25 * r37);
...
void SimpleRadialFixedPoseResJacFirst(
  ...
  SimpleRadialFixedPoseResJacFirstKernel<<<n_blocks, 1024>>>(
      ...
      point_indices, pixel, pixel_num_alloc, pose, pose_num_alloc, out_res,
      out_res_num_alloc, out_rTr, out_calib_jac, out_calib_jac_num_alloc,
