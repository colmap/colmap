...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    r38 = r31 * r31;
    r38 = fma(r28, r38, r39 * r38);
    r36 = r40 * r32;
    r32 = r40 * r32;
    r36 = r36 * r32;
    r36 = fma(r39, r36, r28 * r36);
    WriteSum2<double, double>((double*)inout_shared, r38, r36);
  };
  ...
  if (global_thread_idx < problem_size) {
    r19 = r31 * r39;
    r36 = r31 * r28;
    r36 = fma(r32, r36, r32 * r19);
    WriteSum2<double, double>((double*)inout_shared, r36, r1);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r44 = r43 * r46;
    r24 = r40 * r24;
    r44 = fma(r24, r44, r0 * r35);
    r40 = r22 * r31;
    r44 = fma(r5, r40, r44);
    r40 = r33 * r31;
    r41 = r6 * r42;
    r41 = r41 * r24;
    r40 = fma(r43, r41, r5 * r40);
    r40 = fma(r6, r35, r40);
    ...
    r35 = r23 * r31;
    r1 = r26 * r46;
    r1 = fma(r24, r1, r5 * r35);
    r35 = r26 * r0;
    r35 = r35 * r0;
    r36 = r25 * r23;
    r36 = fma(r46, r36, r34 * r35);
    r35 = r25 * r18;
    r35 = r35 * r6;
    r36 = fma(r42, r35, r36);
    r19 = r26 * r7;
    ...
    r1 = fma(r37, r19, r1);
    r19 = r6 * r36;
    r19 = fma(r26, r41, r37 * r19);
    r35 = r18 * r31;
    r19 = fma(r5, r35, r19);
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 2 * out_point_jac_num_alloc, global_thread_idx, r1, r19);
    r35 = r25 * r29;
    r32 = r21 * r7;
    r32 = fma(r34, r32, r46 * r35);
    r35 = r21 * r0;
    r35 = r35 * r0;
    r32 = fma(r34, r35, r32);
    r34 = r25 * r30;
    ...
    r34 = r0 * r32;
    r35 = r21 * r46;
    r35 = fma(r24, r35, r37 * r34);
    r34 = r29 * r31;
    r35 = fma(r5, r34, r35);
    r34 = r6 * r32;
    r24 = r30 * r31;
    r24 = fma(r5, r24, r37 * r34);
    r24 = fma(r21, r41, r24);
    WriteIdx2<1024, double, double, double2>(out_point_jac,
    ...
    r41 = r4 * r2;
    r34 = r4 * r3;
    r34 = fma(r40, r34, r44 * r41);
    r41 = r4 * r3;
    r5 = r4 * r2;
    r5 = fma(r1, r5, r19 * r41);
    WriteSum2<double, double>((double*)inout_shared, r34, r5);
  };
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r5 = fma(r40, r19, r44 * r1);
    r44 = fma(r44, r35, r40 * r24);
    WriteSum2<double, double>((double*)inout_shared, r5, r44);
  };
