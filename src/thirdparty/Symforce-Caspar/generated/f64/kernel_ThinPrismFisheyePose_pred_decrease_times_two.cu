...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx2<1024, double, double, double2>(
        ...
        0 * ThinPrismFisheyePose_precond_diag_num_alloc, global_thread_idx, r4,
        r5);
    r6 = r1 * r5;
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_precond_diag,
        4 * ThinPrismFisheyePose_precond_diag_num_alloc, global_thread_idx, r11,
        r12);
    r13 = r8 * r12;
    r13 = fma(r7, r13, r10);
    ...
    r6 = fma(r7, r6, r9);
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_step, 2 * ThinPrismFisheyePose_step_num_alloc,
        global_thread_idx, r9, r10);
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_njtr, 2 * ThinPrismFisheyePose_njtr_num_alloc,
        global_thread_idx, r14, r15);
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_precond_diag,
        2 * ThinPrismFisheyePose_precond_diag_num_alloc, global_thread_idx, r16,
        r17);
    r18 = r9 * r16;
    r18 = fma(r7, r18, r14);
    r14 = r10 * r17;
