...
__global__ void __launch_bounds__(1024, 1) PinholeFocalNormalizeKernel(
...
void PinholeFocalNormalize(double *precond_diag,
  ...
  PinholeFocalNormalizeKernel<<<n_blocks, 1024>>>(
