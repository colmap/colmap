...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ReadShared1<double>((double *)inout_shared,
                        point_indices_loc[threadIdx.x].target, r41);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r42 = r24 * r24;
    ...
    ReadIdx2<1024, double, double, double2>(focal_and_extra,
                                            ...
                                            global_thread_idx, r28, r8);
    r7 = r27 * r27;
    r8 = fma(r8, r7, r28 * r27);
    ReadIdx2<1024, double, double, double2>(focal_and_extra,
                                            6 * focal_and_extra_num_alloc,
                                            global_thread_idx, r28, r44);
    r33 = r7 * r7;
    r7 = r27 * r7;
    r8 = fma(r44, r33, r8);
    r8 = fma(r28, r7, r8);
  ...
  SumStore<double>(out_rTr_local, (double *)inout_shared, 0,
                   global_thread_idx < problem_size, r27);
...
void ThinPrismFisheyeSplitFixedPoseFixedFocalAndExtraFixedPrincipalPointScore(
    ...
    unsigned int focal_and_extra_num_alloc, double *principal_point,
    unsigned int principal_point_num_alloc, double *pixel,
    unsigned int pixel_num_alloc, double *const out_rTr, size_t problem_size) {
