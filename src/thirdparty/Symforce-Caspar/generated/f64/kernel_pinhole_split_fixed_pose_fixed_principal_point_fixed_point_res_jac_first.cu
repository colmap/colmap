...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r4 = r4 * r3;
    r4 = r4 * r25;
    WriteSum2<double, double>((double *)inout_shared, r2, r4);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r4 = r1 * r1;
    r4 = r24 * r4;
    WriteSum2<double, double>((double *)inout_shared, r19, r4);
  };
...
void PinholeSplitFixedPoseFixedPrincipalPointFixedPointResJacFirst(
  ...
  PinholeSplitFixedPoseFixedPrincipalPointFixedPointResJacFirstKernel<<<
      n_blocks, 1024>>>(
      focal, focal_num_alloc, focal_indices, pixel, pixel_num_alloc, pose,
      pose_num_alloc, principal_point, principal_point_num_alloc, point,
      point_num_alloc, out_res, out_res_num_alloc, out_rTr, out_focal_njtr,
