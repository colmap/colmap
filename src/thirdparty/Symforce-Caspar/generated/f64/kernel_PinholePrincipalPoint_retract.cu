...
__global__ void __launch_bounds__(1024, 1) PinholePrincipalPointRetractKernel(
    double *PinholePrincipalPoint, unsigned int PinholePrincipalPoint_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(PinholePrincipalPoint,
    ...
    WriteIdx2<1024, double, double, double2>(
        ...
        0 * out_PinholePrincipalPoint_retracted_num_alloc, global_thread_idx,
        r2, r3);
  };
}
...
void PinholePrincipalPointRetract(
  ...
  PinholePrincipalPointRetractKernel<<<n_blocks, 1024>>>(
      PinholePrincipalPoint, PinholePrincipalPoint_num_alloc, delta,
      delta_num_alloc, out_PinholePrincipalPoint_retracted,
      out_PinholePrincipalPoint_retracted_num_alloc, problem_size);
}
