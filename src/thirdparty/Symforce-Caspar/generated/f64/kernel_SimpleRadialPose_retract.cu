...
__global__ void __launch_bounds__(1024, 1) SimpleRadialPoseRetractKernel(
    double *SimpleRadialPose, unsigned int SimpleRadialPose_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(SimpleRadialPose,
    ...
    WriteIdx2<1024, double, double, double2>(
        ...
        0 * out_SimpleRadialPose_retracted_num_alloc, global_thread_idx, r8,
        r12);
    r12 = r0 * r4;
    r8 = r1 * r5;
    r8 = fma(r3, r8, r3 * r12);
    ...
    WriteIdx2<1024, double, double, double2>(
        out_SimpleRadialPose_retracted,
        2 * out_SimpleRadialPose_retracted_num_alloc, global_thread_idx, r12,
        r8);
    ReadIdx2<1024, double, double, double2>(SimpleRadialPose,
                                            4 * SimpleRadialPose_num_alloc,
                                            global_thread_idx, r8, r12);
    r7 = r8 + r7;
    ReadIdx2<1024, double, double, double2>(delta, 4 * delta_num_alloc,
                                            global_thread_idx, r8, r6);
    r8 = r12 + r8;
    WriteIdx2<1024, double, double, double2>(
        out_SimpleRadialPose_retracted,
        4 * out_SimpleRadialPose_retracted_num_alloc, global_thread_idx, r7,
        r8);
    ReadIdx1<1024, double, double, double>(SimpleRadialPose,
                                           6 * SimpleRadialPose_num_alloc,
                                           global_thread_idx, r8);
    r6 = r8 + r6;
    WriteIdx1<1024, double, double, double>(
        out_SimpleRadialPose_retracted,
        6 * out_SimpleRadialPose_retracted_num_alloc, global_thread_idx, r6);
  };
}
...
void SimpleRadialPoseRetract(
  ...
  SimpleRadialPoseRetractKernel<<<n_blocks, 1024>>>(
      SimpleRadialPose, SimpleRadialPose_num_alloc, delta, delta_num_alloc,
      out_SimpleRadialPose_retracted, out_SimpleRadialPose_retracted_num_alloc,
      problem_size);
}
