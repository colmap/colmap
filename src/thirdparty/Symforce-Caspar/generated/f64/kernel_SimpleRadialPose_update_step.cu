...
__global__ void __launch_bounds__(1024, 1) SimpleRadialPoseUpdateStepKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(
        SimpleRadialPose_step_k, 0 * SimpleRadialPose_step_k_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, double, double, double2>(
        ...
        0 * out_SimpleRadialPose_step_kp1_num_alloc, global_thread_idx, r2, r3);
    ReadIdx2<1024, double, double, double2>(
        SimpleRadialPose_step_k, 2 * SimpleRadialPose_step_k_num_alloc,
    ...
    ReadIdx2<1024, double, double, double2>(
        SimpleRadialPose_step_k, 4 * SimpleRadialPose_step_k_num_alloc,
        global_thread_idx, r0, r1);
    ReadIdx2<1024, double, double, double2>(
    ...
    WriteIdx2<1024, double, double, double2>(
        out_SimpleRadialPose_step_kp1,
        4 * out_SimpleRadialPose_step_kp1_num_alloc, global_thread_idx, r2, r4);
  };
}
