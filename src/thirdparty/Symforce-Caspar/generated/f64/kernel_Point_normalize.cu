...
__global__ void __launch_bounds__(1024, 1) PointNormalizeKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx2<1024, double, double, double2>(njtr, 0 * njtr_num_alloc,
                                            global_thread_idx, r0, r9);
    r9 = fma(r0, r8, r9);
    ReadIdx1<1024, double, double, double>(
        precond_tril, 2 * precond_tril_num_alloc, global_thread_idx, r10);
    r10 = fma(r5, r8, r10);
    r11 = r10 * r3;
    r12 = r6 * r11;
    ReadIdx1<1024, double, double, double>(njtr, 2 * njtr_num_alloc,
                                           global_thread_idx, r13);
    r13 = fma(r9, r12, r13);
    r14 = r5 * r0;
    r13 = fma(r7, r14, r13);
    r14 = r5 * r5;
    r11 = fma(r10, r11, r2 * r14);
    r11 = fma(r6, r11, r1);
    ReadIdx1<1024, double, double, double>(
        precond_diag, 2 * precond_diag_num_alloc, global_thread_idx, r6);
    r11 = fma(r6, r4, r11);
    r11 = 1.0 / r11;
    r11 = r13 * r11;
    r12 = fma(r11, r12, r9 * r3);
    r3 = r5 * r7;
    r8 = fma(r12, r8, r11 * r3);
    r8 = fma(r0, r2, r8);
    ...
    WriteIdx1<1024, double, double, double>(
        out_normalized, 2 * out_normalized_num_alloc, global_thread_idx, r11);
  };
}

void PointNormalize(double *precond_diag, unsigned int precond_diag_num_alloc,
                    double *precond_tril, unsigned int precond_tril_num_alloc,
                    double *njtr, unsigned int njtr_num_alloc,
                    const double *const diag, double *out_normalized,
  ...
  PointNormalizeKernel<<<n_blocks, 1024>>>(
