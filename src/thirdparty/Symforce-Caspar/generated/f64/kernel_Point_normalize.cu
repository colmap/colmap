...
__global__ void __launch_bounds__(1024, 1)
    PointNormalizeKernel(double* precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r12 = r6 * r11;
    ReadIdx1<1024, double, double, double>(
        njtr, 2 * njtr_num_alloc, global_thread_idx, r13);
    r13 = fma(r9, r12, r13);
    r14 = r5 * r0;
    r13 = fma(r7, r14, r13);
    r14 = r5 * r5;
...
void PointNormalize(double* precond_diag,
                    unsigned int precond_diag_num_alloc,
                    double* precond_tril,
                    unsigned int precond_tril_num_alloc,
                    double* njtr,
  ...
  PointNormalizeKernel<<<n_blocks, 1024>>>(precond_diag,
