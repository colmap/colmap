...
__global__ void __launch_bounds__(1024, 1) SphericalPoseUpdateStepKernel(
    double* SphericalPose_step_k,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(SphericalPose_step_k,
                                            0 * SphericalPose_step_k_num_alloc,
                                            global_thread_idx,
                                            r0,
                                            r1);
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, double, double, double2>(
        out_SphericalPose_step_kp1,
        0 * out_SphericalPose_step_kp1_num_alloc,
        global_thread_idx,
        r2,
        r3);
    ReadIdx2<1024, double, double, double2>(SphericalPose_step_k,
                                            2 * SphericalPose_step_k_num_alloc,
                                            global_thread_idx,
                                            r3,
                                            r2);
    ReadIdx2<1024, double, double, double2>(SphericalPose_p_kp1,
    ...
    WriteIdx2<1024, double, double, double2>(
        out_SphericalPose_step_kp1,
        2 * out_SphericalPose_step_kp1_num_alloc,
        global_thread_idx,
        r1,
        r0);
    ReadIdx2<1024, double, double, double2>(SphericalPose_step_k,
                                            4 * SphericalPose_step_k_num_alloc,
                                            global_thread_idx,
                                            r0,
                                            r1);
    ReadIdx2<1024, double, double, double2>(SphericalPose_p_kp1,
    ...
    WriteIdx2<1024, double, double, double2>(
        out_SphericalPose_step_kp1,
        4 * out_SphericalPose_step_kp1_num_alloc,
        global_thread_idx,
        r2,
        r4);
  };
...
void SphericalPoseUpdateStep(double* SphericalPose_step_k,
  ...
  SphericalPoseUpdateStepKernel<<<n_blocks, 1024>>>(
      SphericalPose_step_k,
      SphericalPose_step_k_num_alloc,
      SphericalPose_p_kp1,
      SphericalPose_p_kp1_num_alloc,
      alpha,
      out_SphericalPose_step_kp1,
      out_SphericalPose_step_kp1_num_alloc,
      problem_size);
}
