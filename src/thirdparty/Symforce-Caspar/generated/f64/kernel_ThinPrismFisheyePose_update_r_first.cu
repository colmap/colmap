...
__global__ void __launch_bounds__(1024, 1)
    ThinPrismFisheyePoseUpdateRFirstKernel(
        ...
        const double *const negalpha, double *out_ThinPrismFisheyePose_r_kp1,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, double, double, double2>(
        ...
        0 * out_ThinPrismFisheyePose_r_kp1_num_alloc, global_thread_idx, r2,
        r3);
    ReadIdx2<1024, double, double, double2>(
    ...
    WriteIdx2<1024, double, double, double2>(
        out_ThinPrismFisheyePose_r_kp1,
        2 * out_ThinPrismFisheyePose_r_kp1_num_alloc, global_thread_idx, r7,
        r8);
    ReadIdx2<1024, double, double, double2>(
    ...
    WriteIdx2<1024, double, double, double2>(
        out_ThinPrismFisheyePose_r_kp1,
        4 * out_ThinPrismFisheyePose_r_kp1_num_alloc, global_thread_idx, r11,
        r4);
    r5 = fma(r5, r5, r1 * r1);
    r5 = fma(r0, r0, r5);
    r5 = fma(r6, r6, r5);
  ...
  SumFlushFinal<double>(out_ThinPrismFisheyePose_r_0_norm2_tot_local,
                        out_ThinPrismFisheyePose_r_0_norm2_tot, 1);
  SumFlushFinal<double>(out_ThinPrismFisheyePose_r_kp1_norm2_tot_local,
                        out_ThinPrismFisheyePose_r_kp1_norm2_tot, 1);
}
...
void ThinPrismFisheyePoseUpdateRFirst(
  ...
  ThinPrismFisheyePoseUpdateRFirstKernel<<<n_blocks, 1024>>>(
      ...
      ThinPrismFisheyePose_w, ThinPrismFisheyePose_w_num_alloc, negalpha,
      out_ThinPrismFisheyePose_r_kp1, out_ThinPrismFisheyePose_r_kp1_num_alloc,
      out_ThinPrismFisheyePose_r_0_norm2_tot,
      out_ThinPrismFisheyePose_r_kp1_norm2_tot, problem_size);
}
