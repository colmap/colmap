...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r3 = fma(r12, r3, r8 * r2);
    WriteSum2<double, double>((double *)inout_shared, r11, r3);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>((double *)inout_shared,
                        pose_njtr_indices_loc[threadIdx.x].target, r3, r11);
  };
  __syncthreads();
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>((double *)inout_shared,
                        pose_njtr_indices_loc[threadIdx.x].target, r2, r13);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r7 = fma(r2, r7, r11 * r8);
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>((double *)inout_shared,
                        pose_njtr_indices_loc[threadIdx.x].target, r8, r14);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r7 = fma(r13, r9, r7);
