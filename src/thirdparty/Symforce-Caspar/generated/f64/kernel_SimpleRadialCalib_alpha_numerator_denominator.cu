...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialCalibAlphaNumeratorDenominatorKernel(
        ...
        double *SimpleRadialCalib_w, unsigned int SimpleRadialCalib_w_num_alloc,
        double *const SimpleRadialCalib_total_ag,
        double *const SimpleRadialCalib_total_ac, size_t problem_size) {
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(
        SimpleRadialCalib_p_kp1, 2 * SimpleRadialCalib_p_kp1_num_alloc,
        global_thread_idx, r0, r1);
    ReadIdx2<1024, double, double, double2>(SimpleRadialCalib_r_k,
                                            2 * SimpleRadialCalib_r_k_num_alloc,
                                            global_thread_idx, r2, r3);
    ReadIdx2<1024, double, double, double2>(
        SimpleRadialCalib_p_kp1, 0 * SimpleRadialCalib_p_kp1_num_alloc,
  ...
  SumStore<double>(SimpleRadialCalib_total_ag_local, (double *)inout_shared, 0,
  ...
  SumStore<double>(SimpleRadialCalib_total_ac_local, (double *)inout_shared, 0,
                   global_thread_idx < problem_size, r3);
  SumFlushFinal<double>(SimpleRadialCalib_total_ag_local,
                        SimpleRadialCalib_total_ag, 1);
  SumFlushFinal<double>(SimpleRadialCalib_total_ac_local,
                        SimpleRadialCalib_total_ac, 1);
}
...
void SimpleRadialCalibAlphaNumeratorDenominator(
  ...
  SimpleRadialCalibAlphaNumeratorDenominatorKernel<<<n_blocks, 1024>>>(
      SimpleRadialCalib_p_kp1, SimpleRadialCalib_p_kp1_num_alloc,
      SimpleRadialCalib_r_k, SimpleRadialCalib_r_k_num_alloc,
      SimpleRadialCalib_w, SimpleRadialCalib_w_num_alloc,
      SimpleRadialCalib_total_ag, SimpleRadialCalib_total_ac, problem_size);
}
