...
__global__ void __launch_bounds__(1024, 1) PinholeCalibNormalizeKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r2 = 1.0 / r2;
    ReadIdx2<1024, double, double, double2>(
        precond_tril, 0 * precond_tril_num_alloc, global_thread_idx, r4, r7);
    r4 = -1.00000000000000000e+00;
    r8 = r7 * r4;
    r8 = r8 * r2;
    ReadIdx2<1024, double, double, double2>(njtr, 2 * njtr_num_alloc,
                                            global_thread_idx, r9, r10);
    r9 = fma(r0, r8, r9);
    ReadIdx2<1024, double, double, double2>(
        precond_diag, 2 * precond_diag_num_alloc, global_thread_idx, r11, r12);
    r11 = fma(r11, r5, r6);
    r11 = fma(r7, r8, r11);
    r11 = 1.0 / r11;
    r11 = r9 * r11;
    r8 = fma(r8, r11, r0 * r2);
    ReadIdx2<1024, double, double, double2>(
        precond_tril, 4 * precond_tril_num_alloc, global_thread_idx, r2, r0);
    r4 = r2 * r4;
    r3 = fma(r3, r5, r6);
    r3 = 1.0 / r3;
    r4 = r4 * r3;
...
void PinholeCalibNormalize(double *precond_diag,
                           ...
                           double *precond_tril,
                           unsigned int precond_tril_num_alloc, double *njtr,
  ...
  PinholeCalibNormalizeKernel<<<n_blocks, 1024>>>(
