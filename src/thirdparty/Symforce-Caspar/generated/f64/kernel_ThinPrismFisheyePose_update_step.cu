...
__global__ void __launch_bounds__(1024, 1) ThinPrismFisheyePoseUpdateStepKernel(
    ...
    const double *const alpha, double *out_ThinPrismFisheyePose_step_kp1,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_step_k, 0 * ThinPrismFisheyePose_step_k_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, double, double, double2>(
        ...
        0 * out_ThinPrismFisheyePose_step_kp1_num_alloc, global_thread_idx, r2,
        r3);
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_step_k, 2 * ThinPrismFisheyePose_step_k_num_alloc,
    ...
    WriteIdx2<1024, double, double, double2>(
        out_ThinPrismFisheyePose_step_kp1,
        2 * out_ThinPrismFisheyePose_step_kp1_num_alloc, global_thread_idx, r1,
        r0);
    ReadIdx2<1024, double, double, double2>(
        ThinPrismFisheyePose_step_k, 4 * ThinPrismFisheyePose_step_k_num_alloc,
        global_thread_idx, r0, r1);
    ReadIdx2<1024, double, double, double2>(
    ...
    WriteIdx2<1024, double, double, double2>(
        out_ThinPrismFisheyePose_step_kp1,
        4 * out_ThinPrismFisheyePose_step_kp1_num_alloc, global_thread_idx, r2,
        r4);
  };
}
...
void ThinPrismFisheyePoseUpdateStep(
  ...
  ThinPrismFisheyePoseUpdateStepKernel<<<n_blocks, 1024>>>(
      ThinPrismFisheyePose_step_k, ThinPrismFisheyePose_step_k_num_alloc,
      ThinPrismFisheyePose_p_kp1, ThinPrismFisheyePose_p_kp1_num_alloc, alpha,
      out_ThinPrismFisheyePose_step_kp1,
      out_ThinPrismFisheyePose_step_kp1_num_alloc, problem_size);
}
