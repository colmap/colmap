...
__global__ void __launch_bounds__(1024, 1)
    SphericalResJacKernel(double* pose,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r84 = r86 * r86;
    r50 = r72 * r72;
    r50 = fma(r57, r50, r41 * r84);
    WriteSum2<double, double>((double*)inout_shared, r55, r50);
  };
  ...
  if (global_thread_idx < problem_size) {
    r50 = r76 * r41;
    r55 = r2 * r57;
    r2 = fma(r2, r55, r76 * r50);
    r76 = r7 * r7;
    r84 = r60 * r60;
    r84 = fma(r57, r84, r41 * r76);
    WriteSum2<double, double>((double*)inout_shared, r2, r84);
  };
  FlushSumShared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    r76 = r78 * r72;
    r2 = r40 * r86;
    r2 = fma(r41, r2, r57 * r76);
    r76 = fma(r40, r50, r78 * r55);
    WriteSum2<double, double>((double*)inout_shared, r2, r76);
  };
  ...
  if (global_thread_idx < problem_size) {
    r84 = r86 * r7;
    r2 = r72 * r60;
    r2 = fma(r57, r2, r41 * r84);
    r84 = r86 * r34;
    r76 = r72 * r65;
    r76 = fma(r57, r76, r41 * r84);
    WriteSum2<double, double>((double*)inout_shared, r2, r76);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  FlushSumShared<2, double>(out_pose_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r76 = fma(r34, r50, r65 * r55);
    r50 = fma(r6, r50, r29 * r55);
  ...
  if (global_thread_idx < problem_size) {
    r50 = r60 * r65;
    r76 = r7 * r34;
    r76 = fma(r41, r76, r57 * r50);
    r50 = r7 * r6;
    r55 = r60 * r29;
    r55 = fma(r57, r55, r41 * r50);
  ...
  FlushSumShared<1, double>(out_pose_precond_tril,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r76 = fma(r26, r37, r35 * r47);
    r55 = r3 * r76;
    r55 = r55 * r80;
    r55 = r55 * r81;
    r50 = r28 * r26;
    r2 = r28 * r35;
    r2 = fma(r48, r2, r4 * r50);
    r50 = r18 * r59;
    r50 = fma(r54, r50, r2 * r82);
    r2 = r56 * r50;
    r2 = r2 * r67;
    r2 = r2 * r70;
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 0 * out_point_jac_num_alloc, global_thread_idx, r55, r2);
    r2 = fma(r33, r37, r52 * r47);
    r55 = r3 * r2;
    r55 = r55 * r80;
    r55 = r55 * r81;
    r84 = r28 * r52;
    r5 = r28 * r33;
    r5 = fma(r4, r5, r48 * r84);
    r84 = r18 * r25;
    r84 = fma(r54, r84, r5 * r82);
    r5 = r56 * r84;
    r5 = r5 * r67;
    r5 = r5 * r70;
    WriteIdx2<1024, double, double, double2>(
        out_point_jac, 2 * out_point_jac_num_alloc, global_thread_idx, r55, r5);
    ...
    r56 = fma(r76, r58, r50 * r64);
    r3 = fma(r2, r58, r84 * r64);
...
void SphericalResJac(double* pose,
                     unsigned int pose_num_alloc,
                     SharedIndex* pose_indices,
                     double* sensor_from_rig,
                     unsigned int sensor_from_rig_num_alloc,
