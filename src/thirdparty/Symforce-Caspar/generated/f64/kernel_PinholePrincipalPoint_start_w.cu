...
__global__ void __launch_bounds__(1024, 1) PinholePrincipalPointStartWKernel(
    double *PinholePrincipalPoint_precond_diag,
    unsigned int PinholePrincipalPoint_precond_diag_num_alloc,
    const double *const diag, double *PinholePrincipalPoint_p,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, double, double, double2>(
        ...
        0 * PinholePrincipalPoint_precond_diag_num_alloc, global_thread_idx, r0,
        r1);
  };
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r2;
    ReadIdx2<1024, double, double, double2>(
        PinholePrincipalPoint_p, 0 * PinholePrincipalPoint_p_num_alloc,
...
void PinholePrincipalPointStartW(
    double *PinholePrincipalPoint_precond_diag,
    unsigned int PinholePrincipalPoint_precond_diag_num_alloc,
    const double *const diag, double *PinholePrincipalPoint_p,
    unsigned int PinholePrincipalPoint_p_num_alloc,
  ...
  PinholePrincipalPointStartWKernel<<<n_blocks, 1024>>>(
      PinholePrincipalPoint_precond_diag,
      PinholePrincipalPoint_precond_diag_num_alloc, diag,
      PinholePrincipalPoint_p, PinholePrincipalPoint_p_num_alloc,
      out_PinholePrincipalPoint_w, out_PinholePrincipalPoint_w_num_alloc,
      problem_size);
}
