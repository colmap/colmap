...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFocalAndDistortionUpdateRKernel(
  ...
  SumFlushFinal<double>(
      ...
      out_SimpleRadialFocalAndDistortion_r_kp1_norm2_tot,
      1);
}
...
void SimpleRadialFocalAndDistortionUpdateR(
  ...
  SimpleRadialFocalAndDistortionUpdateRKernel<<<n_blocks, 1024>>>(
      SimpleRadialFocalAndDistortion_r_k,
