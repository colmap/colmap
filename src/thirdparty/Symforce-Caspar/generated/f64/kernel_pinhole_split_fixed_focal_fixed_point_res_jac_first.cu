...
__launch_bounds__(1024, 1) PinholeSplitFixedFocalFixedPointResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r43, r7);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r43 = r3 * r42;
    r31 = r2 * r42;
    r31 = fma(r25, r31, r34 * r43);
    WriteSum2<double, double>((double *)inout_shared, r7, r31);
  };
  FlushSumShared<2, double>(out_pose_njtr, 4 * out_pose_njtr_num_alloc,
                            pose_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r31 = fma(r46, r46, r1 * r1);
    r7 = fma(r17, r17, r14 * r14);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r43 = r29 * r26;
    r39 = r27 * r34;
    r43 = fma(r39, r43, r25 * r31);
    WriteSum2<double, double>((double *)inout_shared, r7, r43);
  };
  FlushSumShared<2, double>(out_pose_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r1, r43);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r1 = r27 * r14;
    r1 = r1 * r0;
    WriteSum2<double, double>((double *)inout_shared, r43, r1);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r41 = r4 * r41;
    r25 = r25 * r41;
    WriteSum2<double, double>((double *)inout_shared, r0, r25);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
...
void PinholeSplitFixedFocalFixedPointResJacFirst(
  ...
  PinholeSplitFixedFocalFixedPointResJacFirstKernel<<<n_blocks, 1024>>>(
      ...
      pixel_num_alloc, focal, focal_num_alloc, point, point_num_alloc, out_res,
