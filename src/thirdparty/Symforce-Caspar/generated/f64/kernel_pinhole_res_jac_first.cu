...
__global__ void __launch_bounds__(1024, 1) PinholeResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>((double *)inout_shared,
                        calib_indices_loc[threadIdx.x].target, r5, r28);
  };
  __syncthreads();
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r6, r42);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r37, r7);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r34, r7);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r18, r34);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r18 = r28 * r15;
    r18 = r18 * r0;
    WriteSum2<double, double>((double *)inout_shared, r34, r18);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r18 = r18 * r44;
    r18 = r18 * r36;
    WriteSum2<double, double>((double *)inout_shared, r49, r18);
  };
  FlushSumShared<2, double>(out_pose_precond_tril,
  ...
  FlushSumShared<2, double>(out_calib_precond_diag,
                            ...
                            calib_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    WriteSum2<double, double>((double *)inout_shared, r49, r44);
  };
  FlushSumShared<2, double>(out_calib_precond_tril,
                            0 * out_calib_precond_tril_num_alloc,
                            calib_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    WriteSum2<double, double>((double *)inout_shared, r6, r49);
  };
  FlushSumShared<2, double>(out_calib_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r22, r0);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r0, r44);
  };
