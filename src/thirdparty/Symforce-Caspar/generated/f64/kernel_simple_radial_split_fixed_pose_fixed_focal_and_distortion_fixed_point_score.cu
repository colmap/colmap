...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialSplitFixedPoseFixedFocalAndDistortionFixedPointScoreKernel(
...
void SimpleRadialSplitFixedPoseFixedFocalAndDistortionFixedPointScore(
    double *principal_point, unsigned int principal_point_num_alloc,
    SharedIndex *principal_point_indices, double *pixel,
    unsigned int pixel_num_alloc, double *pose, unsigned int pose_num_alloc,
    double *focal_and_distortion, unsigned int focal_and_distortion_num_alloc,
    double *point, unsigned int point_num_alloc, double *const out_rTr,
    size_t problem_size) {
  ...
  SimpleRadialSplitFixedPoseFixedFocalAndDistortionFixedPointScoreKernel<<<
      n_blocks, 1024>>>(principal_point, principal_point_num_alloc,
                        principal_point_indices, pixel, pixel_num_alloc, pose,
                        pose_num_alloc, focal_and_distortion,
                        focal_and_distortion_num_alloc, point, point_num_alloc,
