...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFixedPoseFixedPointJtjnjtrDirectKernel(
        double* calib_njtr,
...
void SimpleRadialFixedPoseFixedPointJtjnjtrDirect(
    double* calib_njtr,
    unsigned int calib_njtr_num_alloc,
    SharedIndex* calib_njtr_indices,
    double* calib_jac,
  ...
  SimpleRadialFixedPoseFixedPointJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
      calib_njtr,
