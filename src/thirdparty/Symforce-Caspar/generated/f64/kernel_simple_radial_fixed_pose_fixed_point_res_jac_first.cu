...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r3, r23);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r23 = r19 * r24;
    r23 = r23 * r26;
    WriteSum2<double, double>((double *)inout_shared, r13, r23);
  };
  FlushSumShared<2, double>(out_calib_precond_tril,
...
void SimpleRadialFixedPoseFixedPointResJacFirst(
  ...
  SimpleRadialFixedPoseFixedPointResJacFirstKernel<<<n_blocks, 1024>>>(
      calib, calib_num_alloc, calib_indices, pixel, pixel_num_alloc, pose,
      pose_num_alloc, point, point_num_alloc, out_res, out_res_num_alloc,
      out_rTr, out_calib_njtr, out_calib_njtr_num_alloc, out_calib_precond_diag,
