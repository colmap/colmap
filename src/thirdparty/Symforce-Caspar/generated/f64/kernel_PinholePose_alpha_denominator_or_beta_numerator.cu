...
__global__ void __launch_bounds__(1024, 1)
    PinholePoseAlphaDenominatorOrBetaNumeratorKernel(
        ...
        double *const PinholePose_out, size_t problem_size) {
  ...
  SumStore<double>(PinholePose_out_local, (double *)inout_shared, 0,
                   global_thread_idx < problem_size, r6);
  SumFlushFinal<double>(PinholePose_out_local, PinholePose_out, 1);
}
