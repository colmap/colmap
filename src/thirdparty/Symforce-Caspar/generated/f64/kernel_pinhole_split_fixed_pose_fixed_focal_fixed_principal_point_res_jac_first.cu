...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = r4 * r25;
    r21 = r19 * r25;
    r21 = fma(r6, r21, r0 * r20);
    r20 = r4 * r2;
    r27 = r25 * r27;
    r22 = r5 * r23;
    r22 = fma(r0, r22, r19 * r27);
    r20 = fma(r22, r20, r21 * r7);
    r7 = r4 * r2;
    r8 = r5 * r29;
    r8 = fma(r0, r8, r15 * r27);
    r12 = r4 * r3;
    r28 = r15 * r25;
    r14 = r26 * r16;
    r14 = fma(r0, r14, r6 * r28);
    r12 = fma(r14, r12, r8 * r7);
    WriteSum2<double, double>((double *)inout_shared, r20, r12);
  };
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r12 = fma(r21, r14, r22 * r8);
    r21 = fma(r21, r28, r22 * r20);
    WriteSum2<double, double>((double *)inout_shared, r12, r21);
  };
  FlushSumShared<2, double>(out_point_precond_tril,
                            0 * out_point_precond_tril_num_alloc,
                            point_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    r20 = fma(r8, r20, r14 * r28);
...
void PinholeSplitFixedPoseFixedFocalFixedPrincipalPointResJacFirst(
  ...
  PinholeSplitFixedPoseFixedFocalFixedPrincipalPointResJacFirstKernel<<<
      ...
      pose_num_alloc, focal, focal_num_alloc, principal_point,
