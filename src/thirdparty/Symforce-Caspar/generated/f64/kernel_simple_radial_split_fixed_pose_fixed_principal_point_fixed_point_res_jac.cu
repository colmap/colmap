...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = r25 * r2;
    r2 = r4 * r3;
    r2 = fma(r1, r2, r23 * r25);
    r23 = r0 * r9;
    r1 = r24 * r23;
    r13 = r21 * r4;
    r13 = r13 * r3;
    r13 = r13 * r24;
    r13 = fma(r23, r13, r25 * r1);
    WriteSum2<double, double>((double *)inout_shared, r2, r13);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r2 = r5 * r5;
    r2 = r2 * r20;
    r2 = fma(r22, r2, r17 * r13);
    r9 = r0 * r9;
    r20 = r20 * r23;
    r9 = r9 * r20;
    r9 = fma(r22, r9, r17 * r9);
...
void SimpleRadialSplitFixedPoseFixedPrincipalPointFixedPointResJac(
    ...
    double *principal_point, unsigned int principal_point_num_alloc,
    double *point, unsigned int point_num_alloc, double *out_res,
    unsigned int out_res_num_alloc, double *const out_focal_and_distortion_njtr,
    unsigned int out_focal_and_distortion_njtr_num_alloc,
    double *const out_focal_and_distortion_precond_diag,
    unsigned int out_focal_and_distortion_precond_diag_num_alloc,
    double *const out_focal_and_distortion_precond_tril,
