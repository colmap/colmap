...
__global__ void __launch_bounds__(1024, 1)
    PinholeSplitFixedPrincipalPointFixedPointJtjnjtrDirectKernel(
        ...
        double *focal_jac, unsigned int focal_jac_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<double, double>((double *)inout_shared, r10, r3);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>((double *)inout_shared,
                        pose_njtr_indices_loc[threadIdx.x].target, r3, r10);
  };
  __syncthreads();
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<double>((double *)inout_shared,
                        pose_njtr_indices_loc[threadIdx.x].target, r2, r15);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r11 = fma(r2, r11, r10 * r13);
  };
  LoadShared<2, double, double>(pose_njtr, 0 * pose_njtr_num_alloc,
                                pose_njtr_indices_loc, (double *)inout_shared);
  if (global_thread_idx < problem_size) {
    ReadShared2<double>((double *)inout_shared,
                        pose_njtr_indices_loc[threadIdx.x].target, r13, r16);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r11 = fma(r15, r9, r11);
    ...
    r11 = fma(r16, r7, r11);
    r11 = r4 * r11;
    r12 = fma(r2, r12, r10 * r14);
    r12 = fma(r13, r1, r12);
    r12 = fma(r16, r8, r12);
    r12 = fma(r3, r6, r12);
    r12 = r5 * r12;
    WriteSum2<double, double>((double *)inout_shared, r11, r12);
  };
