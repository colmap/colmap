...
__global__ void __launch_bounds__(1024, 1) PointUpdateStepKernel(
    float *Point_step_k, unsigned int Point_step_k_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx3<1024, float, float, float4>(Point_step_k,
...
void PointUpdateStep(float *Point_step_k, unsigned int Point_step_k_num_alloc,
                     float *Point_p_kp1, unsigned int Point_p_kp1_num_alloc,
                     const float *const alpha, float *out_Point_step_kp1,
