...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<float>((float *)inout_shared,
                       focal_indices_loc[threadIdx.x].target, r7, r29);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r30 = r13 * r21;
  ...
  SumStore<float>(out_rTr_local, (float *)inout_shared, 0,
                  global_thread_idx < problem_size, r24);
  if (global_thread_idx < problem_size) {
    r24 = r11 * r12;
    r24 = r24 * r21;
    r1 = r1 + r24;
    ...
    r16 = r16 * r4;
    r16 = r16 * r40;
    r1 = fmaf(r38, r16, r0 * r1);
    r41 = r11 * r11;
    r42 = r4 * r14;
    r43 = r41 + r42;
    r35 = r35 + r43;
    r35 = fmaf(r10, r35, r9 * r15);
    r15 = r29 * r35;
    r44 = r4 * r40;
    r45 = r38 * r44;
    ...
    r13 = r26 + r13;
    r43 = r43 + r13;
    r43 = fmaf(r8, r43, r10 * r23);
    r20 = fmaf(r43, r16, r0 * r20);
    r12 = r18 + r12;
    ...
    WriteIdx4<1024, float, float, float4>(out_pose_jac,
                                          ...
                                          global_thread_idx, r1, r45, r20, r10);
    r17 = r7 * r0;
    r18 = r29 * r0;
    r21 = r26 + r21;
    r21 = r21 + r36;
    ...
    WriteIdx4<1024, float, float, float4>(out_pose_jac,
                                          ...
                                          global_thread_idx, r32, r8, r17, r18);
    r18 = r44 * r34;
    WriteIdx2<1024, float, float, float2>(
        out_pose_jac, 8 * out_pose_jac_num_alloc, global_thread_idx, r16, r18);
    r18 = r4 * r2;
    r17 = r4 * r3;
    r17 = fmaf(r45, r17, r1 * r18);
    r18 = r4 * r3;
    r19 = r4 * r2;
    r19 = fmaf(r20, r19, r10 * r18);
    r18 = r4 * r3;
    r31 = r4 * r2;
    ...
    r18 = r18 * r0;
    r9 = r7 * r18;
    WriteSum4<float, float>((float *)inout_shared, r17, r19, r31, r9);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r31 = r3 * r40;
    r19 = r2 * r40;
    r19 = fmaf(r27, r19, r34 * r31);
    WriteSum2<float, float>((float *)inout_shared, r9, r19);
  };
  ...
  if (global_thread_idx < problem_size) {
    r19 = r7 * r7;
    r19 = r19 * r40;
    r9 = fmaf(r1, r1, r45 * r45);
    r31 = fmaf(r20, r20, r10 * r10);
    r17 = fmaf(r32, r32, r8 * r8);
    WriteSum4<float, float>((float *)inout_shared, r9, r31, r17, r19);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<float, float>((float *)inout_shared, r19, r31);
  };
  FlushSumShared<2, float>(out_pose_precond_diag,
                           4 * out_pose_precond_diag_num_alloc,
                           pose_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r31 = fmaf(r45, r10, r1 * r20);
    r19 = fmaf(r45, r8, r1 * r32);
    r17 = r7 * r1;
    r17 = r17 * r0;
    r37 = r29 * r45;
    r37 = r37 * r0;
    WriteSum4<float, float>((float *)inout_shared, r31, r19, r17, r37);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
                           0 * out_pose_precond_tril_num_alloc,
                           pose_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r37 = fmaf(r20, r32, r10 * r8);
    r17 = r7 * r20;
    r17 = r17 * r0;
    r19 = r29 * r10;
    r19 = r19 * r0;
    ...
    WriteSum4<float, float>((float *)inout_shared, r31, r37, r17, r19);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r17 = r17 * r0;
    r37 = r10 * r44;
    r37 = fmaf(r34, r37, r20 * r16);
    r20 = r8 * r44;
    r20 = fmaf(r34, r20, r32 * r16);
    WriteSum4<float, float>((float *)inout_shared, r37, r19, r17, r20);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r39 = r4 * r39;
    r39 = r39 * r9;
    WriteSum3<float, float>((float *)inout_shared, r20, r17, r39);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, float, float, float2>(out_focal_jac,
                                          ...
                                          global_thread_idx, r39, r17);
    r18 = r5 * r18;
    r17 = r4 * r6;
    r17 = r17 * r3;
    r17 = r17 * r0;
    WriteSum2<float, float>((float *)inout_shared, r18, r17);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r18 = r6 * r6;
    r18 = r18 * r40;
    WriteSum2<float, float>((float *)inout_shared, r17, r18);
  };
