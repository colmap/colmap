...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialPrincipalPointAlphaDenominatorOrBetaNumeratorKernel(
        ...
        float *const SimpleRadialPrincipalPoint_out, size_t problem_size) {
  ...
  SumStore<float>(SimpleRadialPrincipalPoint_out_local, (float *)inout_shared,
                  0, global_thread_idx < problem_size, r3);
  SumFlushFinal<float>(SimpleRadialPrincipalPoint_out_local,
