...
__global__ void __launch_bounds__(1024, 1) ThinPrismFisheyePoseUpdateStepKernel(
    ...
    unsigned int ThinPrismFisheyePose_p_kp1_num_alloc, const float *const alpha,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(
        ...
        0 * out_ThinPrismFisheyePose_step_kp1_num_alloc, global_thread_idx, r4,
        r5, r6, r7);
    ...
    WriteIdx2<1024, float, float, float2>(
        out_ThinPrismFisheyePose_step_kp1,
        4 * out_ThinPrismFisheyePose_step_kp1_num_alloc, global_thread_idx, r5,
        r8);
  };
}
