...
__global__ void __launch_bounds__(1024, 1) SphericalPoseStartWContributeKernel(
  ...
  if (global_thread_idx < problem_size) {
    r0 = r0 * r4;
    ReadIdx4<1024, float, float, float4>(SphericalPose_p,
                                         0 * SphericalPose_p_num_alloc,
                                         global_thread_idx,
                                         r5,
                                         r6,
                                         r7,
    ...
    r3 = r3 * r4;
    r3 = r3 * r8;
    AddIdx4<1024, float, float, float4>(out_SphericalPose_w,
    ...
    ReadIdx2<1024, float, float, float2>(
        ...
        r2);
    r3 = r3 * r4;
    ReadIdx2<1024, float, float, float2>(SphericalPose_p,
                                         4 * SphericalPose_p_num_alloc,
                                         global_thread_idx,
                                         r1,
                                         r0);
    r3 = r3 * r1;
    r4 = r2 * r4;
    r4 = r4 * r0;
    AddIdx2<1024, float, float, float2>(out_SphericalPose_w,
...
void SphericalPoseStartWContribute(
  ...
  SphericalPoseStartWContributeKernel<<<n_blocks, 1024>>>(
      SphericalPose_precond_diag,
      SphericalPose_precond_diag_num_alloc,
      diag,
      SphericalPose_p,
      SphericalPose_p_num_alloc,
      out_SphericalPose_w,
