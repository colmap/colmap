...
__global__ void __launch_bounds__(1024, 1) PinholePrincipalPointUpdateRKernel(
...
void PinholePrincipalPointUpdateR(
    float *PinholePrincipalPoint_r_k,
    unsigned int PinholePrincipalPoint_r_k_num_alloc,
    float *PinholePrincipalPoint_w,
    unsigned int PinholePrincipalPoint_w_num_alloc, const float *const negalpha,
  ...
  PinholePrincipalPointUpdateRKernel<<<n_blocks, 1024>>>(
