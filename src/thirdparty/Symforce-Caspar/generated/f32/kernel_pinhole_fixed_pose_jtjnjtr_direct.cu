...
__global__ void __launch_bounds__(1024, 1) PinholeFixedPoseJtjnjtrDirectKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r1 = fmaf(r0, r6, r1);
    r0 = r11 * r1;
    WriteSum4<float, float>((float *)inout_shared, r12, r0, r9, r1);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadShared4<float>((float *)inout_shared,
                       calib_njtr_indices_loc[threadIdx.x].target, r1, r9, r0,
                       r12);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r10 = fmaf(r1, r10, r0);
    r11 = fmaf(r9, r11, r12);
    r6 = fmaf(r6, r11, r5 * r10);
    r8 = fmaf(r8, r11, r7 * r10);
    r11 = fmaf(r4, r11, r3 * r10);
    WriteSum3<float, float>((float *)inout_shared, r6, r8, r11);
  };
