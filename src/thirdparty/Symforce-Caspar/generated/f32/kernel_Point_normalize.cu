...
__global__ void __launch_bounds__(1024, 1) PointNormalizeKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r1 = r0 * r1;
    ReadIdx3<1024, float, float, float4>(precond_diag,
                                         0 * precond_diag_num_alloc,
                                         global_thread_idx, r2, r3, r4);
    ...
    r4 = fmaf(r0, r3, r4);
    r4 = 1.0 / r4;
    ReadIdx3<1024, float, float, float4>(njtr, 0 * njtr_num_alloc,
                                         global_thread_idx, r3, r8, r1);
    r6 = r0 * r6;
    r8 = fmaf(r3, r10, r8);
    r1 = fmaf(r8, r6, r1);
    r0 = r7 * r3;
    ...
    r5 = fmaf(r1, r5, r3 * r2);
    r5 = fmaf(r6, r10, r5);
    WriteIdx3<1024, float, float, float4>(out_normalized,
                                          0 * out_normalized_num_alloc,
                                          global_thread_idx, r5, r6, r1);
  };
}

void PointNormalize(float *precond_diag, unsigned int precond_diag_num_alloc,
                    float *precond_tril, unsigned int precond_tril_num_alloc,
                    float *njtr, unsigned int njtr_num_alloc,
                    const float *const diag, float *out_normalized,
