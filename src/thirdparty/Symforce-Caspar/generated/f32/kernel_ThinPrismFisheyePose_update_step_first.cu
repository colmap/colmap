...
__global__ void __launch_bounds__(1024, 1)
    ThinPrismFisheyePoseUpdateStepFirstKernel(
        ...
        const float *const alpha, float *out_ThinPrismFisheyePose_step_kp1,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(
        ...
        0 * out_ThinPrismFisheyePose_step_kp1_num_alloc, global_thread_idx, r0,
        r1, r2, r3);
    ...
    WriteIdx2<1024, float, float, float2>(
        out_ThinPrismFisheyePose_step_kp1,
        4 * out_ThinPrismFisheyePose_step_kp1_num_alloc, global_thread_idx, r3,
        r4);
  };
}
