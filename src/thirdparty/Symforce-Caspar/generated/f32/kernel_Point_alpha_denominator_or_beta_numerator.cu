...
__global__ void __launch_bounds__(1024, 1)
    PointAlphaDenominatorOrBetaNumeratorKernel(
        float *Point_p_kp1, unsigned int Point_p_kp1_num_alloc, float *Point_w,
        unsigned int Point_w_num_alloc, float *const Point_out,
        size_t problem_size) {
  ...
  SumStore<float>(Point_out_local, (float *)inout_shared, 0,
