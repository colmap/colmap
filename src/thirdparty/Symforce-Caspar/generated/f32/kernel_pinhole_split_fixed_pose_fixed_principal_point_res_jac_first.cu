...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<float>((float *)inout_shared,
                       focal_indices_loc[threadIdx.x].target, r7, r28);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r17 = r12 * r17;
  ...
  if (global_thread_idx < problem_size) {
    ...
    r10 = r10 * r3;
    r10 = r10 * r0;
    WriteSum2<float, float>((float *)inout_shared, r23, r10);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r27 = r4 * r27;
    r20 = r27 * r20;
    r8 = fmaf(r22, r20, r0 * r8);
    r5 = r22 * r27;
    r10 = r28 * r1;
    r10 = fmaf(r0, r10, r9 * r5);
    r5 = r7 * r29;
    r5 = fmaf(r0, r5, r18 * r20);
    r23 = r28 * r19;
    r24 = r18 * r27;
    r24 = fmaf(r9, r24, r0 * r23);
    WriteIdx4<1024, float, float, float4>(out_point_jac,
                                          0 * out_point_jac_num_alloc,
                                          global_thread_idx, r8, r10, r5, r24);
    r23 = r7 * r30;
    r23 = fmaf(r0, r23, r26 * r20);
    r20 = r26 * r27;
    r11 = r28 * r21;
    r11 = fmaf(r0, r11, r9 * r20);
    WriteIdx2<1024, float, float, float2>(out_point_jac,
                                          4 * out_point_jac_num_alloc,
                                          global_thread_idx, r23, r11);
    r20 = r4 * r2;
    r0 = r4 * r3;
    r0 = fmaf(r10, r0, r8 * r20);
    r20 = r4 * r2;
    r9 = r4 * r3;
    r9 = fmaf(r24, r9, r5 * r20);
    r20 = r4 * r2;
    r15 = r4 * r3;
    r15 = fmaf(r11, r15, r23 * r20);
    WriteSum3<float, float>((float *)inout_shared, r0, r9, r15);
  };
  FlushSumShared<3, float>(out_point_njtr, 0 * out_point_njtr_num_alloc,
                           point_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r15 = fmaf(r8, r8, r10 * r10);
    r9 = fmaf(r24, r24, r5 * r5);
    r0 = fmaf(r23, r23, r11 * r11);
    WriteSum3<float, float>((float *)inout_shared, r15, r9, r0);
  };
  FlushSumShared<3, float>(out_point_precond_diag,
                           0 * out_point_precond_diag_num_alloc,
                           point_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r0 = fmaf(r10, r24, r8 * r5);
    r10 = fmaf(r10, r11, r8 * r23);
    r23 = fmaf(r5, r23, r24 * r11);
    WriteSum3<float, float>((float *)inout_shared, r0, r10, r23);
  };
