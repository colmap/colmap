...
__global__ void __launch_bounds__(1024, 1) SimpleRadialJtjnjtrDirectKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadShared3<float>((float *)inout_shared,
                       point_njtr_indices_loc[threadIdx.x].target, r12, r13,
                       r14);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    ...
    r21 = fmaf(r13, r19, r14 * r15);
    r21 = fmaf(r12, r17, r21);
    r22 = r6 + r21;
    r4 = fmaf(r4, r9, r7);
    r4 = fmaf(r5, r11, r4);
    r13 = fmaf(r13, r20, r14 * r16);
    r13 = fmaf(r12, r18, r13);
    r12 = r4 + r13;
    r14 = fmaf(r1, r12, r0 * r22);
    r5 = fmaf(r3, r12, r2 * r22);
    ReadIdx4<1024, float, float, float4>(pose_jac, 4 * pose_jac_num_alloc,
                                         global_thread_idx, r7, r23, r24, r25);
    r26 = fmaf(r23, r12, r7 * r22);
    r27 = fmaf(r25, r12, r24 * r22);
    WriteSum4<float, float>((float *)inout_shared, r14, r5, r26, r27);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx4<1024, float, float, float4>(pose_jac, 8 * pose_jac_num_alloc,
                                         global_thread_idx, r27, r26, r5, r14);
    r28 = fmaf(r26, r12, r27 * r22);
    r22 = fmaf(r5, r22, r14 * r12);
    WriteSum2<float, float>((float *)inout_shared, r28, r22);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadShared2<float>((float *)inout_shared,
                       pose_njtr_indices_loc[threadIdx.x].target, r22, r28);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r27 = fmaf(r22, r27, r28 * r5);
  };
  LoadShared<4, float, float>(pose_njtr, 0 * pose_njtr_num_alloc,
                              pose_njtr_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    ReadShared4<float>((float *)inout_shared,
                       pose_njtr_indices_loc[threadIdx.x].target, r5, r12, r29,
                       r30);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    ...
    r25 = fmaf(r5, r1, r25);
    r25 = fmaf(r12, r3, r25);
    r25 = fmaf(r22, r26, r25);
    r13 = r25 + r13;
    r9 = fmaf(r9, r13, r8 * r21);
    r11 = fmaf(r11, r13, r10 * r21);
    WriteSum4<float, float>((float *)inout_shared, r9, r11, r21, r13);
  };
  ...
  if (global_thread_idx < problem_size) {
    r6 = r27 + r6;
    r4 = r25 + r4;
    r18 = fmaf(r18, r4, r17 * r6);
    r20 = fmaf(r20, r4, r19 * r6);
    r4 = fmaf(r16, r4, r15 * r6);
    WriteSum3<float, float>((float *)inout_shared, r18, r20, r4);
  };
