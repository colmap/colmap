...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialFocalAndDistortionUpdateStepKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadIdx2<1024, float, float, float2>(
        SimpleRadialFocalAndDistortion_step_k,
        0 * SimpleRadialFocalAndDistortion_step_k_num_alloc, global_thread_idx,
        r0, r1);
    ReadIdx2<1024, float, float, float2>(
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, float, float, float2>(
        out_SimpleRadialFocalAndDistortion_step_kp1,
        0 * out_SimpleRadialFocalAndDistortion_step_kp1_num_alloc,
...
void SimpleRadialFocalAndDistortionUpdateStep(
  ...
  SimpleRadialFocalAndDistortionUpdateStepKernel<<<n_blocks, 1024>>>(
      SimpleRadialFocalAndDistortion_step_k,
      SimpleRadialFocalAndDistortion_step_k_num_alloc,
      SimpleRadialFocalAndDistortion_p_kp1,
      SimpleRadialFocalAndDistortion_p_kp1_num_alloc, alpha,
      out_SimpleRadialFocalAndDistortion_step_kp1,
      out_SimpleRadialFocalAndDistortion_step_kp1_num_alloc, problem_size);
}
