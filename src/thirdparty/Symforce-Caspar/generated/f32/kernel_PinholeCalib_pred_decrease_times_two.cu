...
__global__ void __launch_bounds__(1024, 1)
    PinholeCalibPredDecreaseTimesTwoKernel(
        float *PinholeCalib_step, unsigned int PinholeCalib_step_num_alloc,
        float *PinholeCalib_precond_diag,
        unsigned int PinholeCalib_precond_diag_num_alloc,
        const float *const diag, float *PinholeCalib_njtr,
        unsigned int PinholeCalib_njtr_num_alloc,
        float *const out_PinholeCalib_pred_dec, size_t problem_size) {
  ...
  SumStore<float>(out_PinholeCalib_pred_dec_local, (float *)inout_shared, 0,
                  global_thread_idx < problem_size, r7);
  SumFlushFinal<float>(out_PinholeCalib_pred_dec_local,
...
void PinholeCalibPredDecreaseTimesTwo(
    float *PinholeCalib_step, unsigned int PinholeCalib_step_num_alloc,
    float *PinholeCalib_precond_diag,
    unsigned int PinholeCalib_precond_diag_num_alloc, const float *const diag,
    float *PinholeCalib_njtr, unsigned int PinholeCalib_njtr_num_alloc,
    float *const out_PinholeCalib_pred_dec, size_t problem_size) {
