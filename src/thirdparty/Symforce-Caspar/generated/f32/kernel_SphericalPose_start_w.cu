...
__global__ void __launch_bounds__(1024, 1)
    SphericalPoseStartWKernel(float* SphericalPose_precond_diag,
...
void SphericalPoseStartW(float* SphericalPose_precond_diag,
                         unsigned int SphericalPose_precond_diag_num_alloc,
                         const float* const diag,
                         float* SphericalPose_p,
                         unsigned int SphericalPose_p_num_alloc,
  ...
  SphericalPoseStartWKernel<<<n_blocks, 1024>>>(
      SphericalPose_precond_diag,
