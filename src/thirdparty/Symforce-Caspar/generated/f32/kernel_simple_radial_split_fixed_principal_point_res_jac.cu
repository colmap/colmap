...
__launch_bounds__(1024, 1) SimpleRadialSplitFixedPrincipalPointResJacKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r14 = r14 * r54;
    r50 = fmaf(r30, r14, r50);
    r22 = r0 * r7;
    r24 = fmaf(r24, r1, r14 * r22);
    r14 = r0 * r15;
    r14 = r14 * r37;
    r24 = fmaf(r55, r14, r24);
    r14 = r5 * r19;
    r14 = r14 * r6;
    r14 = r14 * r36;
    r14 = fmaf(r30, r14, r1);
  ...
  FlushSumShared<4, float>(out_pose_precond_tril,
                           ...
                           pose_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r13 = fmaf(r9, r40, r14 * r40);
    r14 = fmaf(r16, r40, r14 * r10);
    r40 = fmaf(r10, r40, r9 * r16);
    WriteSum3<float, float>((float *)inout_shared, r13, r14, r40);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(
        ...
        0 * out_focal_and_distortion_jac_num_alloc, global_thread_idx, r40, r14,
        r13, r10);
    r10 = r4 * r7;
    r10 = r10 * r3;
    r13 = r6 * r4;
  ...
  if (global_thread_idx < problem_size) {
    ...
    r10 = r7 * r42;
    r14 = r6 * r30;
    r14 = fmaf(r42, r14, r22 * r10);
    WriteSum2<float, float>((float *)inout_shared, r13, r14);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r14 = r19 * r29;
    r14 = r14 * r6;
    r14 = fmaf(r8, r14, r21 * r52);
    r26 = r19 * r18;
    r26 = r26 * r7;
    r14 = fmaf(r8, r26, r14);
    r14 = fmaf(r21, r33, r14);
    r26 = r5 * r14;
    r26 = r26 * r37;
    ...
    r10 = fmaf(r18, r1, r10);
    r13 = r32 * r30;
    r13 = fmaf(r20, r1, r54 * r13);
    r22 = r19 * r20;
    r22 = r22 * r6;
    r22 = fmaf(r32, r52, r8 * r22);
    r40 = r19 * r25;
    r40 = r40 * r7;
    r22 = fmaf(r8, r40, r22);
    r22 = fmaf(r32, r33, r22);
    r40 = r5 * r22;
    r40 = r40 * r37;
    r13 = fmaf(r30, r40, r13);
    r40 = r0 * r32;
    r40 = r40 * r7;
    r16 = r0 * r22;
    r16 = r16 * r37;
    r16 = fmaf(r55, r16, r54 * r40);
    r16 = fmaf(r25, r1, r16);
    WriteIdx4<1024, float, float, float4>(
    ...
    r40 = r28 * r30;
    r33 = fmaf(r54, r40, r33);
    r40 = r0 * r28;
    r40 = r40 * r7;
    r40 = fmaf(r54, r40, r34 * r1);
    r1 = r0 * r52;
    r1 = r1 * r37;
    r40 = fmaf(r55, r1, r40);
    WriteIdx2<1024, float, float, float2>(out_point_jac,
                                          4 * out_point_jac_num_alloc,
                                          global_thread_idx, r33, r40);
    r1 = r4 * r2;
    r55 = r4 * r3;
    r55 = fmaf(r10, r55, r26 * r1);
    r1 = r4 * r2;
    r37 = r4 * r3;
    r37 = fmaf(r16, r37, r13 * r1);
    r1 = r4 * r3;
    r54 = r4 * r2;
    r54 = fmaf(r33, r54, r40 * r1);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r37 = fmaf(r16, r16, r13 * r13);
    r55 = fmaf(r33, r33, r40 * r40);
  ...
  FlushSumShared<3, float>(out_point_precond_diag,
                           ...
                           point_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r55 = fmaf(r10, r16, r26 * r13);
    r10 = fmaf(r10, r40, r26 * r33);
    r40 = fmaf(r16, r40, r13 * r33);
    WriteSum3<float, float>((float *)inout_shared, r55, r10, r40);
  };
