...
__global__ void __launch_bounds__(1024, 1) SimpleRadialPoseUpdatePKernel(
    float *SimpleRadialPose_z, unsigned int SimpleRadialPose_z_num_alloc,
    float *SimpleRadialPose_p_k, unsigned int SimpleRadialPose_p_k_num_alloc,
    const float *const beta, float *out_SimpleRadialPose_p_kp1,
