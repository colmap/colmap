...
__global__ void __launch_bounds__(1024, 1)
    PinholeFixedPoseFixedPointScoreKernel(float* calib,
...
void PinholeFixedPoseFixedPointScore(float* calib,
                                     unsigned int calib_num_alloc,
                                     SharedIndex* calib_indices,
                                     float* pixel,
                                     unsigned int pixel_num_alloc,
  ...
  PinholeFixedPoseFixedPointScoreKernel<<<n_blocks, 1024>>>(calib,
                                                            calib_num_alloc,
                                                            calib_indices,
                                                            pixel,
                                                            pixel_num_alloc,
