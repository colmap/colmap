...
__global__ void __launch_bounds__(1024, 1)
  ...
  __shared__ float SimpleRadialFocalAndDistortion_out_local[1];
  ...
  SumStore<float>(SimpleRadialFocalAndDistortion_out_local,
                  (float *)inout_shared, 0, global_thread_idx < problem_size,
                  r3);
  SumFlushFinal<float>(SimpleRadialFocalAndDistortion_out_local,
