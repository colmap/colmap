...
__global__ void __launch_bounds__(1024, 1)
    PointAlphaNumeratorDenominatorKernel(float* Point_p_kp1,
  ...
  SumStore<float>(Point_total_ag_local,
                  (float*)inout_shared,
                  0,
  ...
  SumStore<float>(Point_total_ac_local,
                  (float*)inout_shared,
                  0,
                  global_thread_idx < problem_size,
                  r4);
...
void PointAlphaNumeratorDenominator(float* Point_p_kp1,
                                    unsigned int Point_p_kp1_num_alloc,
                                    float* Point_r_k,
                                    unsigned int Point_r_k_num_alloc,
                                    float* Point_w,
