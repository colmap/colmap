...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    ReadIdx4<1024, float, float, float4>(calib_jac, 0 * calib_jac_num_alloc,
                                         global_thread_idx, r0, r2, r10, r11);
    r12 = fmaf(r0, r1, r2 * r9);
    r13 = fmaf(r10, r1, r11 * r9);
    WriteSum4<float, float>((float *)inout_shared, r12, r13, r1, r9);
  };
  ...
  if (global_thread_idx < problem_size) {
    ReadShared4<float>((float *)inout_shared,
                       calib_njtr_indices_loc[threadIdx.x].target, r9, r1, r13,
                       r12);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    ...
    r7 = fmaf(r7, r0, r8 * r2);
    r0 = fmaf(r3, r0, r4 * r2);
    WriteSum3<float, float>((float *)inout_shared, r5, r7, r0);
  };
