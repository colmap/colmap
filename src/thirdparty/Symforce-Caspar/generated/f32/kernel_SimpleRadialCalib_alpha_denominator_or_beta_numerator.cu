...
__global__ void __launch_bounds__(1024, 1)
    SimpleRadialCalibAlphaDenominatorOrBetaNumeratorKernel(
        ...
        float *const SimpleRadialCalib_out, size_t problem_size) {
  ...
  SumStore<float>(SimpleRadialCalib_out_local, (float *)inout_shared, 0,
...
void SimpleRadialCalibAlphaDenominatorOrBetaNumerator(
    float *SimpleRadialCalib_p_kp1,
    unsigned int SimpleRadialCalib_p_kp1_num_alloc, float *SimpleRadialCalib_w,
