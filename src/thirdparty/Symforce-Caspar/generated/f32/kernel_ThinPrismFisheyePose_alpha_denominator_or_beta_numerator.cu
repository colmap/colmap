...
__global__ void __launch_bounds__(1024, 1)
  ...
  SumStore<float>(ThinPrismFisheyePose_out_local, (float *)inout_shared, 0,
                  global_thread_idx < problem_size, r7);
  SumFlushFinal<float>(ThinPrismFisheyePose_out_local, ThinPrismFisheyePose_out,
                       1);
}
