...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r1 = r1 * r3;
    r3 = r4 * r2;
    r3 = fmaf(r11, r3, r24 * r1);
    r24 = r0 * r17;
    r11 = r25 * r24;
    r8 = r21 * r4;
    r8 = r8 * r2;
    r8 = r8 * r25;
    r8 = fmaf(r24, r8, r1 * r11);
    WriteSum2<float, float>((float *)inout_shared, r3, r8);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r3 = r5 * r5;
    r3 = r3 * r26;
    r3 = fmaf(r10, r3, r23 * r8);
    r17 = r0 * r17;
    r26 = r26 * r24;
    r17 = r17 * r26;
    r17 = fmaf(r10, r17, r23 * r17);
    WriteSum2<float, float>((float *)inout_shared, r3, r17);
  };
...
void SimpleRadialSplitFixedPoseFixedPrincipalPointFixedPointResJac(
    ...
    float *principal_point, unsigned int principal_point_num_alloc,
    float *point, unsigned int point_num_alloc, float *out_res,
    unsigned int out_res_num_alloc, float *const out_focal_and_distortion_njtr,
    unsigned int out_focal_and_distortion_njtr_num_alloc,
    float *const out_focal_and_distortion_precond_diag,
    unsigned int out_focal_and_distortion_precond_diag_num_alloc,
    float *const out_focal_and_distortion_precond_tril,
  ...
  SimpleRadialSplitFixedPoseFixedPrincipalPointFixedPointResJacKernel<<<
      ...
      focal_and_distortion_indices, pixel, pixel_num_alloc, pose,
      pose_num_alloc, principal_point, principal_point_num_alloc, point,
      point_num_alloc, out_res, out_res_num_alloc,
