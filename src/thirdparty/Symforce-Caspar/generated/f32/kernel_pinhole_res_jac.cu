...
__global__ void __launch_bounds__(1024, 1) PinholeResJacKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadShared3<float>((float *)inout_shared,
                       pose_indices_loc[threadIdx.x].target, r7, r8, r9);
  };
  __syncthreads();
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(
        out_pose_jac, 0 * out_pose_jac_num_alloc, global_thread_idx, r23, r51,
        r22, r20);
    r12 = r0 * r2;
    r39 = r1 * r2;
    r38 = r28 + r38;
    ...
    WriteIdx4<1024, float, float, float4>(
        out_pose_jac, 4 * out_pose_jac_num_alloc, global_thread_idx, r49, r10,
        r12, r39);
    r39 = r46 * r26;
    ...
    r39 = r39 * r2;
    r11 = r0 * r39;
    WriteSum4<float, float>((float *)inout_shared, r12, r34, r32, r11);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum2<float, float>((float *)inout_shared, r11, r34);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float *)inout_shared, r11, r32, r12, r34);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r42 = r1 * r51;
    r42 = r42 * r2;
    WriteSum4<float, float>((float *)inout_shared, r32, r34, r12, r42);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float *)inout_shared, r32, r42, r12, r34);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float *)inout_shared, r22, r34, r12, r49);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r44 = r6 * r44;
    r44 = r44 * r11;
    WriteSum3<float, float>((float *)inout_shared, r49, r12, r44);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r34 = r34 * r5;
    r34 = r34 * r2;
    WriteSum4<float, float>((float *)inout_shared, r39, r34, r11, r36);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r11 = r8 * r8;
    r11 = r11 * r45;
    WriteSum4<float, float>((float *)inout_shared, r36, r11, r27, r27);
  };
  FlushSumShared<4, float>(out_calib_precond_diag,
                           0 * out_calib_precond_diag_num_alloc,
                           calib_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    WriteSum4<float, float>((float *)inout_shared, r49, r44, r49, r49);
  };
  FlushSumShared<4, float>(out_calib_precond_tril,
                           0 * out_calib_precond_tril_num_alloc,
                           calib_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    WriteSum2<float, float>((float *)inout_shared, r12, r49);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx4<1024, float, float, float4>(
        out_point_jac, 0 * out_point_jac_num_alloc, global_thread_idx, r49, r44,
        r12, r11);
    r27 = r0 * r24;
    ...
    WriteSum3<float, float>((float *)inout_shared, r26, r2, r34);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float *)inout_shared, r34, r2, r26);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum3<float, float>((float *)inout_shared, r26, r44, r36);
  };
