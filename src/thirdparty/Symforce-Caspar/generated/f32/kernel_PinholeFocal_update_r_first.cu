...
__global__ void __launch_bounds__(1024, 1) PinholeFocalUpdateRFirstKernel(
  ...
  SumStore<float>(out_PinholeFocal_r_0_norm2_tot_local,
                  (float*)inout_shared,
                  0,
  ...
  SumStore<float>(out_PinholeFocal_r_kp1_norm2_tot_local,
                  (float*)inout_shared,
                  0,
                  global_thread_idx < problem_size,
                  r2);
  SumFlushFinal<float>(
      out_PinholeFocal_r_0_norm2_tot_local, out_PinholeFocal_r_0_norm2_tot, 1);
  SumFlushFinal<float>(out_PinholeFocal_r_kp1_norm2_tot_local,
                       out_PinholeFocal_r_kp1_norm2_tot,
                       1);
}

void PinholeFocalUpdateRFirst(float* PinholeFocal_r_k,
                              unsigned int PinholeFocal_r_k_num_alloc,
                              float* PinholeFocal_w,
                              unsigned int PinholeFocal_w_num_alloc,
                              const float* const negalpha,
  ...
  PinholeFocalUpdateRFirstKernel<<<n_blocks, 1024>>>(
      ...
      out_PinholeFocal_r_0_norm2_tot,
      out_PinholeFocal_r_kp1_norm2_tot,
      problem_size);
}
