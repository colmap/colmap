...
__global__ void __launch_bounds__(1024, 1)
    PinholePoseUpdateRFirstKernel(float* PinholePose_r_k,
  ...
  SumStore<float>(out_PinholePose_r_0_norm2_tot_local,
                  (float*)inout_shared,
                  0,
  ...
  SumStore<float>(out_PinholePose_r_kp1_norm2_tot_local,
                  (float*)inout_shared,
                  0,
                  global_thread_idx < problem_size,
                  r7);
...
void PinholePoseUpdateRFirst(float* PinholePose_r_k,
                             unsigned int PinholePose_r_k_num_alloc,
                             float* PinholePose_w,
                             unsigned int PinholePose_w_num_alloc,
                             const float* const negalpha,
