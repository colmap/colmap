...
__global__ void __launch_bounds__(1024, 1)
    SphericalFixedPointScoreKernel(float* pose,
...
void SphericalFixedPointScore(float* pose,
  ...
  SphericalFixedPointScoreKernel<<<n_blocks, 1024>>>(pose,
                                                     pose_num_alloc,
                                                     pose_indices,
                                                     sensor_from_rig,
