...
__global__ void __launch_bounds__(1024, 1)
    PinholePosePriorCoreResJacFirstKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r18 = fmaf(r21, r21, r6 * r6);
    r35 = r20 * r20;
    r4 = r4 * r4;
    r18 = fmaf(r4, r35, r18);
  };
  SumStore<float>(out_rTr_local, (float *)inout_shared, 0,
                  global_thread_idx < problem_size, r18);
  if (global_thread_idx < problem_size) {
    r18 = r7 * r21;
    r35 = r10 * r7;
    r36 = r13 * r14;
  ...
  if (global_thread_idx < problem_size) {
    ...
    r31 = fmaf(r0, r33, r31);
    r22 = fmaf(r31, r22, r19 * r34);
    r34 = r7 * r20;
    r34 = r34 * r24;
    r22 = fmaf(r4, r34, r22);
    WriteSum2<float, float>((float *)inout_shared, r9, r22);
  };
  FlushSumShared<2, float>(out_pose_njtr, 4 * out_pose_njtr_num_alloc,
                           pose_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r22 = fmaf(r45, r45, r25 * r25);
    r9 = r37 * r37;
    r22 = fmaf(r4, r9, r22);
    r9 = r40 * r40;
    ...
    r33 = fmaf(r30, r30, r5 * r5);
    r0 = r27 * r27;
    r33 = fmaf(r4, r0, r33);
    WriteSum4<float, float>((float *)inout_shared, r22, r9, r34, r33);
  };
  FlushSumShared<4, float>(out_pose_precond_diag,
                           0 * out_pose_precond_diag_num_alloc,
                           pose_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r33 = fmaf(r16, r16, r23 * r23);
    r33 = fmaf(r36, r28, r33);
    r36 = fmaf(r19, r19, r31 * r31);
    r34 = r24 * r24;
    r36 = fmaf(r4, r34, r36);
  ...
  FlushSumShared<2, float>(out_pose_precond_diag,
                           ...
                           pose_indices_loc, (float *)inout_shared);
  if (global_thread_idx < problem_size) {
    r36 = fmaf(r25, r29, r45 * r32);
    r33 = r37 * r40;
    r36 = fmaf(r4, r33, r36);
    r33 = fmaf(r25, r38, r45 * r26);
    r34 = fmaf(r45, r5, r25 * r30);
    r9 = r37 * r27;
    r34 = fmaf(r4, r9, r34);
    r9 = fmaf(r45, r16, r25 * r23);
    r9 = fmaf(r37, r28, r9);
    WriteSum4<float, float>((float *)inout_shared, r36, r33, r34, r9);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r9 = fmaf(r30, r29, r9);
    r34 = fmaf(r23, r29, r32 * r16);
    r34 = fmaf(r40, r28, r34);
    WriteSum4<float, float>((float *)inout_shared, r45, r25, r9, r34);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r34 = fmaf(r23, r38, r26 * r16);
    r38 = fmaf(r19, r38, r26 * r31);
    WriteSum4<float, float>((float *)inout_shared, r29, r32, r34, r38);
  };
  FlushSumShared<4, float>(out_pose_precond_tril,
...
void PinholePosePriorCoreResJacFirst(
    float *pose, unsigned int pose_num_alloc, SharedIndex *pose_indices,
    float *prior_position, unsigned int prior_position_num_alloc,
    float *sqrt_info, unsigned int sqrt_info_num_alloc, float *out_res,
    unsigned int out_res_num_alloc, float *const out_rTr,
  ...
  PinholePosePriorCoreResJacFirstKernel<<<n_blocks, 1024>>>(
