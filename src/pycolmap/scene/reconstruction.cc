...
void BindReconstruction(py::module& m) {
  py::classh<Reconstruction>(m, "Reconstruction")
      ...
      .def("read_text_legacy", &Reconstruction::ReadTextLegacy, "path"_a)
      .def("read_binary_legacy", &Reconstruction::ReadBinaryLegacy, "path"_a)
      .def("write_text_legacy", &Reconstruction::WriteTextLegacy, "path"_a)
      .def("write_binary_legacy", &Reconstruction::WriteBinaryLegacy, "path"_a)
