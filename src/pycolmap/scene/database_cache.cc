...
void BindDatabaseCache(py::module& m) {
  ...
  PyOpts.def(py::init<>())
      ...
      .def_readwrite("store_two_view_geometries",
                     &Opts::store_two_view_geometries,
                     "Whether to store two-view geometries. Stored without "
                     "matches, which are stored in the correspondence graph.");
  ...
  PyDatabaseCache.def(py::init<>())
      ...
      .def("num_two_view_geometries", &DatabaseCache::NumTwoViewGeometries)
      ...
      .def("exists_two_view_geometry",
           &DatabaseCache::ExistsTwoViewGeometry,
           "image_id1"_a,
           "image_id2"_a)
      ...
      .def_property_readonly("two_view_geometries",
                             &DatabaseCache::TwoViewGeometries)
