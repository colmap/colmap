...
void BindUndistortion(py::module& m) {
  auto PyUndistortCameraOptions = py::class_<UndistortCameraOptions>(m, "UndistortCameraOptions")
      .def(py::init<>())
      ...
      .def_readwrite("max_image_size", &UndistortCameraOptions::max_image_size)
  ...
  m.def("undistort_camera", &UndistortCamera, "options"_a, "camera"_a, "Undistort camera.");
